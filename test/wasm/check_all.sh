...
fail=0
for c in check_forwards.sh proto/check.sh check_phase1.sh check_phase2.sh check_phase3.sh check_phase4.sh check_data.sh check_calls.sh check_host.sh check_frozen.sh check_exc.sh check_managed.sh check_strop.sh check_index.sh check_dyn.sh check_set.sh check_defmem.sh check_openarr.sh check_aggret.sh check_nested.sh check_fieldlen.sh check_recmgd.sh check_recarr.sh check_zeroinit.sh check_pal.sh check_wasi.sh check_argv.sh check_floatint.sh check_floatwrite.sh check_tickets.sh; do
  name=$(basename "$c" .sh)
  echo "=== $c ==="
