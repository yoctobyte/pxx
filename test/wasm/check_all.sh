...
fail=0
for c in check_forwards.sh proto/check.sh check_phase1.sh check_phase2.sh check_phase3.sh check_phase4.sh check_data.sh check_calls.sh check_host.sh check_frozen.sh check_tickets.sh; do
  name=$(basename "$c" .sh)
  echo "=== $c ==="
