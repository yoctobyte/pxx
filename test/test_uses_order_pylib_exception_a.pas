...
{ feature-a-one-exception-class-in-a-shared-unit: sysutils named BEFORE pylib.
  ...
  Companion test_uses_order_pylib_exception_b.pas runs the identical checks
...
uses exceptions, sysutils, pylib;
