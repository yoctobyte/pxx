program test_a_for_in_enumerator_needs_a_parameterless_movenext_getenumerator;
{$mode objfpc}{$H+}
{ MUST NOT COMPILE: a `GetEnumerator` whose result type has a parametered MoveNext.
...
type
  TCol = class
    function GetEnumerator: TBad;
  end;
function TCol.GetEnumerator: TBad; begin Result := TBad.Create; end;

var i: Integer; c: TCol;
begin
  c := TCol.Create;
