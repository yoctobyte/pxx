...
fpc-check: bootstrap-check $(COMPILER)
	$(FPC) $(FPCFLAGS) -o$(FPC_COMPILER) $(COMPILER_SRC)
	$(FPC_COMPILER) $(PXXFLAGS) $(COMPILER_SRC) $(TESTTMP)/pascal26-from-fpc
	cmp $(COMPILER) $(TESTTMP)/pascal26-from-fpc
...
benchmark: $(COMPILER) benchmark-check
	rm -rf $(TESTTMP)/frankonpiler-bench-fpc-units $(TESTTMP)/frankonpiler-bench-hello-fpc-units
	mkdir -p $(TESTTMP)/frankonpiler-bench-fpc-units $(TESTTMP)/frankonpiler-bench-hello-fpc-units
	$(HYPERFINE) --warmup 3 --runs $(BENCH_RUNS) \
	  --export-markdown $(TESTTMP)/frankonpiler-compiler-bench.md \
	  --command-name 'FPC' '$(FPC) $(FPCFLAGS) -FU$(TESTTMP)/frankonpiler-bench-fpc-units -o$(TESTTMP)/pascal26-bench-fpc $(COMPILER_SRC) >/dev/null' \
	  --command-name 'self-hosted pascal26' './$(COMPILER) $(COMPILER_SRC) $(TESTTMP)/pascal26-bench-self >/dev/null'
	$(HYPERFINE) --warmup 1 --runs $(BENCH_HELLO_RUNS) \
	  --export-markdown $(TESTTMP)/frankonpiler-hello-bench.md \
	  --command-name 'FPC: $(BENCH_BATCH) x hello' 'for i in $$(seq 1 $(BENCH_BATCH)); do $(FPC) $(FPCFLAGS) -FU$(TESTTMP)/frankonpiler-bench-hello-fpc-units -o$(TESTTMP)/hello-bench-fpc test/hello.pas >/dev/null; done' \
...
benchmark-compiler-runtime: $(COMPILER) benchmark-check
	...
	mkdir -p $(TESTTMP)/frankonpiler-bench-runtime-fpc-units
	$(FPC) $(FPCFLAGS) -FU$(TESTTMP)/frankonpiler-bench-runtime-fpc-units -o$(TESTTMP)/pascal26-runtime-fpc $(COMPILER_SRC) >/dev/null
	$(TESTTMP)/pascal26-runtime-fpc $(COMPILER_SRC) $(TESTTMP)/pascal26-runtime-fpc-output >/dev/null
	./$(COMPILER) $(COMPILER_SRC) $(TESTTMP)/pascal26-runtime-self-output >/dev/null
	cmp $(TESTTMP)/pascal26-runtime-fpc-output $(TESTTMP)/pascal26-runtime-self-output
	$(HYPERFINE) --warmup 3 --runs $(BENCH_RUNTIME_RUNS) \
	  --export-markdown $(TESTTMP)/frankonpiler-compiler-runtime-bench.md \
	  --command-name 'FPC-built pascal26 compiles compiler' '$(TESTTMP)/pascal26-runtime-fpc $(COMPILER_SRC) $(TESTTMP)/pascal26-runtime-fpc-output >/dev/null' \
	  --command-name 'self-hosted pascal26 compiles compiler' './$(COMPILER) $(COMPILER_SRC) $(TESTTMP)/pascal26-runtime-self-output >/dev/null'
	$(HYPERFINE) --warmup 1 --runs $(BENCH_HELLO_RUNS) \
	  --export-markdown $(TESTTMP)/frankonpiler-compiler-runtime-hello-bench.md \
...
benchmark-opt-levels: $(COMPILER) benchmark-check
	...
	./$(COMPILER) -O1 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-O1
	./$(COMPILER) -O2 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-O2
	./$(COMPILER) -O3 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-O3
	@echo "=== correctness: every tier binary emits identical output (default -O0 emission) ==="
	$(TESTTMP)/pxx-opt-O0 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-out-O0 >/dev/null
	$(TESTTMP)/pxx-opt-O1 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-out-O1 >/dev/null
	$(TESTTMP)/pxx-opt-O2 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-out-O2 >/dev/null
	$(TESTTMP)/pxx-opt-O3 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-out-O3 >/dev/null
	cmp $(TESTTMP)/pxx-opt-out-O0 $(TESTTMP)/pxx-opt-out-O1
	cmp $(TESTTMP)/pxx-opt-out-O0 $(TESTTMP)/pxx-opt-out-O2
	cmp $(TESTTMP)/pxx-opt-out-O0 $(TESTTMP)/pxx-opt-out-O3
	@echo "=== compiler binary size per tier (smaller = tighter codegen) ==="
	@stat -c '%n  %s bytes' $(TESTTMP)/pxx-opt-O0 $(TESTTMP)/pxx-opt-O1 $(TESTTMP)/pxx-opt-O2 $(TESTTMP)/pxx-opt-O3
	@echo "=== self-compile time per tier ==="
	$(HYPERFINE) --warmup 2 --runs $(BENCH_RUNTIME_RUNS) \
	  --export-markdown $(TESTTMP)/frankonpiler-opt-levels-bench.md \
	  --command-name 'O0-built compiles compiler' '$(TESTTMP)/pxx-opt-O0 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-sc0 >/dev/null' \
	  --command-name 'O1-built compiles compiler' '$(TESTTMP)/pxx-opt-O1 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-sc1 >/dev/null' \
	  --command-name 'O2-built compiles compiler' '$(TESTTMP)/pxx-opt-O2 $(COMPILER_SRC) $(TESTTMP)/pxx-opt-sc2 >/dev/null' \
...
test-nilpy: $(COMPILER)
	...
	./$(COMPILER) test/test_nilpy_control.npy $(TESTTMP)/test_nilpy_control26
	test "$$($(TESTTMP)/test_nilpy_control26)" = "$$(printf '10\n20\n30\n6\n15\n6\n3')"
	./$(COMPILER) test/test_nilpy_local_variant.npy $(TESTTMP)/test_nilpy_local_variant26
	test "$$($(TESTTMP)/test_nilpy_local_variant26)" = "$$(printf '5\n3.14\nTrue\n7')"
	./$(COMPILER) test/test_nilpy_numeric_widen.npy $(TESTTMP)/test_nilpy_numeric_widen26
	test "$$($(TESTTMP)/test_nilpy_numeric_widen26)" = "$$(printf '3.14')"
	...
	./$(COMPILER) test/test_nilpy_dataclass_repr.npy $(TESTTMP)/test_nilpy_dcrepr26
	$(TESTTMP)/test_nilpy_dcrepr26 | diff -u test/test_nilpy_dataclass_repr.expected -
	# `from __future__ import annotations` is a no-op, not a missing unit.
	./$(COMPILER) test/test_nilpy_future_import.npy $(TESTTMP)/test_nilpy_future26
	$(TESTTMP)/test_nilpy_future26 | diff -u test/test_nilpy_future_import.expected -
	...
	./$(COMPILER) test/test_nilpy_dict_keyword_args.npy $(TESTTMP)/test_nilpy_dictkw26
	$(TESTTMP)/test_nilpy_dictkw26 | diff -u test/test_nilpy_dict_keyword_args.expected -
	...
	./$(COMPILER) test/test_nilpy_adjacent_string_literals.npy $(TESTTMP)/test_nilpy_adjstr26
	$(TESTTMP)/test_nilpy_adjstr26 | diff -u test/test_nilpy_adjacent_string_literals.expected -
	...
	./$(COMPILER) test/test_nilpy_fstring_selfdoc.npy $(TESTTMP)/test_nilpy_fsdoc26
	$(TESTTMP)/test_nilpy_fsdoc26 | diff -u test/test_nilpy_fstring_selfdoc.expected -
	# a KeyError names the KEY (via repr, which is what CPython's str() is).
	./$(COMPILER) test/test_nilpy_keyerror_names_the_key.npy $(TESTTMP)/test_nilpy_keyerr26
	$(TESTTMP)/test_nilpy_keyerr26 | diff -u test/test_nilpy_keyerror_names_the_key.expected -
	# .format(): the !r conversion was dropped, and a container arg vanished.
	./$(COMPILER) test/test_nilpy_str_format_conversion_and_containers.npy $(TESTTMP)/test_nilpy_fmtconv26
	$(TESTTMP)/test_nilpy_fmtconv26 | diff -u test/test_nilpy_str_format_conversion_and_containers.expected -
	# enumerate(xs, START) in a FOR HEADER — the expression form always worked.
	./$(COMPILER) test/test_nilpy_enumerate_start_in_for_header.npy $(TESTTMP)/test_nilpy_enstart26
	$(TESTTMP)/test_nilpy_enstart26 | diff -u test/test_nilpy_enumerate_start_in_for_header.expected -
	# `"%(k)s" % {...}` — the MAPPING form of %-formatting.
	./$(COMPILER) test/test_nilpy_percent_format_mapping.npy $(TESTTMP)/test_nilpy_pctmap26
	$(TESTTMP)/test_nilpy_pctmap26 | diff -u test/test_nilpy_percent_format_mapping.expected -
	# `with A() as a, B() as b:` — lowered by NESTING, so exit order is free.
	./$(COMPILER) test/test_nilpy_with_multiple_managers.npy $(TESTTMP)/test_nilpy_withmulti26
	$(TESTTMP)/test_nilpy_withmulti26 | diff -u test/test_nilpy_with_multiple_managers.expected -
	...
	./$(COMPILER) test/test_nilpy_keyword_arg_through_a_callable_value.npy $(TESTTMP)/test_nilpy_kwval26
	$(TESTTMP)/test_nilpy_kwval26 | diff -u test/test_nilpy_keyword_arg_through_a_callable_value.expected -
	./$(COMPILER) test/test_nilpy_local_binding_beats_a_def.npy $(TESTTMP)/test_nilpy_locbind26
	...
	./$(COMPILER) test/test_nilpy_for_getitem_protocol.npy $(TESTTMP)/test_nilpy_gip26
	$(TESTTMP)/test_nilpy_gip26 | diff -u test/test_nilpy_for_getitem_protocol.expected -
	...
	./$(COMPILER) test/test_nilpy_set_comprehension_dedup.npy $(TESTTMP)/test_nilpy_setcomp26
	$(TESTTMP)/test_nilpy_setcomp26 | diff -u test/test_nilpy_set_comprehension_dedup.expected -
	# repr() of an exception is ClassName('msg'), not an address.
	./$(COMPILER) test/test_nilpy_exception_repr.npy $(TESTTMP)/test_nilpy_excrepr26
	$(TESTTMP)/test_nilpy_excrepr26 | diff -u test/test_nilpy_exception_repr.expected -
	# str() of a CONSTRUCTED exception is its message, like a caught one's.
	./$(COMPILER) test/test_nilpy_exception_str_constructed.npy $(TESTTMP)/test_nilpy_excstr26
	$(TESTTMP)/test_nilpy_excstr26 | diff -u test/test_nilpy_exception_str_constructed.expected -
	# subscripting a CALL RESULT: str index/slice, and chained subscripts.
	./$(COMPILER) test/test_nilpy_subscript_of_a_call_result.npy $(TESTTMP)/test_nilpy_callsub26
	$(TESTTMP)/test_nilpy_callsub26 | diff -u test/test_nilpy_subscript_of_a_call_result.expected -
	# `parser = Parser(1)` then `parser(2)` must call __call__, not construct.
	./$(COMPILER) test/test_nilpy_instance_named_like_its_class.npy $(TESTTMP)/test_nilpy_instname26
	$(TESTTMP)/test_nilpy_instname26 | diff -u test/test_nilpy_instance_named_like_its_class.expected -
	...
	./$(COMPILER) test/test_nilpy_not_subscriptable.npy $(TESTTMP)/test_nilpy_notsub26
	$(TESTTMP)/test_nilpy_notsub26 | diff -u test/test_nilpy_not_subscriptable.expected -
	# `e[key()] += 1` must evaluate key() ONCE (side-effecting index observes it).
	./$(COMPILER) test/test_nilpy_augmented_subscript_index_once.npy $(TESTTMP)/test_nilpy_augidx26
	$(TESTTMP)/test_nilpy_augidx26 | diff -u test/test_nilpy_augmented_subscript_index_once.expected -
	...
	$(TESTTMP)/test_nilpy_iife26 | diff -u test/test_nilpy_immediate_lambda_call.expected -
	./$(COMPILER) test/test_nilpy_range_runtime_step.npy $(TESTTMP)/test_nilpy_rngstep26
	$(TESTTMP)/test_nilpy_rngstep26 | diff -u test/test_nilpy_range_runtime_step.expected -
	./$(COMPILER) test/test_nilpy_one_line_def_suite.npy $(TESTTMP)/test_nilpy_oneline26
	$(TESTTMP)/test_nilpy_oneline26 | diff -u test/test_nilpy_one_line_def_suite.expected -
	./$(COMPILER) test/test_nilpy_dunder_index_slice.npy $(TESTTMP)/test_nilpy_idxslice26
	...
	./$(COMPILER) test/test_nilpy_string_variant.npy $(TESTTMP)/test_nilpy_string_variant26
	test "$$($(TESTTMP)/test_nilpy_string_variant26)" = "$$(printf '5\napple\nTrue\nFalse\nFalse\nTrue\nTrue\nTrue\nFalse\nFalse\nTrue\nTrue\nFalse\nTrue\nlt TypeError\ngt TypeError\nhello world\nhello potato\ngreen world')"
	./$(COMPILER) test/test_nilpy_optional_param.npy $(TESTTMP)/test_nilpy_optional_param26
	test "$$($(TESTTMP)/test_nilpy_optional_param26)" = "$$(printf '%b' '5\n7\n10')"
	./$(COMPILER) test/test_nilpy_stmt_semicolon.npy $(TESTTMP)/test_nilpy_stmt_semicolon26
	test "$$($(TESTTMP)/test_nilpy_stmt_semicolon26)" = "$$(printf '%b' '1\n2')"
	./$(COMPILER) test/test_nilpy_no_return_annotation.npy $(TESTTMP)/test_nilpy_no_return_annotation26
	test "$$($(TESTTMP)/test_nilpy_no_return_annotation26)" = "$$(printf '%b' '4\ng ran\n10\nn=5')"
	./$(COMPILER) test/test_nilpy_range_step.npy $(TESTTMP)/test_nilpy_range_step26
	test "$$($(TESTTMP)/test_nilpy_range_step26)" = "$$(printf '%b' '5\n4\n3\n2\n1\n0\n2\n4\n6\n8\n4\n3\n0')"
	./$(COMPILER) test/test_nilpy_many_params.npy $(TESTTMP)/test_nilpy_many_params26
	test "$$($(TESTTMP)/test_nilpy_many_params26)" = "$$(printf '55\n65\n36\n204\n80')"
	! ./$(COMPILER) test/test_nilpy_inconsistent_dedent_fail.npy $(TESTTMP)/test_nilpy_inconsistent_dedent_fail26 > $(TESTTMP)/test_nilpy_inconsistent_dedent_fail.log 2>&1
	grep -q "inconsistent dedent" $(TESTTMP)/test_nilpy_inconsistent_dedent_fail.log
	! ./$(COMPILER) test/test_nilpy_mixed_indent_fail.npy $(TESTTMP)/test_nilpy_mixed_indent_fail26 > $(TESTTMP)/test_nilpy_mixed_indent_fail.log 2>&1
	grep -q "mixing tabs and spaces for indentation" $(TESTTMP)/test_nilpy_mixed_indent_fail.log
	@# feature-nilpy-starred-and-nested-unpacking is COMPLETE -- starred
	@# (test_nilpy_starred_unpack.npy), the nested LOOP target and the nested
	@# ASSIGNMENT target (both test_nilpy_nested_loop_target.npy). All four of
	@# its "must be refused with this message" recipes were retired WITH the
	@# feature that made them compile: a {%FAIL} test outlives its own feature
	@# by turning this target red, and gate.sh quick cannot see that, so the
	@# per-fix gate stays green while the suite is broken. Grep for _fail tests
	@# naming a feature before landing it.
	./$(COMPILER) test/test_nilpy_str_param.npy $(TESTTMP)/test_nilpy_str_param26
	test "$$($(TESTTMP)/test_nilpy_str_param26)" = "$$(printf '2\nb\ncd\nok!')"
	./$(COMPILER) test/test_nilpy_forin.npy $(TESTTMP)/test_nilpy_forin26
	$(TESTTMP)/test_nilpy_forin26 | diff -u test/test_nilpy_forin.expected -
	./$(COMPILER) test/test_nilpy_case_sensitive.npy $(TESTTMP)/test_nilpy_case_sensitive26
	$(TESTTMP)/test_nilpy_case_sensitive26 | diff -u test/test_nilpy_case_sensitive.expected -
	./$(COMPILER) test/test_nilpy_global_scope_binding.npy $(TESTTMP)/test_nilpy_global_scope_binding26
	$(TESTTMP)/test_nilpy_global_scope_binding26 | diff -u test/test_nilpy_global_scope_binding.expected -
	./$(COMPILER) test/test_nilpy_param_defaults_nonconstant.npy $(TESTTMP)/test_nilpy_param_defaults_nonconstant26
	$(TESTTMP)/test_nilpy_param_defaults_nonconstant26 | diff -u test/test_nilpy_param_defaults_nonconstant.expected -
	./$(COMPILER) test/test_nilpy_method_param_defaults.npy $(TESTTMP)/test_nilpy_method_param_defaults26
	$(TESTTMP)/test_nilpy_method_param_defaults26 | diff -u test/test_nilpy_method_param_defaults.expected -
	...
	./$(COMPILER) test/test_nilpy_dataclass_expr_default.npy $(TESTTMP)/test_nilpy_dcexpr26
	...
	grep -q "no option named 'sorted'" $(TESTTMP)/test_nilpy_dcunk.log
	./$(COMPILER) test/test_nilpy_account_program.npy $(TESTTMP)/test_nilpy_acctprog26
	$(TESTTMP)/test_nilpy_acctprog26 | diff -u test/test_nilpy_account_program.expected -
	./$(COMPILER) test/test_nilpy_augmented_assign_variant_operand.npy $(TESTTMP)/test_nilpy_augvarop26
	$(TESTTMP)/test_nilpy_augvarop26 | diff -u test/test_nilpy_augmented_assign_variant_operand.expected -
	./$(COMPILER) test/test_nilpy_floor_div_assign.npy $(TESTTMP)/test_nilpy_floordivassign26
	$(TESTTMP)/test_nilpy_floordivassign26 | diff -u test/test_nilpy_floor_div_assign.expected -
	./$(COMPILER) test/test_nilpy_augmented_assign_variant_field.npy $(TESTTMP)/test_nilpy_augvarfield26
	$(TESTTMP)/test_nilpy_augvarfield26 | diff -u test/test_nilpy_augmented_assign_variant_field.expected -
	./$(COMPILER) test/test_nilpy_bool_operand_and_or.npy $(TESTTMP)/test_nilpy_boolop26
	$(TESTTMP)/test_nilpy_boolop26 | diff -u test/test_nilpy_bool_operand_and_or.expected -
	./$(COMPILER) test/test_nilpy_boolop_left_operand_once.npy $(TESTTMP)/test_nilpy_boolonce26
	$(TESTTMP)/test_nilpy_boolonce26 | diff -u test/test_nilpy_boolop_left_operand_once.expected -
	./$(COMPILER) test/test_nilpy_default_before_star_args.npy $(TESTTMP)/test_nilpy_defstar26
	$(TESTTMP)/test_nilpy_defstar26 | diff -u test/test_nilpy_default_before_star_args.expected -
	./$(COMPILER) test/test_nilpy_star_args_is_a_tuple.npy $(TESTTMP)/test_nilpy_stargstuple26
	$(TESTTMP)/test_nilpy_stargstuple26 | diff -u test/test_nilpy_star_args_is_a_tuple.expected -
	./$(COMPILER) test/test_nilpy_unpack_keeps_class_identity.npy $(TESTTMP)/test_nilpy_unpackid26
	$(TESTTMP)/test_nilpy_unpackid26 | diff -u test/test_nilpy_unpack_keeps_class_identity.expected -
	./$(COMPILER) test/test_nilpy_negative_zero_repr.npy $(TESTTMP)/test_nilpy_negzero26
	$(TESTTMP)/test_nilpy_negzero26 | diff -u test/test_nilpy_negative_zero_repr.expected -
	./$(COMPILER) test/test_nilpy_empty_exception_subclass.npy $(TESTTMP)/test_nilpy_emptyexc26
	$(TESTTMP)/test_nilpy_emptyexc26 | diff -u test/test_nilpy_empty_exception_subclass.expected -
	./$(COMPILER) test/test_nilpy_one_line_class_body.npy $(TESTTMP)/test_nilpy_onelineclass26
	$(TESTTMP)/test_nilpy_onelineclass26 | diff -u test/test_nilpy_one_line_class_body.expected -
	./$(COMPILER) test/test_nilpy_one_line_def_in_module.npy $(TESTTMP)/test_nilpy_onelinemod26
	$(TESTTMP)/test_nilpy_onelinemod26 | diff -u test/test_nilpy_one_line_def_in_module.expected -
	@# a parameter/local named like a CLASS must not be typed as that class
	./$(COMPILER) test/test_nilpy_local_named_like_a_class.npy $(TESTTMP)/test_nilpy_localclsname26
	$(TESTTMP)/test_nilpy_localclsname26 | diff -u test/test_nilpy_local_named_like_a_class.expected -
	@# the field-path half also killed the COMPILER under -g, so that is its own row
	./$(COMPILER) -g test/test_nilpy_local_named_like_a_class.npy $(TESTTMP)/test_nilpy_localclsname_g26
	$(TESTTMP)/test_nilpy_localclsname_g26 | diff -u test/test_nilpy_local_named_like_a_class.expected -
	./$(COMPILER) test/test_nilpy_str_mul_str_undefined.npy $(TESTTMP)/test_nilpy_strmul26
	...
	./$(COMPILER) test/test_nilpy_calling_a_non_callable.npy $(TESTTMP)/test_nilpy_calling_a_non_callable26
	$(TESTTMP)/test_nilpy_calling_a_non_callable26 | diff -u test/test_nilpy_calling_a_non_callable.expected -
	...
	./$(COMPILER) test/test_nilpy_lowercase_name_vs_class.npy $(TESTTMP)/test_nilpy_lowercase_name_vs_class26
	$(TESTTMP)/test_nilpy_lowercase_name_vs_class26 | diff -u test/test_nilpy_lowercase_name_vs_class.expected -
	...
	./$(COMPILER) test/test_nilpy_star_args_ctor.npy $(TESTTMP)/test_nilpy_star_args_ctor26
	$(TESTTMP)/test_nilpy_star_args_ctor26 | diff -u test/test_nilpy_star_args_ctor.expected -
	...
	./$(COMPILER) test/test_nilpy_raise_a_variant.npy $(TESTTMP)/test_nilpy_raise_a_variant26
	$(TESTTMP)/test_nilpy_raise_a_variant26 | diff -u test/test_nilpy_raise_a_variant.expected -
	...
	./$(COMPILER) test/test_nilpy_eq_dunder_variant_operand.npy $(TESTTMP)/test_nilpy_eq_dunder_variant26
	$(TESTTMP)/test_nilpy_eq_dunder_variant26 | diff -u test/test_nilpy_eq_dunder_variant_operand.expected -
	...
	./$(COMPILER) test/test_nilpy_class_as_a_value.npy $(TESTTMP)/test_nilpy_class_as_a_value26
	$(TESTTMP)/test_nilpy_class_as_a_value26 | diff -u test/test_nilpy_class_as_a_value.expected -
	./$(COMPILER) test/test_nilpy_annotated_class_attribute.npy $(TESTTMP)/test_nilpy_annotated_class_attribute26
	...
	$(TESTTMP)/test_nilpy_mapbound26 | diff -u test/test_nilpy_map_over_a_bound_method.expected -
	...
	./$(COMPILER) test/test_nilpy_inherited_class_attribute_through_self.npy $(TESTTMP)/test_nilpy_inhclsattr_self26
	$(TESTTMP)/test_nilpy_inhclsattr_self26 | diff -u test/test_nilpy_inherited_class_attribute_through_self.expected -
	...
	./$(COMPILER) test/test_nilpy_round_keeps_intness.npy $(TESTTMP)/test_nilpy_roundint26
	$(TESTTMP)/test_nilpy_roundint26 | diff -u test/test_nilpy_round_keeps_intness.expected -
	...
	./$(COMPILER) test/test_nilpy_min_max_key_in_a_variable.npy $(TESTTMP)/test_nilpy_minmaxkey26
	$(TESTTMP)/test_nilpy_minmaxkey26 | diff -u test/test_nilpy_min_max_key_in_a_variable.expected -
	...
	./$(COMPILER) test/test_nilpy_filter_between_for_clauses.npy $(TESTTMP)/test_nilpy_filtbetween26
	$(TESTTMP)/test_nilpy_filtbetween26 | diff -u test/test_nilpy_filter_between_for_clauses.expected -
	...
	./$(COMPILER) test/test_nilpy_two_for_clauses_over_range.npy $(TESTTMP)/test_nilpy_twofor26
	$(TESTTMP)/test_nilpy_twofor26 | diff -u test/test_nilpy_two_for_clauses_over_range.expected -
	...
	./$(COMPILER) test/test_nilpy_optional_return_is_none.npy $(TESTTMP)/test_nilpy_optret_none26
	$(TESTTMP)/test_nilpy_optret_none26 | diff -u test/test_nilpy_optional_return_is_none.expected -
	...
	./$(COMPILER) test/test_nilpy_rebinding_a_parameter_is_local.npy $(TESTTMP)/test_nilpy_param_rebind26
	$(TESTTMP)/test_nilpy_param_rebind26 | diff -u test/test_nilpy_rebinding_a_parameter_is_local.expected -
	./$(COMPILER) test/test_nilpy_class_attribute_through_a_class_reference.npy $(TESTTMP)/test_nilpy_clsattr_byref26
	$(TESTTMP)/test_nilpy_clsattr_byref26 | diff -u test/test_nilpy_class_attribute_through_a_class_reference.expected -
	./$(COMPILER) test/test_nilpy_inherited_class_attribute.npy $(TESTTMP)/test_nilpy_inhclsattr26
	...
	./$(COMPILER) test/test_nilpy_user_iterable_in_builtins.npy $(TESTTMP)/test_nilpy_useriter26
	$(TESTTMP)/test_nilpy_useriter26 | diff -u test/test_nilpy_user_iterable_in_builtins.expected -
	./$(COMPILER) test/test_nilpy_pyeval_host_arity_and_returns.npy $(TESTTMP)/test_nilpy_pyeval_arity26
	...
	./$(COMPILER) test/test_nilpy_star_args_as_a_function_value.npy $(TESTTMP)/test_nilpy_starvalue26
	$(TESTTMP)/test_nilpy_starvalue26 | diff -u test/test_nilpy_star_args_as_a_function_value.expected -
	./$(COMPILER) test/test_nilpy_lambda_star_args.npy $(TESTTMP)/test_nilpy_lamstar26
	$(TESTTMP)/test_nilpy_lamstar26 | diff -u test/test_nilpy_lambda_star_args.expected -
	./$(COMPILER) test/test_nilpy_star_unpack_into_a_collecting_callee.npy $(TESTTMP)/test_nilpy_starsplice26
	...
	./$(COMPILER) test/test_nilpy_augmented_repeat_mutates_in_place.npy $(TESTTMP)/test_nilpy_augrep26
	$(TESTTMP)/test_nilpy_augrep26 | diff -u test/test_nilpy_augmented_repeat_mutates_in_place.expected -
	...
	./$(COMPILER) test/test_nilpy_int_of_an_expression.npy $(TESTTMP)/test_nilpy_intexpr26
	...
	./$(COMPILER) test/test_nilpy_int_float_dunders.npy $(TESTTMP)/test_nilpy_intfloatdunder26
	$(TESTTMP)/test_nilpy_intfloatdunder26 | diff -u test/test_nilpy_int_float_dunders.expected -
	...
	$(TESTTMP)/test_nilpy_hasprop26 | diff -u test/test_nilpy_hasattr_getattr_property.expected -
	./$(COMPILER) test/test_nilpy_builtin_type_as_callback.npy $(TESTTMP)/test_nilpy_btypecb26
	$(TESTTMP)/test_nilpy_btypecb26 | diff -u test/test_nilpy_builtin_type_as_callback.expected -
	...
	$(TESTTMP)/test_nilpy_lamdefv26 | diff -u test/test_nilpy_lambda_default_values.expected -
	./$(COMPILER) test/test_nilpy_matmul_dunder.npy $(TESTTMP)/test_nilpy_matmul26
	$(TESTTMP)/test_nilpy_matmul26 | diff -u test/test_nilpy_matmul_dunder.expected -
	./$(COMPILER) test/test_nilpy_operand_clash_messages.npy $(TESTTMP)/test_nilpy_opclash26
	$(TESTTMP)/test_nilpy_opclash26 | diff -u test/test_nilpy_operand_clash_messages.expected -
	./$(COMPILER) test/test_nilpy_hasattr_builtin_receivers.npy $(TESTTMP)/test_nilpy_hasattrbuiltin26
	$(TESTTMP)/test_nilpy_hasattrbuiltin26 | diff -u test/test_nilpy_hasattr_builtin_receivers.expected -
	./$(COMPILER) test/test_nilpy_math_domain_errors.npy $(TESTTMP)/test_nilpy_mathdomain26
	$(TESTTMP)/test_nilpy_mathdomain26 | diff -u test/test_nilpy_math_domain_errors.expected -
	./$(COMPILER) test/test_nilpy_getattr_dunder.npy $(TESTTMP)/test_nilpy_getattrdunder26
	$(TESTTMP)/test_nilpy_getattrdunder26 | diff -u test/test_nilpy_getattr_dunder.expected -
	./$(COMPILER) test/test_nilpy_none_comparison_raises.npy $(TESTTMP)/test_nilpy_nonecmp26
	$(TESTTMP)/test_nilpy_nonecmp26 | diff -u test/test_nilpy_none_comparison_raises.expected -
	...
	$(TESTTMP)/test_nilpy_raisebare26 | diff -u test/test_nilpy_raise_bare_class.expected -
	./$(COMPILER) test/test_nilpy_iterator_protocol.npy $(TESTTMP)/test_nilpy_iterproto26
	$(TESTTMP)/test_nilpy_iterproto26 | diff -u test/test_nilpy_iterator_protocol.expected -
	...
	$(TESTTMP)/test_nilpy_closure_lifetime26 | diff -u test/test_nilpy_closure_lifetime.expected -
	./$(COMPILER) test/test_nilpy_lambda_arity.npy $(TESTTMP)/test_nilpy_lambda_arity26
	$(TESTTMP)/test_nilpy_lambda_arity26 | diff -u test/test_nilpy_lambda_arity.expected -
	./$(COMPILER) test/test_nilpy_body_scan_attribution.npy $(TESTTMP)/test_nilpy_bodyscan26
	$(TESTTMP)/test_nilpy_bodyscan26 | diff -u test/test_nilpy_body_scan_attribution.expected -
	./$(COMPILER) test/test_nilpy_bound_method_value_receiver_shapes.npy $(TESTTMP)/test_nilpy_bmrecv26
	$(TESTTMP)/test_nilpy_bmrecv26 | diff -u test/test_nilpy_bound_method_value_receiver_shapes.expected -
	./$(COMPILER) test/test_nilpy_global_read_above_its_assignment.npy $(TESTTMP)/test_nilpy_globread26
	$(TESTTMP)/test_nilpy_globread26 | diff -u test/test_nilpy_global_read_above_its_assignment.expected -
	./$(COMPILER) test/test_nilpy_function_value_repr.npy $(TESTTMP)/test_nilpy_fnrepr26
	$(TESTTMP)/test_nilpy_fnrepr26 | diff -u test/test_nilpy_function_value_repr.expected -
	./$(COMPILER) test/test_nilpy_callable_field_call_returns.npy $(TESTTMP)/test_nilpy_cbfield26
	$(TESTTMP)/test_nilpy_cbfield26 | diff -u test/test_nilpy_callable_field_call_returns.expected -
	./$(COMPILER) test/test_nilpy_callable_field_all_shapes.npy $(TESTTMP)/test_nilpy_cbshapes26
	$(TESTTMP)/test_nilpy_cbshapes26 | diff -u test/test_nilpy_callable_field_all_shapes.expected -
	./$(COMPILER) test/test_nilpy_conditional_expression_none.npy $(TESTTMP)/test_nilpy_condnone26
	...
	test "$$($(TESTTMP)/test_nilpy_tobject_member26)" = "$$(printf 'Dog\nDog\nDog\n42\n43')"
	./$(COMPILER) test/test_nilpy_object_arc.npy $(TESTTMP)/test_nilpy_object_arc26
	test "$$($(TESTTMP)/test_nilpy_object_arc26)" = "$$(printf '3\n9\n2\n2')"
	./$(COMPILER) test/test_nilpy_class_return.npy $(TESTTMP)/test_nilpy_class_return26
	test "$$($(TESTTMP)/test_nilpy_class_return26)" = "$$(printf 'a\nb\nsolo\ninner\n41\nlate')"
	./$(COMPILER) test/test_nilpy_fstrings.npy $(TESTTMP)/test_nilpy_fstrings26
	...
	test "$$($(TESTTMP)/test_nilpy_exceptions26)" = "$$(printf 'none\nA\n10\nB\n20\nnone\nfin\nerr\nfin\ninner\nouter\n5\nbare')"
	./$(COMPILER) test/test_nilpy_kwargs.npy $(TESTTMP)/test_nilpy_kwargs26
	test "$$($(TESTTMP)/test_nilpy_kwargs26)" = "$$(printf 'Hello, Ann!\nHi, Bob!\nHello, Cid?\nYo, Dee?!\nHey, Eve?\nHello, Fay!\nHello, Gus.\n111\n124\n130\n245')"
	./$(COMPILER) test/test_nilpy_defaults.npy $(TESTTMP)/test_nilpy_defaults26
	test "$$($(TESTTMP)/test_nilpy_defaults26)" = "$$(printf '3\n6\nhi bob\nhi bob!\nend...\nend!\n7\n103\n106\n3\n-3\n206')"
	./$(COMPILER) test/test_nilpy_bytes.npy $(TESTTMP)/test_nilpy_bytes26
	test "$$($(TESTTMP)/test_nilpy_bytes26)" = "$$(printf '4\n0\n0\n65\n66\n0\n255\n255\n65\n65\n1\n4\n1024\n0')"
	./$(COMPILER) test/test_nilpy_file_read.npy $(TESTTMP)/test_nilpy_file_read26
	test "$$($(TESTTMP)/test_nilpy_file_read26)" = "$$(printf '%b' 'abc\n  abc\nabc  \nhello\nxxhello\nhelloxx\nline')"
	./$(COMPILER) test/test_nilpy_dedent.npy $(TESTTMP)/test_nilpy_dedent26
	test "$$($(TESTTMP)/test_nilpy_dedent26)" = "$$(printf '%b' 'a\n  b\nc\n')"
	./$(COMPILER) test/test_nilpy_str_of_container.npy $(TESTTMP)/test_nilpy_str_of_container26
	test "$$($(TESTTMP)/test_nilpy_str_of_container26)" = "$$(printf '%b' '(1, 2)\n[1, 2]\n{'\''a'\'': 1}\n(1, 2)\n(5,)\n['\''a'\'']\n(1, 2)\n[(1, 2), (3, 4)]\n(1, 2)!')"
	./$(COMPILER) test/test_nilpy_percent_format.npy $(TESTTMP)/test_nilpy_percent_format26
	test "$$($(TESTTMP)/test_nilpy_percent_format26)" = "$$(printf '%b' 'bob is 42\n     3.142|\nbob       |\n5\n50%\n[[1, 2]]\n1-2\n   42|42   |00042\nff FF 10\n3.14\n1 2')"
	./$(COMPILER) test/test_nilpy_chaining.npy $(TESTTMP)/test_nilpy_chaining26
	test "$$($(TESTTMP)/test_nilpy_chaining26)" = "$$(printf '%b' '6 3\n5\nA\nA,B\nB\n0012')"
	./$(COMPILER) test/test_nilpy_unknown_method.npy $(TESTTMP)/test_nilpy_unknown_method26
	test "$$($(TESTTMP)/test_nilpy_unknown_method26)" = "$$(printf '%b' '5\ncb 5\n7')"
	./$(COMPILER) test/test_nilpy_super.npy $(TESTTMP)/test_nilpy_super26
	...
	test "$$($(TESTTMP)/test_nilpy_minmax26)" = "$$(printf '%b' '7 3\n42 42\n7 3\n42\n9 2')"
	./$(COMPILER) test/test_nilpy_funcvalue.npy $(TESTTMP)/test_nilpy_funcvalue26
	test "$$($(TESTTMP)/test_nilpy_funcvalue26)" = "$$(printf '%b' 'hi 5\nhi 7\nhi 8\nhi 9\n12\nzero\nhi x\nhi x\nhi y\n10\n5\n42\n5\n15\nvoid x\n10\ns:q\nnoargs\nnoargs')"
	./$(COMPILER) test/test_nilpy_dict_pop.npy $(TESTTMP)/test_nilpy_dict_pop26
	test "$$($(TESTTMP)/test_nilpy_dict_pop26)" = "$$(printf '%b' '1\n99\n1\n0')"
	./$(COMPILER) test/test_nilpy_raise_from.npy $(TESTTMP)/test_nilpy_raise_from26
	test "$$($(TESTTMP)/test_nilpy_raise_from26)" = "$$(printf '%b' '5\ncaught wrapped')"
	./$(COMPILER) test/test_nilpy_file_open.npy $(TESTTMP)/test_nilpy_file_open26
	test "$$($(TESTTMP)/test_nilpy_file_open26)" = "$$(printf '%b' 'alpha\nbeta\ngamma\n3\n3')"
	@# whole-file read() past `with open` + a dict literal as a call argument
	./$(COMPILER) test/test_nilpy_file_io_and_comprehensions.npy $(TESTTMP)/test_nilpy_fileiocompr26
	test "$$($(TESTTMP)/test_nilpy_fileiocompr26)" = "$$(printf '%b' 'alpha\nbeta\ngamma\n\n17\nsource 3')"
	./$(COMPILER) test/test_nilpy_or_and_value.npy $(TESTTMP)/test_nilpy_or_and_value26
	test "$$($(TESTTMP)/test_nilpy_or_and_value26)" = "$$(printf '%b' 'hello\ndefault\ndefault\n2\n0\nin range\nout')"
	./$(COMPILER) test/test_nilpy_ternary_arg.npy $(TESTTMP)/test_nilpy_ternary_arg26
	test "$$($(TESTTMP)/test_nilpy_ternary_arg26)" = "$$(printf '%b' 'pos\nneg\n4')"
	./$(COMPILER) test/test_nilpy_method_kwarg.npy $(TESTTMP)/test_nilpy_method_kwarg26
	test "$$($(TESTTMP)/test_nilpy_method_kwarg26)" = "$$(printf '%b' 'H\ni')"
	./$(COMPILER) test/test_nilpy_variant_subscript.npy $(TESTTMP)/test_nilpy_variant_subscript26
	./$(COMPILER) test/test_nilpy_variant_slice.npy $(TESTTMP)/test_nilpy_variant_slice26
	test "$$($(TESTTMP)/test_nilpy_variant_slice26)" = "$$(printf '%b' 'ab\n3\n2')"
	./$(COMPILER) test/test_nilpy_variant_print_container.npy $(TESTTMP)/test_nilpy_variant_print_container26
	test "$$($(TESTTMP)/test_nilpy_variant_print_container26)" = "$$(printf '%b' '[1, 2]\n[10, 20]\n{\047k\047: 1}\n7\nhi')"
	./$(COMPILER) test/test_nilpy_exception_print.npy $(TESTTMP)/test_nilpy_exception_print26
	test "$$($(TESTTMP)/test_nilpy_exception_print26)" = "$$(printf '%b' 'bad value\nbad value\ngot: bad value\nboom')"
	@# f"{e}" of a caught exception shows its message, like print(e)/str(e)
	./$(COMPILER) test/test_nilpy_exception_fstring_message.npy $(TESTTMP)/test_nilpy_excfstr26
	test "$$($(TESTTMP)/test_nilpy_excfstr26)" = "$$(printf '%b' 'boom\ngot: boom and boom\nbad value')"
	@# builtin runtime errors (div-by-zero, int()/float(), bad subscript,
	@# missing key) raise CATCHABLE exceptions, bare except: and typed
	./$(COMPILER) test/test_nilpy_catchable_runtime_errors.npy $(TESTTMP)/test_nilpy_catchable26
	test "$$($(TESTTMP)/test_nilpy_catchable26)" = "$$(printf '%b' 'caught div (bare)\ncaught floordiv ZeroDivisionError\ncaught truediv ZeroDivisionError\ncaught int() ValueError\ncaught float() ValueError\ncaught IndexError\ncaught KeyError')"
	@# sum/max/min/any/all/sorted/set (already worked) + type(x).__name__ (new)
	./$(COMPILER) test/test_nilpy_aggregate_builtins.npy $(TESTTMP)/test_nilpy_aggbuiltins26
	test "$$($(TESTTMP)/test_nilpy_aggbuiltins26)" = "$$(printf '%b' '6\n3\n1\nTrue\nTrue\n[1, 2, 3]\n3\n[1, 2, 3]\nValueError\nFoo')"
	@# a class body consisting of ONLY `pass` used to error "expected def"
	./$(COMPILER) test/test_nilpy_class_pass_body.npy $(TESTTMP)/test_nilpy_clspass26
	test "$$($(TESTTMP)/test_nilpy_clspass26)" = "$$(printf '%b' 'caught: custom\nMyErr\nmade empty')"
	@# a class field's type inferred from self.x = <ctor param>, incl. inherited
	./$(COMPILER) test/test_nilpy_class_field_infer_from_ctor.npy $(TESTTMP)/test_nilpy_fieldinfer26
	test "$$($(TESTTMP)/test_nilpy_fieldinfer26)" = "$$(printf '%b' '5 five\n1 one 3.14\n4 8')"
	@# `**`, `/=` (true division augmented-assign, distinct from `//=`), divmod()
	./$(COMPILER) test/test_nilpy_power_divmod_truediv.npy $(TESTTMP)/test_nilpy_powdivmod26
	test "$$($(TESTTMP)/test_nilpy_powdivmod26)" = "$$(printf '%b' '1024\n0.25\n1\n-4\n-8\n512\n8.0\n9.0\n0.75\n3.5\n(3, 1)\n(-4, 1)\n(3.0, 1.5)')"
	...
	test "$$($(TESTTMP)/test_nilpy_mapfilter26)" = "$$(printf '%b' '[2, 4, 6]\n[1, 2, 3]\n[3, 6, 9]\n[1, 2, 3]\n[2, 3]\n[2, 3]\n[1, 2, 3]')"
	...
	./$(COMPILER) test/test_nilpy_dunder_len_contains.npy $(TESTTMP)/test_nilpy_dunderlc26
	test "$$($(TESTTMP)/test_nilpy_dunderlc26)" = "$$(printf '%b' '3\nTrue\nFalse\nFalse\n3\n5\n2\nTrue\nTrue\ncaught len: TypeError\ncaught in: TypeError')"
	...
	./$(COMPILER) test/test_nilpy_dunder_call.npy $(TESTTMP)/test_nilpy_dundercall26
	test "$$($(TESTTMP)/test_nilpy_dundercall26)" = "$$(printf '%b' '15\n25\nhi\n6\ncaught: TypeError\ndict: 6\nlist: 7\ncall result: 103\nparam 1: 9\nparam 0: hi\nparam 3: 7\ninherited: 15\ninherited via dict: 15\ndynamic no-__call__: TypeError')"
	@# a class defining __getitem__/__setitem__ routes subscript read/write
	./$(COMPILER) test/test_nilpy_dunder_getitem_setitem.npy $(TESTTMP)/test_nilpy_dundergetset26
	test "$$($(TESTTMP)/test_nilpy_dundergetset26)" = "$$(printf '%b' '20\n99\n[10, 99, 30]\n42\n-1\n10\ncaught: TypeError')"
	...
	./$(COMPILER) test/test_nilpy_bytes_decode.npy $(TESTTMP)/test_nilpy_bytesdec26
	test "$$($(TESTTMP)/test_nilpy_bytesdec26)" = "$$(printf '%b' 'abc\nabc\n3\nabc!\nTrue\nhi')"
	...
	./$(COMPILER) test/test_nilpy_with_protocol.npy $(TESTTMP)/test_nilpy_withproto26
	test "$$($(TESTTMP)/test_nilpy_withproto26)" = "$$(printf '%b' 'enter one\nbody sees ENTERVAL-one\nexit one\nenter two\nexit two\ncaught after exit\nenter outer\nenter inner\nnested body\nexit inner\nexit outer\nenter bare\nbare body\nexit bare\nfiledata\ndone')"
	...
	./$(COMPILER) test/test_nilpy_unsupported_operand_raises.npy $(TESTTMP)/test_nilpy_unsupop26
	test "$$($(TESTTMP)/test_nilpy_unsupop26)" = "$$(printf '%b' 'caught add\ncaught sub\ncaught mul\ncaught truediv\ncaught neg\ncaught list concat\nstill running\n7')"
	...
	./$(COMPILER) test/test_nilpy_dunder_reflected.npy $(TESTTMP)/test_nilpy_dunderrf26
	test "$$($(TESTTMP)/test_nilpy_dunderrf26)" = "$$(printf '%b' 'radd:3\nrsub:3\nrmul:3\nrtruediv:3\nrfloordiv:3\nrmod:3\nrpow:3\nradd:10\ndirect\nreflected\n7 -1 12 4.0 3 1 32\nab [1, 2] abab')"
	@# __floordiv__ / __mod__ / __pow__; str % stays FORMATTING, numeric // % **
	@# unaffected (incl. negative-operand rules)
	./$(COMPILER) test/test_nilpy_dunder_arith2.npy $(TESTTMP)/test_nilpy_dunderar226
	test "$$($(TESTTMP)/test_nilpy_dunderar226)" = "$$(printf '%b' '2\n1\n343\nFLOORDIV\nMOD\nPOW\n2 -3 1 2 1024\n3.0 1.5\n5 apples')"
	@# unary dunders: abs() -> __abs__, ~ -> __invert__; no dunder = TypeError
	./$(COMPILER) test/test_nilpy_dunder_unary.npy $(TESTTMP)/test_nilpy_dunderun26
	test "$$($(TESTTMP)/test_nilpy_dunderun26)" = "$$(printf '%b' '5\n7\nINVERTED\ncaught invert\n30\n9 9 2.5\n-1 -6 0')"
	...
	./$(COMPILER) test/test_nilpy_dunder_bitwise.npy $(TESTTMP)/test_nilpy_dunderbit26
	test "$$($(TESTTMP)/test_nilpy_dunderbit26)" = "$$(printf '%b' 'AND1\nOR2\nXOR3\nLSHIFT4\nRSHIFT5\ncaught and\ncaught lshift\n[2, 3]\n[1, 2, 3]\n[1, 3]\n2\n2 7 5 16 8')"
	@# `!=` prefers a declared __ne__ (CPython calls it rather than negating
	@# __eq__); with only __eq__ the negation is still derived
	./$(COMPILER) test/test_nilpy_dunder_ne.npy $(TESTTMP)/test_nilpy_dunderne26
	test "$$($(TESTTMP)/test_nilpy_dunderne26)" = "$$(printf '%b' 'NE-CALLED\nNE-CALLED\nTrue\nFalse\nFalse\nTrue\nTrue\nFalse\nTrue\nTrue\nFalse\nTrue')"
	...
	./$(COMPILER) test/test_nilpy_list_ordering.npy $(TESTTMP)/test_nilpy_listord26
	test "$$($(TESTTMP)/test_nilpy_listord26)" = "$$(printf '%b' 'content < False\ncontent > True\ncontent <= False\ncontent >= True\neq < False\neq <= True\neq > False\neq >= True\nprefix < False\nprefix > True\nplain < True\nnested < False\neq == True\nne != True')"
	...
	./$(COMPILER) test/test_nilpy_dunder_bool.npy $(TESTTMP)/test_nilpy_dunderbool26
	test "$$($(TESTTMP)/test_nilpy_dunderbool26)" = "$$(printf '%b' 'boolfalse falsy\nbooltrue truthy\nlenzero falsy\nlentwo truthy\nboth falsy\nplain truthy\nnot boolfalse True\nnot booltrue False\nnot lenzero True\nnot lentwo False\nnot both True\nnot plain False\ntemp falsy\nor fallback\nand kept')"
	...
	./$(COMPILER) test/test_nilpy_dunder_ordering.npy $(TESTTMP)/test_nilpy_dunderord26
	test "$$($(TESTTMP)/test_nilpy_dunderord26)" = "$$(printf '%b' 'False\nTrue\nFalse\nTrue\nTrue\nFalse\nFalse\nTrue\ncaught lt: TypeError\nFalse')"
	...
	./$(COMPILER) test/test_nilpy_module_block_scope.npy $(TESTTMP)/test_nilpy_modblockscope26
	test "$$($(TESTTMP)/test_nilpy_modblockscope26)" = "$$(printf '%b' '3\n4\n4\n5\n7\nTrue\n5\n3\n2')"
	...
	test "$$($(TESTTMP)/test_nilpy_novmkey26)" = "[42, 43]"
	...
	test "$$($(TESTTMP)/test_nilpy_pyevalpow26)" = "[1024, 512, -4, 0.5]"
	...
	./$(COMPILER) test/test_nilpy_promo_local_zero_init.npy $(TESTTMP)/test_nilpy_promozero26
	test "$$($(TESTTMP)/test_nilpy_promozero26)" = "1"
	@# select.select() actually polls (it was a stub answering "nothing ready")
	./$(COMPILER) test/test_nilpy_select_stdin_ready.npy $(TESTTMP)/test_nilpy_selready26
	$(TESTTMP)/test_nilpy_selready26 < test/test_nilpy_select_stdin_ready.stdin | diff -u test/test_nilpy_select_stdin_ready.expected -
	@# a host method whose params MIX a variant with register-sized kinds
	./$(COMPILER) test/test_nilpy_pyeval_host_mixed_params.npy $(TESTTMP)/test_nilpy_pyevalmix26
	$(TESTTMP)/test_nilpy_pyevalmix26 | diff -u test/test_nilpy_pyeval_host_mixed_params.expected -
	...
	test "$$($(TESTTMP)/test_nilpy_dynattr26)" = "$$(printf '%b' '105\n110')"
	./$(COMPILER) test/test_nilpy_dynattr_class.npy $(TESTTMP)/test_nilpy_dynattr_class26
	test "$$($(TESTTMP)/test_nilpy_dynattr_class26)" = "105"
	./$(COMPILER) test/test_nilpy_dynattr_augassign.npy $(TESTTMP)/test_nilpy_dynattr_augassign26
	test "$$($(TESTTMP)/test_nilpy_dynattr_augassign26)" = "15"
	./$(COMPILER) test/test_nilpy_lambda_stub.npy $(TESTTMP)/test_nilpy_lambda_stub26
	test "$$($(TESTTMP)/test_nilpy_lambda_stub26)" = "$$(printf '%b' 'A\nB\nok')"
	...
	./$(COMPILER) test/test_nilpy_encode_decode_codecs.npy $(TESTTMP)/test_nilpy_codecs26
	$(TESTTMP)/test_nilpy_codecs26 | diff -u test/test_nilpy_encode_decode_codecs.expected -
	...
	test "$$($(TESTTMP)/test_nilpy_list_comp26)" = "$$(printf '%b' '1\n4\n9\n16\n10\n11\n12\n2\n3\n4')"
	./$(COMPILER) test/test_nilpy_str_concat.npy $(TESTTMP)/test_nilpy_str_concat26
	test "$$($(TESTTMP)/test_nilpy_str_concat26)" = "$$(printf '%b' 'abcd\nefgh\nx=5 t=hi end\nplain and 5\nfirst line second line')"
	./$(COMPILER) test/test_nilpy_trailing_comma.npy $(TESTTMP)/test_nilpy_trailing_comma26
	test "$$($(TESTTMP)/test_nilpy_trailing_comma26)" = "$$(printf '%b' 'exec mode=interpret token=dup\n7')"
	./$(COMPILER) test/test_nilpy_for_variant.npy $(TESTTMP)/test_nilpy_for_variant26
	test "$$($(TESTTMP)/test_nilpy_for_variant26)" = "$$(printf '%b' '10\n20\n30')"
	./$(COMPILER) test/test_nilpy_unpack_callable.npy $(TESTTMP)/test_nilpy_unpack_callable26
	test "$$($(TESTTMP)/test_nilpy_unpack_callable26)" = "$$(printf '%b' 'native ran\n5\n6\n7\n8')"
	...
	./$(COMPILER) test/test_nilpy_void_def_value_call.npy $(TESTTMP)/test_nilpy_voiddefval26
	test "$$($(TESTTMP)/test_nilpy_voiddefval26)" = "$$(printf '%b' 'native ran\nNone\ndone\nNone\n1')"
	./$(COMPILER) test/test_nilpy_optional_return.npy $(TESTTMP)/test_nilpy_optional_return26
	test "$$($(TESTTMP)/test_nilpy_optional_return26)" = "$$(printf '%b' 'native\nternary ok\n7')"
	./$(COMPILER) test/test_nilpy_encode.npy $(TESTTMP)/test_nilpy_encode26
	test "$$($(TESTTMP)/test_nilpy_encode26)" = "$$(printf '%b' '3\n65\n67\n2\nhi\nhi\n4\n90\n2\nb')"
	./$(COMPILER) test/test_nilpy_bytes_ann.npy $(TESTTMP)/test_nilpy_bytes_ann26
	./$(COMPILER) test/test_nilpy_bytes_literal.npy $(TESTTMP)/test_nilpy_bytes_literal26
	test "$$($(TESTTMP)/test_nilpy_bytes_literal26)" = "$$(printf '%b' '5\n104\n1\n-1\n4')"
	./$(COMPILER) test/test_nilpy_method_str_chain.npy $(TESTTMP)/test_nilpy_method_str_chain26
	test "$$($(TESTTMP)/test_nilpy_method_str_chain26)" = "HI"
	test "$$($(TESTTMP)/test_nilpy_bytes_ann26)" = "$$(printf '%b' '3\n65\n0')"
	./$(COMPILER) test/test_nilpy_tuples.npy $(TESTTMP)/test_nilpy_tuples26
	test "$$($(TESTTMP)/test_nilpy_tuples26)" = "$$(printf '%b' 'ab\ncd\nef\n6\np\nq\n3\n5\n6')"
	./$(COMPILER) test/test_nilpy_tuple_in_find.npy $(TESTTMP)/test_nilpy_tuple_in_find26
	test "$$($(TESTTMP)/test_nilpy_tuple_in_find26)" = "$$(printf '%b' 'True\nTrue\nFalse\n3\n1\n4\n-1\n3\n-1')"
	./$(COMPILER) test/test_nilpy_expr_arg.npy $(TESTTMP)/test_nilpy_expr_arg26
	test "$$($(TESTTMP)/test_nilpy_expr_arg26)" = "$$(printf '%b' 'xy\n|x|\n|y|\n4\n6')"
	./$(COMPILER) test/test_nilpy_attrs.npy $(TESTTMP)/test_nilpy_attrs26
	test "$$($(TESTTMP)/test_nilpy_attrs26)" = "$$(printf '%b' 'True\nFalse\n7\nhi\n42\nfallback')"
	./$(COMPILER) test/test_nilpy_stmt_after_for.npy $(TESTTMP)/test_nilpy_stmt_after_for26
	test "$$($(TESTTMP)/test_nilpy_stmt_after_for26)" = "$$(printf '%b' '3\n3\n2\n90')"
	./$(COMPILER) test/test_nilpy_ctor_kwargs.npy $(TESTTMP)/test_nilpy_ctor_kwargs26
	test "$$($(TESTTMP)/test_nilpy_ctor_kwargs26)" = "$$(printf '%b' 'dup\n3\nTrue\nswap\n7\nFalse\nover\n9\n\n0')"
	./$(COMPILER) test/test_nilpy_variant_bitwise.npy $(TESTTMP)/test_nilpy_variant_bitwise26
	test "$$($(TESTTMP)/test_nilpy_variant_bitwise26)" = "$$(printf '%b' '44\n255\n240\n256\n16\n-4\n255\n1\n3\ncaught RuntimeError\ncaught via Exception base')"
	./$(COMPILER) test/test_nilpy_property.npy $(TESTTMP)/test_nilpy_property26
	$(TESTTMP)/test_nilpy_property26 | diff -u test/test_nilpy_property.expected -
	./$(COMPILER) test/test_nilpy_float_conv.npy $(TESTTMP)/test_nilpy_float_conv26
	test "$$($(TESTTMP)/test_nilpy_float_conv26)" = "$$(printf '%b' '3.5\n-2.25\n10.0\n1000.0\n0.025\n7.0\n3.5\ncaught float ValueError\ncaught empty float\ndone')"
	./$(COMPILER) test/test_nilpy_none_local.npy $(TESTTMP)/test_nilpy_none_local26
	test "$$($(TESTTMP)/test_nilpy_none_local26)" = "$$(printf '%b' '97\n-1')"
	./$(COMPILER) test/test_nilpy_int_base.npy $(TESTTMP)/test_nilpy_int_base26
	test "$$($(TESTTMP)/test_nilpy_int_base26)" = "$$(printf '255\n2\n511\n-26\n255\n42\n7\n1295\ncaught ValueError\ncaught empty\ncaught bad base\ndone')"
	./$(COMPILER) test/test_nilpy_ternary.npy $(TESTTMP)/test_nilpy_ternary26
	test "$$($(TESTTMP)/test_nilpy_ternary26)" = "$$(printf '%b' '-1\n0\npos\nb\nc\n10\n20')"
	./$(COMPILER) test/test_nilpy_os_path.npy $(TESTTMP)/test_nilpy_os_path26
	test "$$($(TESTTMP)/test_nilpy_os_path26)" = "$$(printf 'True\nFalse\n/a/b\n/a/b\n/b\n/a/b\n/\n\nTrue\nFalse\n/a/c\n/a/b')"
	./$(COMPILER) test/test_nilpy_suites.npy $(TESTTMP)/test_nilpy_suites26
	test "$$($(TESTTMP)/test_nilpy_suites26)" = "$$(printf '0\n1\n2\n14\n1\n2\n3\nbig\n3')"
	./$(COMPILER) test/test_nilpy_truthiness.npy $(TESTTMP)/test_nilpy_truthiness26
	test "$$($(TESTTMP)/test_nilpy_truthiness26)" = "$$(printf 's truthy\ne falsy\nnot s -> False\nTrue\nFalse')"
	./$(COMPILER) test/test_nilpy_print_kwargs.npy $(TESTTMP)/test_nilpy_print_kwargs26
	test "$$($(TESTTMP)/test_nilpy_print_kwargs26 2>/dev/null)" = "$$(printf 'ab\nx|y|\nplain\nmulti 1 2\nafter stderr\nnl end\nflush only')"
	test "$$($(TESTTMP)/test_nilpy_print_kwargs26 2>&1 >/dev/null)" = "to stderr"
	./$(COMPILER) test/test_nilpy_to_bytes.npy $(TESTTMP)/test_nilpy_to_bytes26
	test "$$($(TESTTMP)/test_nilpy_to_bytes26)" = "$$(printf '8\n10\n0\n10\n254\n255\n-2\n255\n0\n255\n-1\n255\n8\n44\n1\n300\n300\n4\n258\n-2\n6\n8 0 4\n1 2 2\n71\n70\n71\n201\n10\n8 101\n9\n8 0 1\n1 70\n9\n[1, 2, 8]')"
	...
	./$(COMPILER) test/test_nilpy_input_builtin.npy $(TESTTMP)/test_nilpy_input26
	test "$$(printf 'one\ntwo\n' | $(TESTTMP)/test_nilpy_input26)" = "$$(printf 'first:one\nprompt> second:two\n3 3\nONE\none-two\no t\nTrue False')"
	...
	./$(COMPILER) test/test_nilpy_input_eof_raises.npy $(TESTTMP)/test_nilpy_input_eof26
	$(TESTTMP)/test_nilpy_input_eof26 < test/test_nilpy_input_eof_raises.stdin | diff -u test/test_nilpy_input_eof_raises.expected -
	...
	test "$$($(TESTTMP)/test_nilpy_format_multiarg26)" = "$$(printf '1 two 3.5\n1 3.5 two\n3.5-3.5\n    1|two  |3.50\n1 2 3 4 5 6 7 8\n1\n1 two\ntwotwo\n   1\n{literal} 1\nplain')"
	@# list(<bytes>)/tuple(<bytes>) — the byte VALUES, not an empty list
	./$(COMPILER) test/test_nilpy_list_of_bytes.npy $(TESTTMP)/test_nilpy_list_of_bytes26
	test "$$($(TESTTMP)/test_nilpy_list_of_bytes26)" = "$$(printf '[44, 1, 0, 0, 0, 0, 0, 0]\n(44, 1, 0, 0, 0, 0, 0, 0)\n8\n44\n1\n45\n[44, 1, 0, 0]\n[44, 1, 0, 0]\n[]')"
	@# the guard: a user class declaring to_bytes must win over the intrinsic
	./$(COMPILER) test/test_nilpy_to_bytes_user_class_wins.npy $(TESTTMP)/test_nilpy_tb_userwins26
	test "$$($(TESTTMP)/test_nilpy_tb_userwins26)" = "$$(printf 'packet:7\npacket:1\nframe:2\nreg:16\nreg:32\nregcount:8')"
	./$(COMPILER) test/test_nilpy_comp_iterable.npy $(TESTTMP)/test_nilpy_comp_iterable26
	test "$$($(TESTTMP)/test_nilpy_comp_iterable26)" = "$$(printf '2\n3\n4\nr 0\nr 1\nr 2\n66')"
	./$(COMPILER) test/test_nilpy_mixed_return_variant.npy $(TESTTMP)/test_nilpy_mixed_return_variant26
	test "$$($(TESTTMP)/test_nilpy_mixed_return_variant26)" = "$$(printf 'pos\n42\n1 2\na b\n43')"
	./$(COMPILER) test/test_nilpy_variant_str_boxing.npy $(TESTTMP)/test_nilpy_variant_str_boxing26
	test "$$($(TESTTMP)/test_nilpy_variant_str_boxing26)" = "$$(printf 'hello changed\nabcdef\npos\n500000 abcdef')"
	./$(COMPILER) test/test_nilpy_escape_decode.npy $(TESTTMP)/test_nilpy_escape_decode26
	test "$$($(TESTTMP)/test_nilpy_escape_decode26)" = "$$(printf '2\n0 255\n3 65 99\n3\n1\n5\n4')"
	./$(COMPILER) test/test_nilpy_comp_filter.npy $(TESTTMP)/test_nilpy_comp_filter26
	test "$$($(TESTTMP)/test_nilpy_comp_filter26)" = "$$(printf '4 2 5\n3 0 4 8\n0\n4 16\n2 ab cde\n3\n3')"
	...
	test "$$($(TESTTMP)/test_nilpy_implret26)" = "$$(printf '1073794252\n0\nTrue\n0\nTrue')"
	...
	test "$$($(TESTTMP)/test_nilpy_chrrange26)" = "$$(printf '%b' 'A\n233\n€ 8364\n日 1\n128512 1\ncaught: chr out of range\ncaught: chr negative')"
	@# min()/max() over a bare string (any iterable), not just a list or two scalars
	./$(COMPILER) test/test_nilpy_minmax_over_string.npy $(TESTTMP)/test_nilpy_minmax26
	test "$$($(TESTTMP)/test_nilpy_minmax26)" = "$$(printf '%b' 'c\na\n3\n1\n7\n2.1')"
	@# "{} and {}".format(a, b) -- two positional placeholders, not just one
	./$(COMPILER) test/test_nilpy_str_format_multiarg.npy $(TESTTMP)/test_nilpy_fmtmulti26
	test "$$($(TESTTMP)/test_nilpy_fmtmulti26)" = "$$(printf 'a and 2\n3.1 then x\n5')"
	@# math.fabs and os.path.basename were unresolvable names
	./$(COMPILER) test/test_nilpy_math_fabs_os_basename.npy $(TESTTMP)/test_nilpy_mathos26
	test "$$($(TESTTMP)/test_nilpy_mathos26)" = "$$(printf '3.5\n2.0\nc.txt\n\nnoslash')"
	@# a unit-level proc called qualified can omit a trailing defaulted parameter
	./$(COMPILER) test/test_nilpy_qualified_proc_omitted_default.npy $(TESTTMP)/test_nilpy_qualdefault26
	test "$$($(TESTTMP)/test_nilpy_qualdefault26)" = "$$(printf 'a 0\nb 5\nc 0 False\nd 7 True')"
	...
	./$(COMPILER) test/test_nilpy_kwarg_overload_set.npy $(TESTTMP)/test_nilpy_kwovlset26
	test "$$($(TESTTMP)/test_nilpy_kwovlset26)" = "$$(printf 'hi\nhi\nHI\nhi\nraw: a raw string\nnamed color=red width=3\nnamed color= width=9')"
	@# a lambda value stored in a name and CALLED, not just passed around
	./$(COMPILER) test/test_nilpy_lambda_real_value.npy $(TESTTMP)/test_nilpy_lambdareal26
	test "$$($(TESTTMP)/test_nilpy_lambdareal26)" = "$$(printf '6\n12')"
	@# map()/filter() over a lambda and a named def, via list() and via for
	./$(COMPILER) test/test_nilpy_map_filter_lambda_def.npy $(TESTTMP)/test_nilpy_mapfilterld26
	test "$$($(TESTTMP)/test_nilpy_mapfilterld26)" = "$$(printf '%b' '[2, 3, 4]\n[2, 3, 4]\n[2, 3]\n2\n4\n6\n2\n3\n[2, 4, 6]\n[2, 3]\n2\n4\n6\n2\n3')"
	...
	test "$$($(TESTTMP)/test_nilpy_noneresid26)" = "$$(printf 'None\nTrue\nhi')"
	@# a bare generator expression as a call argument and in a return statement
	./$(COMPILER) test/test_nilpy_genexpr_arg.npy $(TESTTMP)/test_nilpy_genexprarg26
	test "$$($(TESTTMP)/test_nilpy_genexprarg26)" = "$$(printf '%b' 'def __body__():\n    a\n    b\n    c\n12\n[2, 3, 4]\nTrue')"
	...
	./$(COMPILER) test/test_nilpy_closure_captured_default_and_slice_assign.npy $(TESTTMP)/test_nilpy_closuredefslice26
	test "$$($(TESTTMP)/test_nilpy_closuredefslice26)" = "$$(printf 'hi\n97 98 99 97 98 99')"
	@# str.join preallocated instead of reallocating per item (perf)
	./$(COMPILER) test/test_nilpy_str_join_perf_fix.npy $(TESTTMP)/test_nilpy_joinperf26
	test "$$($(TESTTMP)/test_nilpy_joinperf26)" = "$$(printf '%b' 'a,bb,ccc\nxyz\n\nsingle\none, two, three, four\ncaught type error')"
	./$(COMPILER) test/test_nilpy_return_none_variant.npy $(TESTTMP)/test_nilpy_return_none_variant26
	test "$$($(TESTTMP)/test_nilpy_return_none_variant26)" = "$$(printf 'a NONE\nb NONE\nc 9')"
	...
	test "$$($(TESTTMP)/test_nilpy_slices26)" = "$$(printf 'cde\nabc\nfgh\nabcdefgh\nfgh\nab\ndef\n\n\nab\n3\n3\n65\n67\n2\n66\n90\n65\n66\n0\n3\n20\n20\n40\n50\n5')"
	./$(COMPILER) test/test_nilpy_set.npy $(TESTTMP)/test_nilpy_set26
	test "$$($(TESTTMP)/test_nilpy_set26)" = "$$(printf '1\n3\nTrue\nTrue\nFalse\nTrue\n0\n2\nTrue\nFalse\n2\nTrue\nFalse\n1')"
	./$(COMPILER) test/test_nilpy_dict.npy $(TESTTMP)/test_nilpy_dict26
	test "$$($(TESTTMP)/test_nilpy_dict26)" = "$$(printf '2\n3\n2\nTrue\nFalse\n3\n-1\n2\n200\n1\nFalse\n2\n2\n7\n8\n2\n1\n2\n0\n1\n3\nFalse\n0\nFalse\n9\n1\n4\n1')"
	./$(COMPILER) test/test_nilpy_literals.npy $(TESTTMP)/test_nilpy_literals26
	test "$$($(TESTTMP)/test_nilpy_literals26)" = "$$(printf '65536\n15\n10\n1000000\ntri\nple')"
	./$(COMPILER) test/test_nilpy_operators.npy $(TESTTMP)/test_nilpy_operators26
	test "$$($(TESTTMP)/test_nilpy_operators26)" = "$$(printf '61440\n65535\n3855\n1024\n256\n255\n32\n240\n15\n12\n24\n4\n1\n8\n9\n6\n96\n24\n142\n140\n2.5\n2.0\n3')"
	./$(COMPILER) test/test_nilpy_annotated.npy $(TESTTMP)/test_nilpy_annotated26
	test "$$($(TESTTMP)/test_nilpy_annotated26)" = "$$(printf 'True\n42\n1.5\nhi')"
	./$(COMPILER) test/test_nilpy_list.npy $(TESTTMP)/test_nilpy_list26
	test "$$($(TESTTMP)/test_nilpy_list26)" = "$$(printf '3\n1\n2\n3\n3\n4\n10\n42\n10\n3\n0\nhello\n2.5\nTrue\n3\n9\n1\n2\n0\n3\na\nccc\n2\n20\n2')"
	./$(COMPILER) test/test_nilpy_factory.npy $(TESTTMP)/test_nilpy_factory26
	test "$$($(TESTTMP)/test_nilpy_factory26)" = "$$(printf '0\n0\n2\n0\n6')"
	./$(COMPILER) test/test_nilpy_classvar_counter.npy $(TESTTMP)/test_nilpy_classvar_counter26
	test "$$($(TESTTMP)/test_nilpy_classvar_counter26)" = "$$(printf 'dup 1\nswap 2\ndrop 3')"
	./$(COMPILER) test/test_nilpy_membership.npy $(TESTTMP)/test_nilpy_membership26
	test "$$($(TESTTMP)/test_nilpy_membership26)" = "$$(printf 'True\nFalse\nTrue\nTrue\nFalse\nTrue\nTrue\nFalse\nFalse\nTrue\nTrue\nFalse\n3\n7\n3\n7\n-1\n2.5')"
	...
	./$(COMPILER) test/test_nilpy_membership_eq_dunder.npy $(TESTTMP)/test_nilpy_memeq26
	$(TESTTMP)/test_nilpy_memeq26 | diff -u test/test_nilpy_membership_eq_dunder.expected -
	...
	./$(COMPILER) test/test_nilpy_user_hash_dict_key.npy $(TESTTMP)/test_nilpy_userhash26
	$(TESTTMP)/test_nilpy_userhash26 | diff -u test/test_nilpy_user_hash_dict_key.expected -
	...
	./$(COMPILER) test/test_nilpy_intrinsic_result_chain.npy $(TESTTMP)/test_nilpy_chain26
	$(TESTTMP)/test_nilpy_chain26 | diff -u test/test_nilpy_intrinsic_result_chain.expected -
	...
	./$(COMPILER) test/test_nilpy_file_read_follows_the_mode.npy $(TESTTMP)/test_nilpy_readmode26
	$(TESTTMP)/test_nilpy_readmode26 | diff -u test/test_nilpy_file_read_follows_the_mode.expected -
	...
	./$(COMPILER) test/test_nilpy_isinstance_over_a_type_value.npy $(TESTTMP)/test_nilpy_isinstval26
	$(TESTTMP)/test_nilpy_isinstval26 | diff -u test/test_nilpy_isinstance_over_a_type_value.expected -
	...
	./$(COMPILER) test/test_nilpy_multi_param_lambda_is_compiled.npy $(TESTTMP)/test_nilpy_mplam26
	$(TESTTMP)/test_nilpy_mplam26 | diff -u test/test_nilpy_multi_param_lambda_is_compiled.expected -
	test "$$(strings $(TESTTMP)/test_nilpy_mplam26 | grep -cE 'a \+ b \+ k|a \* b \+ c|x \* 2')" = "0"
	...
	./$(COMPILER) test/test_nilpy_arity_four_dynamic_call.npy $(TESTTMP)/test_nilpy_a4call26
	$(TESTTMP)/test_nilpy_a4call26 | diff -u test/test_nilpy_arity_four_dynamic_call.expected -
	...
	./$(COMPILER) test/test_nilpy_pyeval_errors_are_catchable.npy $(TESTTMP)/test_nilpy_pyevalerr26
	$(TESTTMP)/test_nilpy_pyevalerr26 | diff -u test/test_nilpy_pyeval_errors_are_catchable.expected -
	...
	./$(COMPILER) test/test_nilpy_hash_builtin.npy $(TESTTMP)/test_nilpy_hash26
	$(TESTTMP)/test_nilpy_hash26 | diff -u test/test_nilpy_hash_builtin.expected -
	! ./$(COMPILER) test/test_nilpy_isinstance_unknown_type_fail.npy $(TESTTMP)/test_nilpy_isinstfail26 2>&1 | grep -q 'ok:'
	...
	./$(COMPILER) test/test_nilpy_sort_lt_dunder.npy $(TESTTMP)/test_nilpy_sortlt26
	$(TESTTMP)/test_nilpy_sortlt26 | diff -u test/test_nilpy_sort_lt_dunder.expected -
	...
	./$(COMPILER) test/test_nilpy_divmod_dunder.npy $(TESTTMP)/test_nilpy_divmod26
	$(TESTTMP)/test_nilpy_divmod26 | diff -u test/test_nilpy_divmod_dunder.expected -
	...
	./$(COMPILER) test/test_nilpy_repr_of_user_object.npy $(TESTTMP)/test_nilpy_reprobj26
	$(TESTTMP)/test_nilpy_reprobj26 | diff -u test/test_nilpy_repr_of_user_object.expected -
	...
	./$(COMPILER) test/test_nilpy_delitem_dunder.npy $(TESTTMP)/test_nilpy_delitem26
	$(TESTTMP)/test_nilpy_delitem26 | diff -u test/test_nilpy_delitem_dunder.expected -
	...
	$(TESTTMP)/test_nilpy_blkrebind26 | diff -u test/test_nilpy_block_nested_rebind_widens.expected -
	# a COUNT-FIRST sequence repeat returned from a def (`return u * [7]`) infers
	# as the sequence, not Integer. Controls pin ordinary `*` and `**`.
	./$(COMPILER) test/test_nilpy_reversed_sequence_repeat_return.npy $(TESTTMP)/test_nilpy_revrepeat26
	$(TESTTMP)/test_nilpy_revrepeat26 | diff -u test/test_nilpy_reversed_sequence_repeat_return.expected -
	...
	./$(COMPILER) test/test_nilpy_pow_domain.npy $(TESTTMP)/test_nilpy_powdomain26
	$(TESTTMP)/test_nilpy_powdomain26 | diff -u test/test_nilpy_pow_domain.expected -
	...
	./$(COMPILER) test/test_nilpy_kwarg_with_star_params.npy $(TESTTMP)/test_nilpy_kwstar26
	$(TESTTMP)/test_nilpy_kwstar26 | diff -u test/test_nilpy_kwarg_with_star_params.expected -
	# str.isascii() -- note the EMPTY string is True, unlike its isspace/isdigit
	# siblings which are False.
	./$(COMPILER) test/test_nilpy_str_isascii.npy $(TESTTMP)/test_nilpy_isascii26
	$(TESTTMP)/test_nilpy_isascii26 | diff -u test/test_nilpy_str_isascii.expected -
	...
	./$(COMPILER) test/test_nilpy_str_as_an_iterable_argument.npy $(TESTTMP)/test_nilpy_striter26
	$(TESTTMP)/test_nilpy_striter26 | diff -u test/test_nilpy_str_as_an_iterable_argument.expected -
	...
	./$(COMPILER) test/test_nilpy_set_star_spread_dedups.npy $(TESTTMP)/test_nilpy_setstar26
	$(TESTTMP)/test_nilpy_setstar26 | diff -u test/test_nilpy_set_star_spread_dedups.expected -
	# bytes.hex() -- zero-padded to two digits per byte, lowercase.
	./$(COMPILER) test/test_nilpy_bytes_hex.npy $(TESTTMP)/test_nilpy_byteshex26
	$(TESTTMP)/test_nilpy_byteshex26 | diff -u test/test_nilpy_bytes_hex.expected -
	...
	./$(COMPILER) test/test_nilpy_bytearray_vs_bytes.npy $(TESTTMP)/test_nilpy_bavsb26
	$(TESTTMP)/test_nilpy_bavsb26 | diff -u test/test_nilpy_bytearray_vs_bytes.expected -
	...
	./$(COMPILER) test/test_nilpy_set_dict_gaps.npy $(TESTTMP)/test_nilpy_setdictgaps26
	$(TESTTMP)/test_nilpy_setdictgaps26 | diff -u test/test_nilpy_set_dict_gaps.expected -
	...
	./$(COMPILER) test/test_nilpy_str_translate.npy $(TESTTMP)/test_nilpy_strtrans26
	$(TESTTMP)/test_nilpy_strtrans26 | diff -u test/test_nilpy_str_translate.expected -
	...
	./$(COMPILER) test/test_nilpy_repr_of_variant_object.npy $(TESTTMP)/test_nilpy_reprvar26
	$(TESTTMP)/test_nilpy_reprvar26 | diff -u test/test_nilpy_repr_of_variant_object.expected -
	...
	./$(COMPILER) test/test_nilpy_dict_update_variant.npy $(TESTTMP)/test_nilpy_dictupdv26
	$(TESTTMP)/test_nilpy_dictupdv26 | diff -u test/test_nilpy_dict_update_variant.expected -
	...
	./$(COMPILER) test/test_nilpy_builtin_type_as_a_value.npy $(TESTTMP)/test_nilpy_btypeval26
	$(TESTTMP)/test_nilpy_btypeval26 | diff -u test/test_nilpy_builtin_type_as_a_value.expected -
	...
	./$(COMPILER) test/test_nilpy_nested_loop_target.npy $(TESTTMP)/test_nilpy_nestedtgt26
	$(TESTTMP)/test_nilpy_nestedtgt26 | diff -u test/test_nilpy_nested_loop_target.expected -
	...
	./$(COMPILER) test/test_nilpy_block_unreadable_binding_widens.npy $(TESTTMP)/test_nilpy_blkunk26
	$(TESTTMP)/test_nilpy_blkunk26 | diff -u test/test_nilpy_block_unreadable_binding_widens.expected -
	...
	./$(COMPILER) test/test_nilpy_id_and_ascii_builtins.npy $(TESTTMP)/test_nilpy_idascii26
	$(TESTTMP)/test_nilpy_idascii26 | diff -u test/test_nilpy_id_and_ascii_builtins.expected -
	...
	./$(COMPILER) test/test_nilpy_call_arg_count_braces_and_trailing_comma.npy $(TESTTMP)/test_nilpy_argcnt26
	$(TESTTMP)/test_nilpy_argcnt26 | diff -u test/test_nilpy_call_arg_count_braces_and_trailing_comma.expected -
	...
	./$(COMPILER) test/test_nilpy_attr_off_subscript_of_call_result.npy $(TESTTMP)/test_nilpy_attrsub26
	$(TESTTMP)/test_nilpy_attrsub26 | diff -u test/test_nilpy_attr_off_subscript_of_call_result.expected -
	...
	./$(COMPILER) test/test_nilpy_issubclass.npy $(TESTTMP)/test_nilpy_issub26
	$(TESTTMP)/test_nilpy_issub26 | diff -u test/test_nilpy_issubclass.expected -
	...
	./$(COMPILER) test/test_nilpy_set_augmented_union.npy $(TESTTMP)/test_nilpy_setaug26
	$(TESTTMP)/test_nilpy_setaug26 | diff -u test/test_nilpy_set_augmented_union.expected -
	...
	./$(COMPILER) test/test_nilpy_selector_off_call_returning_a_global.npy $(TESTTMP)/test_nilpy_selglob26
	$(TESTTMP)/test_nilpy_selglob26 | diff -u test/test_nilpy_selector_off_call_returning_a_global.expected -
	...
	./$(COMPILER) test/test_nilpy_ctor_star_and_kwargs.npy $(TESTTMP)/test_nilpy_ctorargs26
	...
	test "$$($(TESTTMP)/test_nilpy_imphdr26)" = "$$(printf 'malloc/free ok\nabs         3')"
	...
	$(TESTTMP)/test_nilpy_optstr26 | diff -u test/test_nilpy_optional_str_none.expected -
	./$(COMPILER) test/test_nilpy_class_name_chain.npy $(TESTTMP)/test_nilpy_clsname26
	$(TESTTMP)/test_nilpy_clsname26 | diff -u test/test_nilpy_class_name_chain.expected -
	./$(COMPILER) test/test_nilpy_frozenset.npy $(TESTTMP)/test_nilpy_frozenset26
	...
	./$(COMPILER) test/test_nilpy_import_string_module.npy $(TESTTMP)/test_nilpy_impstring26
	$(TESTTMP)/test_nilpy_impstring26 | diff -u test/test_nilpy_import_string_module.expected -
	./$(COMPILER) test/test_nilpy_min_max_key_none.npy $(TESTTMP)/test_nilpy_mmkeynone26
	...
	# both directions.
	./$(COMPILER) test/test_nilpy_float_format_exact.npy $(TESTTMP)/test_nilpy_ffexact26
	$(TESTTMP)/test_nilpy_ffexact26 | diff -u test/test_nilpy_float_format_exact.expected -
	./$(COMPILER) test/test_nilpy_exception_args.npy $(TESTTMP)/test_nilpy_excargs26
	$(TESTTMP)/test_nilpy_excargs26 | diff -u test/test_nilpy_exception_args.expected -
	...
	./$(COMPILER) test/test_nilpy_exception_non_string_argument.npy $(TESTTMP)/test_nilpy_excnonstr26
	$(TESTTMP)/test_nilpy_excnonstr26 | diff -u test/test_nilpy_exception_non_string_argument.expected -
	...
	./$(COMPILER) test/test_nilpy_format_builtin.npy $(TESTTMP)/test_nilpy_fmtbuiltin26
	$(TESTTMP)/test_nilpy_fmtbuiltin26 | diff -u test/test_nilpy_format_builtin.expected -
	# zip(a, b, c) — three and four streams; two-way must still yield a PAIR.
	./$(COMPILER) test/test_nilpy_zip_n_way.npy $(TESTTMP)/test_nilpy_zipnway26
	$(TESTTMP)/test_nilpy_zipnway26 | diff -u test/test_nilpy_zip_n_way.expected -
	# a computed precision inside a format spec -- f"{x:.{n}f}"
	./$(COMPILER) test/test_nilpy_fstring_computed_spec.npy $(TESTTMP)/test_nilpy_fscomp26
	$(TESTTMP)/test_nilpy_fscomp26 | diff -u test/test_nilpy_fstring_computed_spec.expected -
	...
	./$(COMPILER) test/test_nilpy_user_def_shadows_a_builtin.npy $(TESTTMP)/test_nilpy_defshadow26
	$(TESTTMP)/test_nilpy_defshadow26 | diff -u test/test_nilpy_user_def_shadows_a_builtin.expected -
	...
	./$(COMPILER) test/test_nilpy_print_is_not_a_keyword.npy $(TESTTMP)/test_nilpy_printkw26
	$(TESTTMP)/test_nilpy_printkw26 | diff -u test/test_nilpy_print_is_not_a_keyword.expected -
	./$(COMPILER) test/test_nilpy_tuple_is_not_a_list.npy $(TESTTMP)/test_nilpy_tupnotlist26
	$(TESTTMP)/test_nilpy_tupnotlist26 | diff -u test/test_nilpy_tuple_is_not_a_list.expected -
	./$(COMPILER) test/test_nilpy_set_equality_is_membership.npy $(TESTTMP)/test_nilpy_seteq26
	$(TESTTMP)/test_nilpy_seteq26 | diff -u test/test_nilpy_set_equality_is_membership.expected -
	./$(COMPILER) test/test_nilpy_set_update_methods.npy $(TESTTMP)/test_nilpy_setupd26
	$(TESTTMP)/test_nilpy_setupd26 | diff -u test/test_nilpy_set_update_methods.expected -
	...
	./$(COMPILER) test/test_nilpy_overload_by_class_through_a_variant.npy $(TESTTMP)/test_nilpy_ovlcls26
	$(TESTTMP)/test_nilpy_ovlcls26 | diff -u test/test_nilpy_overload_by_class_through_a_variant.expected -
	...
	./$(COMPILER) test/test_nilpy_module_name_rebound_in_a_block.npy $(TESTTMP)/test_nilpy_modrebind26
	$(TESTTMP)/test_nilpy_modrebind26 | diff -u test/test_nilpy_module_name_rebound_in_a_block.expected -
	...
	./$(COMPILER) test/test_nilpy_min_max_of_a_variant_list.npy $(TESTTMP)/test_nilpy_minmaxvar26
	$(TESTTMP)/test_nilpy_minmaxvar26 | diff -u test/test_nilpy_min_max_of_a_variant_list.expected -
	...
	./$(COMPILER) test/test_nilpy_percent_star_width.npy $(TESTTMP)/test_nilpy_pctstar26
	$(TESTTMP)/test_nilpy_pctstar26 | diff -u test/test_nilpy_percent_star_width.expected -
	...
	test "$$($(TESTTMP)/test_nilpy_any_params26)" = "$$(printf 'got\ngot\n20\n3')"
	./$(COMPILER) test/test_nilpy_method_return_types.npy $(TESTTMP)/test_nilpy_method_return_types26
	test "$$($(TESTTMP)/test_nilpy_method_return_types26)" = "$$(printf '7\nTrue\nFalse\n2.5\n14\ntext\nTEXT')"
	./$(COMPILER) test/test_nilpy_class_field_identity.npy $(TESTTMP)/test_nilpy_class_field_identity26
	test "$$($(TESTTMP)/test_nilpy_class_field_identity26)" = "$$(printf 'dup\nswap\nDUP\nSWAP\ndup\ndup\nDUP')"
	./$(COMPILER) test/test_nilpy_str_methods.npy $(TESTTMP)/test_nilpy_str_methods26
	test "$$($(TESTTMP)/test_nilpy_str_methods26)" = "$$(printf 'HELLO, WORLD! 123\nhello, world! 123\nMIXED\nmixed\n42\nWORD7\nhello, world! 123\nHELLO, WORLD! 123\nFORTH\n\nALREADY UPPER\nalready lower\nDIGITS 0123 AND !@# STAY\nEMOJI STAYS >>> OK\nHello, World! 123\naB\nxyz\nB\nTrue\n[padded]\n[padded  ]\n[  padded]\n[]\n[]\n[tabbed]\nTrue\nFalse\nTrue\nFalse\nTrue\nTrue\nFalse\n2\n0\n-1\n0\n1\n2\nTrue\nFalse\nFalse\nTrue\nMIXED\nmixed\nTrue\nH\ne\n3\nH\n3\n5\n0\n2\na,b,c\nabc\nsolo\n[]\na|b|c\na||b\n1\nFORTH|is|fun\n0\n0\none|two|three\n1\n0\n2\n3\nDUP|SWAP|DROP\n2\n12\n[  7]\n007\nabc\n[****]\nx y\n...42 5\na')"
	./$(COMPILER) test/test_nilpy_isinstance.npy $(TESTTMP)/test_nilpy_isinstance26
	test "$$($(TESTTMP)/test_nilpy_isinstance26)" = "$$(printf 'num\nnum\ntext\nword\ncall\nnum')"
	./$(COMPILER) test/test_nilpy_optional.npy $(TESTTMP)/test_nilpy_optional26
	test "$$($(TESTTMP)/test_nilpy_optional26)" = "$$(printf 'dup\n0\nFalse\n65536')"
	./$(COMPILER) test/test_nilpy_variant_str_ownership.npy $(TESTTMP)/test_nilpy_variant_str_ownership26
	test "$$($(TESTTMP)/test_nilpy_variant_str_ownership26)" = "$$(printf '1\n2\none\ntwo\n2\n1\n2\n3 4\n9 2 3\naaa 9\nbbb 2\nccc 3\naaa 9')"
	./$(COMPILER) test/test_nilpy_floordiv_modulo.npy $(TESTTMP)/test_nilpy_floordiv_modulo26
	test "$$($(TESTTMP)/test_nilpy_floordiv_modulo26)" = "$$(printf '7 3 2 1 0\n7 -3 -3 -2 0\n-7 3 -3 2 0\n-7 -3 2 -1 0\n8 4 2 0 0\n8 -4 -2 0 0\n-8 4 -2 0 0\n-8 -4 2 0 0\n0 5 0 0 0\n0 -5 0 0 0\n1 7 0 1 0\n-1 7 -1 6 0\n1 -7 -1 -6 0\n-1 -7 0 -1 0\n3.0 1.5\n-4.0 0.5\n-4.0 -0.5')"
	./$(COMPILER) test/test_nilpy_int_str_builtins.npy $(TESTTMP)/test_nilpy_int_str_builtins26
	test "$$($(TESTTMP)/test_nilpy_int_str_builtins26)" = "$$(printf '42 -7 9 3 2 -2 1\nab  True False 5 -5 2.5 0.0\n34\n101 14 2\n2 2.75\n0 0\n9 4 1 0\n-9 -5 1 0\n10 5 0 0\n-10 -5 0 0')"
	./$(COMPILER) test/test_nilpy_pyexpr_semantics.npy $(TESTTMP)/test_nilpy_pyexpr_semantics26
	test "$$($(TESTTMP)/test_nilpy_pyexpr_semantics26)" = "$$(printf 'False\nTrue\nTrue\nTrue\nTrue\nababab ababab x \n4 3 4\n4 True\nTrue\nTrue False True')"
	./$(COMPILER) test/test_nilpy_variant_operator_sweep.npy $(TESTTMP)/test_nilpy_variant_operator_sweep26
	test "$$($(TESTTMP)/test_nilpy_variant_operator_sweep26)" = "$$(printf '7 -7 8 6 14\n-7 7 -6 -8 -14\n0 0 1 -1 0\n3 1 3.5\n-4 1 -3.5\n0 0 0.0\n2.5 -2.5 3.5 5.0\n-2.5 2.5 -1.5 -5.0\nab ab!\n !\nTrue False True\nFalse True False\n2 3\nTrue False\nTrue False\n1 1.5 z True\n5 5 5 -5\nTrue False True\n1 2 1.5 2.5\n97 b\nTrue False True False True False\nFalse True')"
	./$(COMPILER) test/test_nilpy_method_str_return.npy $(TESTTMP)/test_nilpy_method_str_return26
	test "$$($(TESTTMP)/test_nilpy_method_str_return26)" = "$$(printf 'alpha 1 True 2.5\nalpha! alpha literal\nbeta -2 False fallback\nalpha alpha! 5 6\nalphaalpha!\nnc')"
	./$(COMPILER) test/test_nilpy_variant_polymorphic_builtins.npy $(TESTTMP)/test_nilpy_variant_polymorphic_builtins26
	test "$$($(TESTTMP)/test_nilpy_variant_polymorphic_builtins26)" = "$$(printf '2 abab abab\n0  \n3 xyzxyz xyzxyz\n1 qq qq\n9 9\n-6 -6\n0 0\n3.0 3.0\n-1.0 -1.0\n97 1 aaa\n122 1 zzz\n3\n2')"
	...
	test "$$($(TESTTMP)/test_nilpy_function_values26)" = "$$(printf '1\n11\nONE\n12\nONE 13\nTEN 23\n34')"
	...
	test "$$($(TESTTMP)/test_nilpy_variant_arith_nested26)" = "$$(printf '66\n509\n72\n8.0\na-b-')"
	...
	test "$$($(TESTTMP)/test_nilpy_unpack26)" = "$$(printf '1 2\n2 1\np 2 3.5\n7 8\na 1\nb 2\nc 3\n6\na 1\nb 2\nc 3')"
	...
	@n=$$(./$(COMPILER) test/test_pascal_self_result_warn.pas $(TESTTMP)/test_pascal_self_result_warn26 2>&1 \
	   | grep -c 'bare own name'); \
	 test "$$n" = "1" \
	  || { echo "test_pascal_self_result_warn: FAIL - expected exactly 1 bare-own-name warning, got $$n"; exit 1; }
	test "$$($(TESTTMP)/test_pascal_self_result_warn26)" = "$$(printf '5\n1\n8\n42\n6\n42\n100')"
	@# ... and --no-warn-self-result silences it
	@n=$$(./$(COMPILER) --no-warn-self-result test/test_pascal_self_result_warn.pas $(TESTTMP)/test_pascal_self_result_warn26 2>&1 \
	   | grep -c 'bare own name'); \
	 test "$$n" = "0" \
	...
	./$(COMPILER) test/test_pascal_self_result_delphi.pas $(TESTTMP)/test_pascal_self_result_delphi26
	test "$$($(TESTTMP)/test_pascal_self_result_delphi26)" = "$$(printf '42\n4\n7\n3\n10')"
	@n=$$(./$(COMPILER) test/test_pascal_self_result_delphi.pas $(TESTTMP)/test_pascal_self_result_delphi26 2>&1 \
	   | grep -c 'bare own name'); \
	 test "$$n" = "0" \
	...
	./$(COMPILER) test/test_pascal_mode_switch_cli.pas $(TESTTMP)/test_pascal_mode_cli26
	test "$$($(TESTTMP)/test_pascal_mode_cli26)" = "$$(printf '7\n1')"
	./$(COMPILER) -Mdelphi test/test_pascal_mode_switch_cli.pas $(TESTTMP)/test_pascal_mode_cli_d26
	test "$$($(TESTTMP)/test_pascal_mode_cli_d26)" = "$$(printf '42\n4')"
	...
	./$(COMPILER) -Mobjfpc test/test_pascal_mode_switch_cli.pas $(TESTTMP)/test_pascal_mode_cli_o26
	test "$$($(TESTTMP)/test_pascal_mode_cli_o26)" = "$$(printf '7\n1')"
	./$(COMPILER) -Mtp test/test_pascal_mode_switch_cli.pas $(TESTTMP)/test_pascal_mode_cli_tp26
	test "$$($(TESTTMP)/test_pascal_mode_cli_tp26)" = "$$(printf '7\n1')"
	...
	test "$$($(TESTTMP)/test_nilpy_discarded_string_result26)" = "$$(printf '5 [0, 1, 2, 3, 4]\n5\ns99 m99 6 6\n8 101 102')"
	./$(COMPILER) test/test_nilpy_lambda_returned_from_def.npy $(TESTTMP)/test_nilpy_lambda_returned26
	test "$$($(TESTTMP)/test_nilpy_lambda_returned26)" = "$$(printf '2 11 6 2\n2 101\n6 1005\n8 2\n2 21')"
	./$(COMPILER) test/test_nilpy_annotated_module_global.npy $(TESTTMP)/test_nilpy_annotated_module_global26
	test "$$($(TESTTMP)/test_nilpy_annotated_module_global26)" = "$$(printf '2\n5 8 AB 2 1\n1 1 7 ab 3')"
	...
	./$(COMPILER) test/test_nilpy_str_of_an_instance_and_a_class_typed_none.npy $(TESTTMP)/test_nilpy_strinst26
	$(TESTTMP)/test_nilpy_strinst26 | diff -u test/test_nilpy_str_of_an_instance_and_a_class_typed_none.expected -
	...
	$(TESTTMP)/test_nilpy_defretbig26 | diff -u test/test_nilpy_def_returning_a_big_int.expected -
	...
	$(TESTTMP)/test_nilpy_delvar26 | diff -u test/test_nilpy_del_on_a_variant_receiver.expected -
	...
	./$(COMPILER) test/test_nilpy_repr_dunder_returns_str.npy $(TESTTMP)/test_nilpy_reprdunder26
	$(TESTTMP)/test_nilpy_reprdunder26 | diff -u test/test_nilpy_repr_dunder_returns_str.expected -
	...
	./$(COMPILER) test/test_nilpy_pow_evaluates_operands_once.npy $(TESTTMP)/test_nilpy_pow_once26
	$(TESTTMP)/test_nilpy_pow_once26 | diff -u test/test_nilpy_pow_evaluates_operands_once.expected -
	./$(COMPILER) test/test_nilpy_float_overflow_raises.npy $(TESTTMP)/test_nilpy_ovf26
	...
	./$(COMPILER) test/test_nilpy_dict_fromkeys_any_iterable.npy $(TESTTMP)/test_nilpy_fromkeys26
	...
	./$(COMPILER) test/test_nilpy_builtin_type_as_a_map_callback.npy $(TESTTMP)/test_nilpy_btmap27
	$(TESTTMP)/test_nilpy_btmap27 | diff -u test/test_nilpy_builtin_type_as_a_map_callback.expected -
	...
	$(TESTTMP)/test_nilpy_halfeven26 | diff -u test/test_nilpy_format_half_even.expected -
	...
	./$(COMPILER) test/test_nilpy_round_ndigits_keeps_int.npy $(TESTTMP)/test_nilpy_roundint26
	$(TESTTMP)/test_nilpy_roundint26 | diff -u test/test_nilpy_round_ndigits_keeps_int.expected -
	...
	./$(COMPILER) test/test_nilpy_override_return_type_differs.npy $(TESTTMP)/test_nilpy_ovrret26
	$(TESTTMP)/test_nilpy_ovrret26 | diff -u test/test_nilpy_override_return_type_differs.expected -
	...
	./$(COMPILER) test/test_nilpy_module_name_from_a_field_in_a_block.npy $(TESTTMP)/test_nilpy_modfield26
	$(TESTTMP)/test_nilpy_modfield26 | diff -u test/test_nilpy_module_name_from_a_field_in_a_block.expected -
	...
	./$(COMPILER) test/test_nilpy_field_from_module_global.npy $(TESTTMP)/test_nilpy_field_from_global26
	$(TESTTMP)/test_nilpy_field_from_global26 | diff -u test/test_nilpy_field_from_module_global.expected -
	./$(COMPILER) test/test_nilpy_method_string_result_ownership.npy $(TESTTMP)/test_nilpy_method_string_result26
	test "$$($(TESTTMP)/test_nilpy_method_string_result26)" = "$$(printf 'lit 7 kk-7 kk 9\n3 1 4 2 1\nzz 99 zz\n300 zz-99')"
	...
	test "$$($(TESTTMP)/test_nilpy_is_identity26)" = "$$(printf 'False True True False\nTrue False\nFalse True True\nTrue\nFalse True\nTrue\nTrue False False True\nFalse True\ncopied same')"
	./$(COMPILER) test/test_nilpy_callable_param_heap_callable.npy $(TESTTMP)/test_nilpy_callable_param26
	test "$$($(TESTTMP)/test_nilpy_callable_param26)" = "$$(printf '6\n7\n1005\n42\n-1\n42\n105\n105 8\n105\n11 21\ninc 2')"
	./$(COMPILER) test/test_nilpy_return_ownership.npy $(TESTTMP)/test_nilpy_return_ownership26
	test "$$($(TESTTMP)/test_nilpy_return_ownership26)" = "$$(printf 'ctor 1\nlocal 2\nctor 3\nfield 7\nelem 8\nfield elem\n500 499')"
	./$(COMPILER) test/test_nilpy_set_literal_dedup.npy $(TESTTMP)/test_nilpy_set_literal_dedup26
	test "$$($(TESTTMP)/test_nilpy_set_literal_dedup26)" = "$$(printf '3\n3\n3\n2\n4\nTrue False True\n4\n4\n1 2\n[1, 2, 3]')"
	...
	test "$$($(TESTTMP)/test_nilpy_typeerror_catch26)" = "$$(printf 'caught repeat\ncaught len\ncaught int\ncaught fmt\ncaught sep\ncaught max\ncaught call-None\ncaught ord\ncaught strindex\ncaught set\ncaught join\ncaught bytearray\ncaught fnf\nas Exception\nafter')"
	...
	./$(COMPILER) test/test_nilpy_mixed_type_operands.npy $(TESTTMP)/test_nilpy_mixed_type_operands26
	test "$$($(TESTTMP)/test_nilpy_mixed_type_operands26)" = "$$(printf 'sub TypeError\ndiv TypeError\nlt TypeError\nle TypeError\ngt TypeError\nge TypeError\nmul-dict TypeError\nsub-list TypeError\nababab ababab\n2 1.5 1 1\nTrue True False True\n[1, 2, 1, 2]\n[1, 2, 1, 2]\nTrue True False True True\n5 apples\na-b\n[1, 2, 1, 3]\n[1]\nleftover TypeError\nno specifier\nfloat sub TypeError\nfloat lt TypeError\n5.0 1.5 True')"
	...
	./$(COMPILER) test/test_nilpy_return_type_inference.npy $(TESTTMP)/test_nilpy_ret_infer26
	test "$$($(TESTTMP)/test_nilpy_ret_infer26)" = "$$(printf 'str\n[1, 2]\n2.5\n5\ndeep\nstr\nouter')"
	@# `return <subscript>`/`return <slice>` on a variant/string receiver, and a
	@# self-referential chr() accumulator's return type
	./$(COMPILER) test/test_nilpy_bare_return_subscript_slice.npy $(TESTTMP)/test_nilpy_bare_ret_subslice26
	test "$$($(TESTTMP)/test_nilpy_bare_ret_subslice26)" = "$$(printf 'a\na\nab\nprefix_\na\n1.5\nTrue\n[1]\na\n1\nv\n[1, 2]\nhello world')"
	@# a `for` target reused after a non-string binding (and the reverse order)
	./$(COMPILER) test/test_nilpy_for_variable_reuse.npy $(TESTTMP)/test_nilpy_for_var_reuse26
	test "$$($(TESTTMP)/test_nilpy_for_var_reuse26)" = "$$(printf 'a\nZ\na\nZ\na\nZ\na\nZ\na\nb\n5\n1.5\nTrue\n1\n2')"
	@# a method call / subscript on a PARENTHESISED expression
	./$(COMPILER) test/test_nilpy_postfix_after_parens.npy $(TESTTMP)/test_nilpy_parenpost26
	$(TESTTMP)/test_nilpy_parenpost26 | diff -u test/test_nilpy_postfix_after_parens.expected -
	@# zip() inside a COMPREHENSION parses (the zip intercept is statement-only)
	./$(COMPILER) test/test_nilpy_zip_in_a_comprehension.npy $(TESTTMP)/test_nilpy_zipcomp26
	$(TESTTMP)/test_nilpy_zipcomp26 | diff -u test/test_nilpy_zip_in_a_comprehension.expected -
	@# a for target inside a def is a LOCAL, not the module global of that name
	./$(COMPILER) test/test_nilpy_loop_target_in_a_def_is_local.npy $(TESTTMP)/test_nilpy_loctgt26
	$(TESTTMP)/test_nilpy_loctgt26 | diff -u test/test_nilpy_loop_target_in_a_def_is_local.expected -
	@# an `except ... as e` binder is scoped to its handler, so a later
	@# ordinary `e = ...` does not land in the exception-typed slot
	./$(COMPILER) test/test_nilpy_except_as_binder_scope.npy $(TESTTMP)/test_nilpy_exc_as26
	$(TESTTMP)/test_nilpy_exc_as26 | diff -u test/test_nilpy_except_as_binder_scope.expected -
	...
	./$(COMPILER) test/test_nilpy_none_beside_a_container_return.npy $(TESTTMP)/test_nilpy_none_container26
	$(TESTTMP)/test_nilpy_none_container26 | diff -u test/test_nilpy_none_beside_a_container_return.expected -
	@# an EXPLICIT None separator means whitespace runs, like split() itself
	./$(COMPILER) test/test_nilpy_split_none_separator.npy $(TESTTMP)/test_nilpy_split_none26
	...
	test "$$($(TESTTMP)/test_nilpy_missattr26)" = "$$(printf 'caught foo\ncaught upper\ncaught nope\ncaught getx\nTrue\nFalse\n1\ndef\n42\nAB')"
	...
	test "$$($(TESTTMP)/test_nilpy_redefdef26)" = "$$(printf '2\n3\n2\n5')"
	@# %e/%E/%g/%G no longer collapse onto %f
	./$(COMPILER) test/test_nilpy_percent_e_g_format.npy $(TESTTMP)/test_nilpy_pctformat26
	test "$$($(TESTTMP)/test_nilpy_pctformat26)" = "$$(printf '1.500000e+03\n1.500000E+03\n1.23e+03\n1.5e+06\n0.0001\n100\n0\n0.000000e+00\n-1.500000e+03\n1.23457e+08\n3.141592654\n1\n1.500000\n1.50')"
	@# `xs += ys` on a VARIANT-typed list extends in place instead of rebinding
	./$(COMPILER) test/test_nilpy_augmented_add_variant_list.npy $(TESTTMP)/test_nilpy_augaddvar26
	test "$$($(TESTTMP)/test_nilpy_augaddvar26)" = "$$(printf '[1, 9]\n[1, 5]\n[1, 9]\n[1, 9]\n[1, 9]\n[1, 8]')"
	./$(COMPILER) test/test_nilpy_exception_no_leak.npy $(TESTTMP)/test_nilpy_excnoleak26
	test "$$($(TESTTMP)/test_nilpy_excnoleak26)" = "640000"
	@if [ -x /usr/bin/time ]; then \
	  /usr/bin/time -v $(TESTTMP)/test_nilpy_excnoleak26 2>$(TESTTMP)/excnoleak.time >/dev/null; \
	...
	test "$$($(TESTTMP)/test_nilpy_mathfloor26)" = "$$(printf '%b' '2 3\n-3 -2\n2 2\n3\n3 2 2.7\n-2 2 -2 0\n2 -2 0\n-6\n-3.0 3.0\n-3.0 3.0\n-3.0 3.0')"
	...
	./$(COMPILER) test/test_nilpy_fstring_spec_on_variant.npy $(TESTTMP)/test_nilpy_fmtspecvar26
	$(TESTTMP)/test_nilpy_fmtspecvar26 | diff -u test/test_nilpy_fstring_spec_on_variant.expected -
	./$(COMPILER) test/test_nilpy_fstring_format_spec.npy $(TESTTMP)/test_nilpy_fmtspec26
	test "$$($(TESTTMP)/test_nilpy_fmtspec26)" = "$$(printf '%b' '3.14\n    F\n   42\n3\n1.23e+03\n    hi    \n    hi     \n********hi\nhi********\n****hi****\n  7  \n00007\n-0003\n000-3\n3.142\n***3.1****\nx    |\n    3|')"
	...
	./$(COMPILER) test/test_nilpy_str_local_loop_zeroinit.npy $(TESTTMP)/test_nilpy_str_local_zi26
	test "$$($(TESTTMP)/test_nilpy_str_local_zi26)" = "$$(printf 'a\nb\nx\nx\ny\nz\ny\nz\n65\n66\ng\nh\n1\n2\ni\nj\nk\nl')"
	...
	./$(COMPILER) test/test_nilpy_chr_of_variant.npy $(TESTTMP)/test_nilpy_chr_of_variant26
	test "$$($(TESTTMP)/test_nilpy_chr_of_variant26)" = "$$(printf 'a b\nb\nabc\na\na A\nz\n97 98\ncaught chr')"
	...
	./$(COMPILER) test/test_nilpy_char_ordering.npy $(TESTTMP)/test_nilpy_char_ordering26
	test "$$($(TESTTMP)/test_nilpy_char_ordering26)" = "$$(printf 'False True True False\nTrue True False False\nTrue False True False\nTrue False\nTrue False\nTrue True\n{\0475\047: 1}\n[\0475\047, \0473\047]\n123 3\n[\04712\047, \047+\047, \04734\047, \047*\047, \0472\047]\na lower\nZ upper\n9 digit\n! other')"
	...
	./$(COMPILER) test/test_nilpy_variant_str_index.npy $(TESTTMP)/test_nilpy_variant_str_index26
	test "$$($(TESTTMP)/test_nilpy_variant_str_index26)" = "$$(printf 'a\na\nb\na d\nc\ncaught index\nTrue False\na [\047apple\047, \047avocado\047]\nb [\047banana\047, \047blueberry\047]\n7 5')"
	...
	./$(COMPILER) test/test_nilpy_file_write_text.npy $(TESTTMP)/test_nilpy_file_write26
	test "$$($(TESTTMP)/test_nilpy_file_write26)" = "$$(printf 'hello\n6\n5 a\nbb\n[]\n5000\nfirst\nsecond')"
	# close()/readlines() on a read-mode handle (still a TPyList under the read-slurp model)
	./$(COMPILER) test/test_nilpy_file_close_readlines.npy $(TESTTMP)/test_nilpy_file_closerl26
	test "$$($(TESTTMP)/test_nilpy_file_closerl26)" = "$$(printf '3\none\ntwo\nthree')"
	...
	./$(COMPILER) -Futest/nilpylib test/test_nilpy_import_py_from_library_path.npy $(TESTTMP)/test_nilpy_pylibpath26
	test "$$($(TESTTMP)/test_nilpy_pylibpath26)" = "$$(printf 'lib:x\n42\nbbnbnb')"
	...
	./$(COMPILER) test/test_nilpy_variant_method_pick_by_arity.npy $(TESTTMP)/test_nilpy_arity26
	test "$$($(TESTTMP)/test_nilpy_arity26)" = "$$(printf '42\n1')"
	...
	./$(COMPILER) test/test_nilpy_write_overload_by_arg_type.npy $(TESTTMP)/test_nilpy_wovl26
	test "$$($(TESTTMP)/test_nilpy_wovl26)" = "$$(printf 'via-param\nxconcat\nfmt!\nlocal?\ndirect-literal\nbytes-arg')"
	...
	./$(COMPILER) test/test_nilpy_open_one_class_every_mode.npy $(TESTTMP)/test_nilpy_open_one_class26
	test "$$($(TESTTMP)/test_nilpy_open_one_class26)" = "$$(printf '[one\n]\nafter-append:one|two|\niter:one\niter:two\nlines:2')"
	# a name bound by `with open(...) as f:` reused later for a plain `f = open(...)`
	./$(COMPILER) test/test_nilpy_with_name_reuse.npy $(TESTTMP)/test_nilpy_with_name_reuse26
	test "$$($(TESTTMP)/test_nilpy_with_name_reuse26)" = "$$(printf '2\n[one\ntwo\n]')"
	...
	./$(COMPILER) test/test_nilpy_escaping_closure_many_captures.npy $(TESTTMP)/test_nilpy_closure_caps26
	test "$$($(TESTTMP)/test_nilpy_closure_caps26)" = "$$(printf '843\n952\n1173\n1398\n2217\n1181\n1 2 3 108')"
	...
	./$(COMPILER) test/test_nilpy_returned_container_element_survives.npy $(TESTTMP)/test_nilpy_borrowret26
	test "$$($(TESTTMP)/test_nilpy_borrowret26)" = "$$(printf '3 [1, 5, 3]\n4 9\n4 7\n8 8 15\n[4, 5, 6] [7, 8]\n[1, 5, 11]')"
	...
	./$(COMPILER) test/test_nilpy_range_counter_after_loop.npy $(TESTTMP)/test_nilpy_range_after26
	test "$$($(TESTTMP)/test_nilpy_range_after26)" = "$$(printf 'i 2\nj 7\nk 9\nd 1\nm 99\np 7\nnested 2 1\nbreak 4\nonce 0\nsum 6 last 3\nrebound 20\ncomp [0, 1, 2] untouched\ncomp2 [0, 4, 8]\ncomputed 2')"
	./$(COMPILER) test/test_nilpy_nonlocal_escaping_closure.npy $(TESTTMP)/test_nilpy_nonlocal_esc26
	test "$$($(TESTTMP)/test_nilpy_nonlocal_esc26)" = "$$(printf 'before\nafter\n1\n2\n3\n1 2 1\nalive: 2\nreadonly: 7\ntwo: 2020 3030\nfloat: 0.75 1.0\nlist: 1 2\nassign plain: 41\nassign nonlocal: 41\nassign counter: 1 2 3\nshared a: 1\nshared b: 99\nshared c: 1\nshared d: 15\nshared e: 9\nshared f: 2\ndirect: 2\nboth: 2')"
	...
	./$(COMPILER) test/test_nilpy_static_operand_clash.npy $(TESTTMP)/test_nilpy_static_clash26 2>&1 \
	...
	test "$$($(TESTTMP)/test_nilpy_static_clash26)" = "$$(printf 'sub TE\nadd TE\ndiv TE\nfdiv TE\nlt TE\nge TE\nababab ababab\n3/ab\n4 2 1.25 abc True True')"
	./$(COMPILER) test/test_nilpy_none_value_semantics.npy $(TESTTMP)/test_nilpy_none_value_semantics26
	test "$$($(TESTTMP)/test_nilpy_none_value_semantics26)" = "$$(printf 'False False True True\nFalse False True\nFalse False\nFalse False\nFalse False\nFalse False\nTrue False\nTrue False False False False\nFalse False False False\nNone None v=None False\nNone\nn None a None\nTrue True True True True\ngood')"
	...
	./$(COMPILER) test/test_nilpy_int_of_string_is_arbitrary_precision.npy $(TESTTMP)/test_nilpy_int_str_promo26
	test "$$($(TESTTMP)/test_nilpy_int_str_promo26)" = "$$(printf '12345678901234567890\n123456789012345678901234567890\n123456789012345678901234567890123456789012345678901234567890\n-123456789012345678901234567890\n12345678901234567890\nTrue\nTrue\n123456789012345678901234567891\n246913578024691357802469135780\n0\n123456789012345\n0\nTrue\nTrue\nTrue\n42\n-8\n8\n0\n40\n6\nValueError\nValueError\nValueError\n123456789012345678901234567890')"
	...
	./$(COMPILER) test/test_nilpy_for_two_names_over_a_variant.npy $(TESTTMP)/test_nilpy_for2var26
	...
	$(TESTTMP)/test_nilpy_for2var26 | diff -u test/test_nilpy_for_two_names_over_a_variant.expected -
	...
	./$(COMPILER) test/test_nilpy_hasattr_variant_receiver.npy $(TESTTMP)/test_nilpy_hasattr_var26
	test "$$($(TESTTMP)/test_nilpy_hasattr_var26)" = "$$(printf 'True False\nTrue True False\nTrue False\nTrue False\nFalse True\n1 2\npresent missing\nTrue\nTrue\nTrue True False\nFalse False False')"
	./$(COMPILER) test/test_nilpy_return_nested_def.npy $(TESTTMP)/test_nilpy_return_nested_def26
	test "$$($(TESTTMP)/test_nilpy_return_nested_def26)" = "$$(printf '11 21\n2\n101\n1001 2002\n35\n45\n8 9 10')"
	./$(COMPILER) test/test_nilpy_lambda_sibling_capture.npy $(TESTTMP)/test_nilpy_lambda_sibling_capture26
	test "$$($(TESTTMP)/test_nilpy_lambda_sibling_capture26)" = "$$(printf 'F 11 fwd\nF 11 fwd\nB 21 back\nB 21 back\nC 1 2 3\nR 5\nR 5\nR 5\nR 5')"
	./$(COMPILER) test/test_nilpy_nested_def.npy $(TESTTMP)/test_nilpy_nested_def26
	./$(COMPILER) test/test_nilpy_nested_def_capture.npy $(TESTTMP)/test_nilpy_nested_def_capture26
	test "$$($(TESTTMP)/test_nilpy_nested_def_capture26)" = "$$(printf '11\n|x||y|\n11\n223\n13')"
	test "$$($(TESTTMP)/test_nilpy_nested_def26)" = "$$(printf '11\n34\n200\n7')"
	./$(COMPILER) test/test_nilpy_str_repeat.npy $(TESTTMP)/test_nilpy_str_repeat26
	test "$$($(TESTTMP)/test_nilpy_str_repeat26)" = "$$(printf '300\nababab 6\nqq\nzzy\n12')"
	./$(COMPILER) test/test_nilpy_long_string.npy $(TESTTMP)/test_nilpy_long_string26
	test "$$($(TESTTMP)/test_nilpy_long_string26)" = "$$(printf '300\n1000\nx\n400 y\n300\n300\n0 1 xxx')"
	./$(COMPILER) test/test_nilpy_subscript_suffix.npy $(TESTTMP)/test_nilpy_subscript_suffix26
	test "$$($(TESTTMP)/test_nilpy_subscript_suffix26)" = "$$(printf 'b a c c\nB c a\ny 10\nv\ny z X\nq 1\n1')"
	./$(COMPILER) test/test_nilpy_unary_minus_precedence.npy $(TESTTMP)/test_nilpy_unary_minus_precedence26
	test "$$($(TESTTMP)/test_nilpy_unary_minus_precedence26)" = "$$(printf -- '-4 1 -4 1\n-4 -1 3 -1\n-14 -5 -3.5 -9 9\n-4.0 0.5 0\n-4 1 -14 -3\n3 3')"
	...
	test "$$($(TESTTMP)/test_nilpy_one_char_string26)" = "$$(printf 'd 1\ndx\nq!\nz! 1\na 1\nbb 2\n97 b True ab\naaa True')"
	./$(COMPILER) test/test_nilpy_inheritance.npy $(TESTTMP)/test_nilpy_inheritance26
	test "$$($(TESTTMP)/test_nilpy_inheritance26)" = "$$(printf 'rex has 4\nwoof\ntom has 4\nmeow 9\nwoof rex2 has 4\nwoof ax has 4\nmeow bx has 4\n... cx has 2')"
	./$(COMPILER) test/test_nilpy_variant_method_call.npy $(TESTTMP)/test_nilpy_variant_method_call26
	test "$$($(TESTTMP)/test_nilpy_variant_method_call26)" = "$$(printf '2 20 True\n5 50 False\none 21\ntwo 24\n<alpha>\n<beta>\n20 <alpha>\n4\n25')"
	./$(COMPILER) test/test_nilpy_variant_unbox.npy $(TESTTMP)/test_nilpy_variant_unbox26
	test "$$($(TESTTMP)/test_nilpy_variant_unbox26)" = "$$(printf '7 -3 0\n2.5 -0.5\nab z\nTrue False\n8 6 14 3 1 -7\n4 -21\n3.5 5.0\nabc\nTrue True True\n4\nabz\n2.0')"
	./$(COMPILER) test/test_nilpy_dataclass.npy $(TESTTMP)/test_nilpy_dataclass26
	test "$$($(TESTTMP)/test_nilpy_dataclass26)" = "$$(printf '3\n4\n25\n10\nfull 1.5 2 False custom\ndefaults 2.5 7 True std\nmix 9.0 7 True std')"
	./$(COMPILER) test/test_nilpy_dict_comprehension.npy $(TESTTMP)/test_nilpy_dict_comprehension26
	test "$$($(TESTTMP)/test_nilpy_dict_comprehension26)" = "$$(printf '%b' '3\n60\n9\n3\n4')"
	./$(COMPILER) test/test_nilpy_captured_class.npy $(TESTTMP)/test_nilpy_captured_class26
	test "$$($(TESTTMP)/test_nilpy_captured_class26)" = "$$(printf '%b' 'HE\n?\n2')"
	./$(COMPILER) test/test_nilpy_method_nested_def.npy $(TESTTMP)/test_nilpy_method_nested_def26
	test "$$($(TESTTMP)/test_nilpy_method_nested_def26)" = "$$(printf '%b' '23\n23')"
	./$(COMPILER) test/test_nilpy_optional_int_none.npy $(TESTTMP)/test_nilpy_optional_int_none26
	test "$$($(TESTTMP)/test_nilpy_optional_int_none26)" = "$$(printf '%b' '7\n42\n0')"
	./$(COMPILER) test/test_nilpy_variant_in.npy $(TESTTMP)/test_nilpy_variant_in26
	test "$$($(TESTTMP)/test_nilpy_variant_in26)" = "$$(printf '%b' '2 in list\n5 not in list\nk in dict')"
	./$(COMPILER) test/test_nilpy_is_none_typed.npy $(TESTTMP)/test_nilpy_is_none_typed26
	test "$$($(TESTTMP)/test_nilpy_is_none_typed26)" = "$$(printf '%b' '11\nobj-live\nTrue\nTrue\n1\ncompound-yes\n[1]\nTrue\n1\nFalse\nFalse\nTrue\n5\nNone')"
	./$(COMPILER) test/test_nilpy_bytes_setslice_variant.npy $(TESTTMP)/test_nilpy_bytes_setslice_variant26
	$(TESTTMP)/test_nilpy_bytes_setslice_variant26 | diff -u test/test_nilpy_bytes_setslice_variant.expected -
	@# `seq * n` where the COUNT has no static type (uforth's FILL)
	./$(COMPILER) test/test_nilpy_sequence_repeat_variant_count.npy $(TESTTMP)/test_nilpy_seqrep26
	$(TESTTMP)/test_nilpy_seqrep26 | diff -u test/test_nilpy_sequence_repeat_variant_count.expected -
	./$(COMPILER) test/test_nilpy_unnamed_managed_temp_init.npy $(TESTTMP)/test_nilpy_unnamed_managed_temp_init26
	test "$$($(TESTTMP)/test_nilpy_unnamed_managed_temp_init26)" = "75"
	./$(COMPILER) test/test_nilpy_not_container.npy $(TESTTMP)/test_nilpy_not_container26
	test "$$($(TESTTMP)/test_nilpy_not_container26)" = "$$(printf '%b' 'xs-truthy\nB\nd-truthy\nD')"
	./$(COMPILER) test/test_nilpy_variant_to_str_param.npy $(TESTTMP)/test_nilpy_variant_to_str_param26
	test "$$($(TESTTMP)/test_nilpy_variant_to_str_param26)" = "$$(printf '%b' 'WORLD\nHELLO\nWORLD\nworld')"
	./$(COMPILER) test/test_nilpy_variant_return_to_class.npy $(TESTTMP)/test_nilpy_variant_return_to_class26
	test "$$($(TESTTMP)/test_nilpy_variant_return_to_class26)" = "$$(printf '%b' 'none-ok\nfound-ok')"
	./$(COMPILER) examples/shell/shell0.npy $(TESTTMP)/test_nilpy_shell026
	$(TESTTMP)/test_nilpy_shell026 | grep -q "hello portable userland"
	...
	./$(COMPILER) test/test_nilpy_variant_field_call_runtime_dispatch.npy $(TESTTMP)/test_nilpy_vfcalldisp26
	$(TESTTMP)/test_nilpy_vfcalldisp26 | diff -u test/test_nilpy_variant_field_call_runtime_dispatch.expected -
	@# __repr__/__str__ on a user instance reached only as a container ELEMENT
	./$(COMPILER) test/test_nilpy_container_element_repr.npy $(TESTTMP)/test_nilpy_celemrepr26
	$(TESTTMP)/test_nilpy_celemrepr26 | diff -u test/test_nilpy_container_element_repr.expected -
	./$(COMPILER) test/test_nilpy_set_ops.npy $(TESTTMP)/test_nilpy_setops26
	...
	./$(COMPILER) test/test_nilpy_list_plus_nonlist_fail.npy $(TESTTMP)/test_nilpy_lpnl_fail26
	test "$$($(TESTTMP)/test_nilpy_lpnl_fail26)" = "$$(printf '%b' 'caught list+str\nstill running')"
	# set methods: issubset/issuperset/union/intersection/difference/add/discard/remove; expectation is CPython's own output
	./$(COMPILER) test/test_nilpy_set_methods.npy $(TESTTMP)/test_nilpy_setmeth26
	test "$$($(TESTTMP)/test_nilpy_setmeth26)" = "$$(printf '%b' 'False\nTrue\nTrue\n[1, 2, 3]\n[2, 3]\n[1]\n[1, 2, 3, 4]\n[2, 3, 4]\n[2, 3, 4]\n[3, 4]')"
	# arithmetic operator dunders (__add__/__sub__/__mul__/__truediv__) on a user class; expectation is CPython's own output
	./$(COMPILER) test/test_nilpy_operator_dunders.npy $(TESTTMP)/test_nilpy_opdunder26
	test "$$($(TESTTMP)/test_nilpy_opdunder26)" = "$$(printf '%b' '(5, 8)\n(3, 4)\n(12, 18)\n(2.0, 3.0)')"
	...
	./$(COMPILER) test/test_nilpy_operator_dunder_missing_fail.npy $(TESTTMP)/test_nilpy_nodunder_fail26
	test "$$($(TESTTMP)/test_nilpy_nodunder_fail26)" = "$$(printf '%b' 'caught missing __add__\nstill running')"
	...
	./$(COMPILER) test/test_nilpy_str_method_subscript.npy $(TESTTMP)/test_nilpy_strmsub26
	test "$$($(TESTTMP)/test_nilpy_strmsub26)" = "$$(printf '%b' 'World\nHello\nc\n[\047a\047, \047b\047, \047c\047]\nb\ny\nH\nhello,world\nPAD\nb\n72\ntwo')"
	...
	./$(COMPILER) test/test_nilpy_format_thousands.npy $(TESTTMP)/test_nilpy_fth26
	test "$$($(TESTTMP)/test_nilpy_fth26)" = "$$(printf '%b' '1,234,567\n-1,234,567\n0\n999\n1,000\n9,876,543,210\n100\n1234567\n42 ff 00007\nbad spec caught\nstill running\n1,234.50\n1,234.5\n1,234,567.25\n1234.50\n      3.14\n75%\n1.234500e+03\n1234.5\n-9,876.5')"
	...
	./$(COMPILER) test/test_nilpy_slice_step.npy $(TESTTMP)/test_nilpy_slicestep26
	test "$$($(TESTTMP)/test_nilpy_slicestep26)" = "$$(printf '%b' 'bd\naceg\nadg\nceg\nace\nhgfedcba\nhfdb\nedc\nhgf\nhgfed\n[]\n[]\n[]\n[]\na\nh\n[1, 3, 5]\n[0, 2, 4, 6]\n[7, 6, 5, 4, 3, 2, 1, 0]\n[7, 4, 1]\n[6, 4, 2]\n[]\n(4, 3, 2, 1)\n(1, 3)\n(2, 4)\naceg\nhfdb\n[0, 3, 6]\nhfdb\n[0, 3, 6]\nstep-zero ValueError caught\nstep-zero ValueError caught on list\nstill running')"
	...
	./$(COMPILER) test/test_nilpy_type_name.npy $(TESTTMP)/test_nilpy_typename26
	test "$$($(TESTTMP)/test_nilpy_typename26)" = "$$(printf '%b' 'Dog\nAnimal\nint\nfloat\nbool\nstr\nNoneType\nlist\ndict\ndict\nbytes\ntuple\nlist\ntuple\ntuple\nint\nstr\nfloat\nNoneType\nbool\nlist\ntuple\ndict\nint str list tuple')"
	...
	./$(COMPILER) test/test_nilpy_iterate_live_list.npy $(TESTTMP)/test_nilpy_livelist26
	test "$$($(TESTTMP)/test_nilpy_livelist26)" = "$$(printf '%b' '[1, 2, 3, 9]\n[1, 2, 3, 9]\n[1, 2, 3]\n[1, 2, 3]\n[1, 3]\n[2, 4]\n[1]\n[]\n[2, 4, 6]\n[2, 3]\n0 1\n1 2\n2 3\na 1\nb 2\na 1\nb 2\na\nb\nc\n90\nempty ok\n[1, 3]')"
	...
	./$(COMPILER) test/test_nilpy_list_pop_at_index_keeps_the_rest.npy $(TESTTMP)/test_nilpy_popat26
	test "$$($(TESTTMP)/test_nilpy_popat26)" = "$$(printf '%b' '(\047tag\047, 0) [(\047tag\047, 1), (\047z\047, 9)]\n[(\047tag\047, 1), (\047tag\047, 2), (\047z\047, 9)]\n[(\047tag\047, 0), (\047tag\047, 2), (\047tag\047, 3), (\047z\047, 9)]\n[(\047tag\047, 0), (\047tag\047, 1), (\047z\047, 9)]\n[(\047tag\047, 1), (\047tag\047, 0)]\n[(\047tag\047, 0), (\047tag\047, 2), (\047z\047, 9)]\n[[3, 4], [5, 6]]\n[\047bb\047, \047cc\047]\n[(\047tag\047, 0), (\047z\047, 9)]\n(\047tag\047, 0) [(\047tag\047, 1), (\047z\047, 9)]\n[(\047tag\047, 0), (\047tag\047, 1), (\047tag\047, 2), (\047tag\047, 3), (\047tag\047, 4)]')"
	./$(COMPILER) test/test_nilpy_del_list_index.npy $(TESTTMP)/test_nilpy_delidx26
	test "$$($(TESTTMP)/test_nilpy_delidx26)" = "$$(printf '%b' '[0, 2, 3, 4]\n[0, 2, 3]\n[2, 3]\nIndexError\n[2, 3]\nIndexError neg\n[2, 3]\n[1, 2, 3]\n[8, 9]\n1\n{\047b\047: 2}\n[1, 4, 5]\n[]\n0')"
	...
	./$(COMPILER) test/test_nilpy_format_sign_flag.npy $(TESTTMP)/test_nilpy_fsign26
	test "$$($(TESTTMP)/test_nilpy_fsign26)" = "$$(printf '%b' '+42\n-42\n42\n-42\n 42\n-42\n+0\n 0\n+42\n-42\n  +42|\n42++++++|\n++++++42|\n+++42+++|\n+00042\n-00042\n 00042\n+3.14\n-3.14\n 3.14\n     +3.14|\n+000003.14\n+1,234,567\n-1,234,567\n+3.14\n+2a\n+101010\n+42\n+3.1\n 42\n0x2a\n0X2A\n0o52\n0b101010\n0x0\n-0x2a\n0x0000002a\n-0x000002a\n      0x2a|\n2a########|\n+0x2a\n0x12d687\n0x2a\n1_234_567\n-1_234_567\n42\n1_234_567\n+1_234_567\nA\n*\nab\nabcdef\n|\nabc     |\n     abc|\nstring spec ValueError caught\nstill running\n+42|-42| 42|\n+42     |\n0x2a|0o52|0X2A|\n0x0000002a|\nHi!\n03.14|+3.142|3.14      |\nabcdef=42 (2a)\n42%')"
	...
	./$(COMPILER) test/test_nilpy_empty_tuple.npy $(TESTTMP)/test_nilpy_emptytup26
	test "$$($(TESTTMP)/test_nilpy_emptytup26)" = "$$(printf '%b' '()\n0\ntuple\nTrue\nFalse\n(1, 2)\n(1, 2)\n()\n[]\n[]\nempty loop ok\n1 2\nFalse\n()\n0\n%\n100%\n1\n0\nX')"
	...
	./$(COMPILER) test/test_nilpy_inf_nan_spelling.npy $(TESTTMP)/test_nilpy_infnan26
	test "$$($(TESTTMP)/test_nilpy_infnan26)" = "$$(printf '%b' 'inf\n-inf\nnan\ninf\n-inf\nnan\ninf\n[inf, -inf]\n(inf, -inf)\n{\047k\047: inf}\ninf\n-inf\nInf\nInf\n[\047Inf\047]\nTrue\n3\n2.5\n2.5\n-0.125\n[1.5, 2.5]\n2.5\nTrue\nTrue\nFalse')"
	...
	./$(COMPILER) test/test_nilpy_str_search_window.npy $(TESTTMP)/test_nilpy_strwin26
	test "$$($(TESTTMP)/test_nilpy_strwin26)" = "$$(printf '%b' '4\n7\n7\n-1\n-1\n7\n7\n7\n4\n7\n-1\n3\n2\n2\n0\n1\n7\n7\nindex raises ValueError\nTrue\nTrue\nTrue\nFalse\nTrue\nTrue\nTrue\nFalse\n-1\n0\nFalse\nstill running')"
	...
	./$(COMPILER) test/test_nilpy_assert.npy $(TESTTMP)/test_nilpy_assert26
	test "$$($(TESTTMP)/test_nilpy_assert26)" = "$$(printf '%b' 'pass ok\ncaught: boom\nbare len: 0\nempty list is falsy\nempty dict is falsy\nempty str is falsy\nNone is falsy\nzero is falsy\ntruthy ok\n5\nin def: must be positive\nvia Exception: generic\nn was 3\nstill running')"
	...
	./$(COMPILER) test/test_nilpy_numeric_dict_keys.npy $(TESTTMP)/test_nilpy_numkey26
	test "$$($(TESTTMP)/test_nilpy_numkey26)" = "$$(printf '%b' '1\nfloat\nfloat\nTrue\na\nTrue\nx\n1\nf\nm\nbig\nTrue\nhalf\nTrue\nFalse\nFalse\n1\nnz\n3\none\nstr-one\ntwo-five\nnan\nTrue\nFalse')"
	...
	./$(COMPILER) test/test_nilpy_module_true_divide_assign.npy $(TESTTMP)/test_nilpy_tdiv26
	test "$$($(TESTTMP)/test_nilpy_tdiv26)" = "$$(printf '%b' '2.0\n2.5\n1.25\n0.333333\n2.0\n2.0\n4.5\n2.0\n4\n1\n9\n3\n6\n2\n16\n3.5\n2.0')"
	...
	./$(COMPILER) test/test_nilpy_bytes_membership.npy $(TESTTMP)/test_nilpy_bymem26
	test "$$($(TESTTMP)/test_nilpy_bymem26)" = "$$(printf '%b' 'True\nTrue\nTrue\nFalse\nTrue\nTrue\nTrue\nFalse\nTrue\nFalse\nTrue\nValueError for 300\nValueError for -1\nTrue\nFalse\nbranch taken\n[b\047a\047]\nTrue\nFalse\nstill running')"
	...
	./$(COMPILER) test/test_nilpy_sorted_dict_key.npy $(TESTTMP)/test_nilpy_sdk26
	test "$$($(TESTTMP)/test_nilpy_sdk26)" = "$$(printf '%b' '[\047a\047, \047b\047, \047c\047]\n[\047a\047, \047b\047, \047c\047]\n[\047c\047, \047b\047, \047a\047]\n[\047c\047, \047b\047, \047a\047]\n[(\047a\047, 1), (\047b\047, 2), (\047c\047, 3)]\n[\047a\047, \047b\047, \047c\047] [1, 2, 3]\n[1, 2, 3] [3, 2, 1] [3, 2, 1]')"
	# tuple() and pow(): the tuple TYPE existed but not its constructor, and pow
	# was undefined though ** worked
	./$(COMPILER) test/test_nilpy_tuple_pow_builtins.npy $(TESTTMP)/test_nilpy_tpb26
	test "$$($(TESTTMP)/test_nilpy_tpb26)" = "$$(printf '%b' '(1, 2, 3)\n(\047a\047, \047b\047, \047c\047)\n()\n(1, 2) 1 2\n(1, 2, 3)\n[4, 5]\n1024 1 27\n8.0 0.5\n1024')"
	# numeric builtin gaps: float("inf"/"nan") raised ValueError, min/max were not
	# variadic, sum() took no start value
	./$(COMPILER) test/test_nilpy_numeric_builtins.npy $(TESTTMP)/test_nilpy_numbi26
	test "$$($(TESTTMP)/test_nilpy_numbi26)" = "$$(printf '%b' 'True\nTrue\nTrue\nTrue\nTrue\n1.5 -2.0 3.5\nabc ValueError\n1 3\n0 9\n1 3\n2 9\n6 16\n0 5\n1.5 b')"
	...
	./$(COMPILER) test/test_nilpy_list_reverse.npy $(TESTTMP)/test_nilpy_lrev26
	test "$$($(TESTTMP)/test_nilpy_lrev26)" = "$$(printf '%b' '[1, 3, 5]\n[5, 3, 1]\n[1]\n[]\n[4, 3, 2, 1]\n[1, 2, 3, 4]\n[1, 2, 3, 4]\n[4, 3, 2, 1]\n[2.5, \047a\047, 1]')"
	...
	./$(COMPILER) test/test_nilpy_str_index.npy $(TESTTMP)/test_nilpy_stridx26
	test "$$($(TESTTMP)/test_nilpy_stridx26)" = "$$(printf '%b' '6 4 7\n7 9\n-1 -1\nindex ValueError\nrindex ValueError\nindex-from ValueError')"
	...
	./$(COMPILER) test/test_nilpy_tuple_identity.npy $(TESTTMP)/test_nilpy_tupleid26
	test "$$($(TESTTMP)/test_nilpy_tupleid26)" = "$$(printf '%b' '(1, 2, 3)\n(2, 3)\n(1, 2)\n(3, 2, 1)\n(1, 2, 3, 4)\n(1, 2, 3, 1, 2, 3)\n[2, 3]\n[3, 2, 1]\n[1, 2, 3, 4]\n[1, 2, 3, 1, 2, 3]\n[1, 2, 3]\n[1, 2, 3]\n[3, 2, 1]\n(5,)\n(5, 5)')"
	...
	./$(COMPILER) test/test_nilpy_range_variant_bound.npy $(TESTTMP)/test_nilpy_rangevar26
	test "$$($(TESTTMP)/test_nilpy_rangevar26)" = "$$(printf '%b' '[0, 1, 4, 9]\n[2, 3, 4]\n[0, 3, 6, 9]\n[0, 1, 2]\n[]\n[0, 2, 4]\n[0, 1, 2, 3]\n[0, 1, 2]')"
	...
	./$(COMPILER) test/test_nilpy_round.npy $(TESTTMP)/test_nilpy_round26
	test "$$($(TESTTMP)/test_nilpy_round26)" = "$$(printf '%b' '0 2 2 4 0 -2\n1 -2\n0.12 2.0\n2.35 0.14 1.0\n3.142 3.1\n1200.0 1230.0 16000.0\n-1200.0\n2.67 2.67\n9.99 0.04 0.3 100.0\n1.0 0.0 -0.0 0.0')"
	...
	./$(COMPILER) test/test_nilpy_hex_bin_oct_bigint.npy $(TESTTMP)/test_nilpy_hexbig26
	$(TESTTMP)/test_nilpy_hexbig26 | diff -u test/test_nilpy_hex_bin_oct_bigint.expected -
	...
	./$(COMPILER) test/test_nilpy_int_promotion_default.npy $(TESTTMP)/test_nilpy_intpromo26
	$(TESTTMP)/test_nilpy_intpromo26 | diff -u test/test_nilpy_int_promotion_default.expected -
	...
	./$(COMPILER) test/test_nilpy_nested_comprehension_over_range.npy $(TESTTMP)/test_nilpy_nestcomp26
	$(TESTTMP)/test_nilpy_nestcomp26 | diff -u test/test_nilpy_nested_comprehension_over_range.expected -
	...
	./$(COMPILER) test/test_nilpy_augmented_subscript_variant_base.npy $(TESTTMP)/test_nilpy_augsubvar26
	$(TESTTMP)/test_nilpy_augsubvar26 | diff -u test/test_nilpy_augmented_subscript_variant_base.expected -
	...
	./$(COMPILER) test/test_nilpy_while_condition_hoist.npy $(TESTTMP)/test_nilpy_whilehoist26
	$(TESTTMP)/test_nilpy_whilehoist26 | diff -u test/test_nilpy_while_condition_hoist.expected -
	...
	./$(COMPILER) test/test_nilpy_nested_def_own_local_not_a_capture.npy $(TESTTMP)/test_nilpy_ndcap26
	$(TESTTMP)/test_nilpy_ndcap26 | diff -u test/test_nilpy_nested_def_own_local_not_a_capture.expected -
	...
	./$(COMPILER) test/test_nilpy_container_kind_tag.npy $(TESTTMP)/test_nilpy_ckt26
	$(TESTTMP)/test_nilpy_ckt26 | diff -u test/test_nilpy_container_kind_tag.expected -
	...
	./$(COMPILER) test/test_nilpy_for_inline_suite.npy $(TESTTMP)/test_nilpy_fis26
	$(TESTTMP)/test_nilpy_fis26 | diff -u test/test_nilpy_for_inline_suite.expected -
	...
	./$(COMPILER) test/test_nilpy_repr_and_range_consumers.npy $(TESTTMP)/test_nilpy_reprrange26
	$(TESTTMP)/test_nilpy_reprrange26 | diff -u test/test_nilpy_repr_and_range_consumers.expected -
	...
	@./$(COMPILER) test/test_nilpy_method_arity_missing_args_fails.npy $(TESTTMP)/test_nilpy_arity_fail26 2>&1 \
	...
	./$(COMPILER) test/test_nilpy_method_arity_ok.npy $(TESTTMP)/test_nilpy_arity_ok26
	$(TESTTMP)/test_nilpy_arity_ok26 | diff -u test/test_nilpy_method_arity_ok.expected -
	...
	./$(COMPILER) test/test_nilpy_dict_mutation_during_iteration.npy $(TESTTMP)/test_nilpy_dictmut26
	$(TESTTMP)/test_nilpy_dictmut26 | diff -u test/test_nilpy_dict_mutation_during_iteration.expected -
	...
	./$(COMPILER) test/test_nilpy_print_container_arg_freshness.npy $(TESTTMP)/test_nilpy_pargord26
	$(TESTTMP)/test_nilpy_pargord26 | diff -u test/test_nilpy_print_container_arg_freshness.expected -
	...
	# the test's header.
	./$(COMPILER) test/test_nilpy_index_dunder_typeerror.npy $(TESTTMP)/test_nilpy_idxdun26
	test "$$($(TESTTMP)/test_nilpy_idxdun26)" = "$$(printf '%b' 'obj-key-ok\n20 c 120\nlist TypeError\nstr TypeError\nbytes TypeError\n20 b 121')"
	...
	./$(COMPILER) test/test_nilpy_list_mutators_return_none.npy $(TESTTMP)/test_nilpy_lmut26
	$(TESTTMP)/test_nilpy_lmut26 | diff -u test/test_nilpy_list_mutators_return_none.expected -
	...
	./$(COMPILER) test/test_nilpy_chained_assign_powassign.npy $(TESTTMP)/test_nilpy_chpow26
	test "$$($(TESTTMP)/test_nilpy_chpow26)" = "$$(printf '%b' '5 5\nhi hi hi\n7 7 1\n6\n[1, 2, 3] [1, 2, 3]\n2 2\n8\n0.5\n2.0\n0.5 2.0\n4')"
	...
	./$(COMPILER) test/test_nilpy_comprehension_two_for.npy $(TESTTMP)/test_nilpy_c2for26
	$(TESTTMP)/test_nilpy_c2for26 | diff -u test/test_nilpy_comprehension_two_for.expected -
	...
	./$(COMPILER) test/test_nilpy_bytearray_ctor.npy $(TESTTMP)/test_nilpy_bactor26
	test "$$($(TESTTMP)/test_nilpy_bactor26)" = "$$(printf '%b' '3 97 98 99\n122\n120 65\n3 1 3\n0\n3 0\n0\nValueError')"
	...
	./$(COMPILER) test/test_nilpy_nested_def_name_per_method.npy $(TESTTMP)/test_nilpy_ndpm26
	test "$$($(TESTTMP)/test_nilpy_ndpm26)" = "$$(printf '%b' '11 99 20 15\n11 99')"
	...
	./$(COMPILER) test/test_nilpy_nested_def_self_field.npy $(TESTTMP)/test_nilpy_nselffld26
	test "$$($(TESTTMP)/test_nilpy_nselffld26)" = "$$(printf '%b' '17 7 17 17\n17 hi 17\n3 6')"
	...
	test "$$($(TESTTMP)/test_nilpy_lamsib26)" = "$$(printf '%b' '11 15 16 11\n11 6 11\n11')"
	...
	./$(COMPILER) test/test_nilpy_stdlib_shim_arity.npy $(TESTTMP)/test_nilpy_shimarity26
	test "$$($(TESTTMP)/test_nilpy_shimarity26)" = "$$(printf '%b' 'a/b\na/b/c\na/b/c/d\n/x/y/z\na/c\ndflt')"
	...
	./$(COMPILER) test/test_nilpy_range_into_list.npy $(TESTTMP)/test_nilpy_rangelist26
	test "$$($(TESTTMP)/test_nilpy_rangelist26)" = "$$(printf '%b' '[0, 1, 2]\n[1, 2, 3]\n[0, 3, 6, 9]\n[3, 2, 1]\n[]\n[]\n[-3, -1, 1]\n[0, 1, 2, 3]\n[0, 1, 2]\n10\n[0, 1, 9]\nValueError\na   b a       b     \nab  c abcd    e a b c\na\nb   c\na b ab no tabs\n9')"
	...
	./$(COMPILER) test/test_nilpy_pow_mod.npy $(TESTTMP)/test_nilpy_powmod26
	test "$$($(TESTTMP)/test_nilpy_powmod26)" = "$$(printf '%b' '24 1024 1 0\n8 -2 2 -3\n560583526\n1 0\n3 5 11\n281250002\nValueError-zero-mod\nValueError-not-invertible\n1,234,567\nbd [2, 4] ace fedcba')"
	...
	# CPython's.
	./$(COMPILER) test/test_nilpy_def_return_type.npy $(TESTTMP)/test_nilpy_defret26
	test "$$($(TESTTMP)/test_nilpy_defret26)" = "$$(printf '%b' '2.5 1 2.5 0.5\n1.5 2.5 1.5 1.5\n0.25 1.5 7 6\nlate')"
	...
	./$(COMPILER) test/test_nilpy_int_field_width.npy $(TESTTMP)/test_nilpy_intfld26
	test "$$($(TESTTMP)/test_nilpy_intfld26)" = "$$(printf '%b' '1073741824\n2147483648\n4294967296\n1099511627776\n4611686018427387904\n-4294967296\n4294967296')"
	...
	./$(COMPILER) test/test_nilpy_str_format_indices.npy $(TESTTMP)/test_nilpy_fmtidx26
	test "$$($(TESTTMP)/test_nilpy_fmtidx26)" = "$$(printf '%b' 'ba\nab\nab\nx-x\ny-y\n7\n7\n[   ab]\n[   cd]\n{literal} v\n3.14 and 2.7')"
	...
	./$(COMPILER) test/test_nilpy_bool_protocol.npy $(TESTTMP)/test_nilpy_boolproto26
	test "$$($(TESTTMP)/test_nilpy_boolproto26)" = "$$(printf '%b' 'False False True True\nTrue True False False\nif-bf: falsy\nif-l3: truthy\nif-np: truthy\nFalse True True False True\nFalse True False True False True\nTrue False\nFalse\nFalse True\nFalse False False True True\nFalse\nTrue')"
	...
	./$(COMPILER) test/test_nilpy_static_mixed_type_guard.npy $(TESTTMP)/test_nilpy_statguard26
	test "$$($(TESTTMP)/test_nilpy_statguard26)" = "$$(printf '%b' 'int-list  TypeError\nint/list  TypeError\nint//list TypeError\nint%list  TypeError\nint<list  TypeError\nint>=list TypeError\nstr-list  TypeError\nstr<int   TypeError\nlist//int TypeError\nlist%int  TypeError\nstr-str  TypeError\nstr/str  TypeError\nstr//str TypeError\n[1, 3]\n[1, 2, 1, 2] abab\n5 ok\n5 3.5 3 1\n2.5 2 True\nTrue True True\n[1, 2] ab\nTrue')"
	...
	./$(COMPILER) test/test_nilpy_sequence_ordering.npy $(TESTTMP)/test_nilpy_seqord26
	test "$$($(TESTTMP)/test_nilpy_seqord26)" = "$$(printf '%b' 'False\nTrue\nFalse\nTrue\nFalse True False True True\nTrue\nFalse\nTrue\nFalse True\nFalse True\nTrue\nFalse\nTrue True\nFalse True')"
	...
	./$(COMPILER) test/test_nilpy_typed_const_import.npy $(TESTTMP)/test_nilpy_typedconst26
	test "$$($(TESTTMP)/test_nilpy_typedconst26)" = "$$(printf '%b' '72.0\n2.834645669291339\n28.346456692913385\nTrue\nTrue\nTrue\nTrue')"
	...
	./$(COMPILER) test/test_nilpy_def_local_shadows_module_global.npy $(TESTTMP)/test_nilpy_deflocal26
	test "$$($(TESTTMP)/test_nilpy_deflocal26)" = "$$(printf '%b' 'hello\n1\nADD2\nfor-done\n11\nnested\n21\nwritten\nread-ok\nctrl-ok')"
	...
	./$(COMPILER) test/test_nilpy_global_shadowed_by_param.npy $(TESTTMP)/test_nilpy_gshadow26
	test "$$($(TESTTMP)/test_nilpy_gshadow26)" = "$$(printf '%b' '1\nADD2\nADD1\nFalse\nTrue\n10\nADD2\nADD2\n8\n7')"
	# unary minus dunder (__neg__) on a user class; expectation is CPython's own output
	./$(COMPILER) test/test_nilpy_neg_dunder.npy $(TESTTMP)/test_nilpy_negdunder26
	test "$$($(TESTTMP)/test_nilpy_negdunder26)" = "$$(printf '%b' 'Neg(-5)\nNeg(3)\n-5\n-6\n-4')"
	...
	./$(COMPILER) -Futest/nilpy_units -Ilib/cpyext/include test/test_cpyext_hello.npy $(TESTTMP)/test_cpyext_hello26
	test "$$($(TESTTMP)/test_cpyext_hello26)" = "42"
	...
	./$(COMPILER) -Futest/nilpy_units -Ilib/cpyext/include test/test_cpyext_args_errors.npy $(TESTTMP)/test_cpyext_args_errors26
	test "$$($(TESTTMP)/test_cpyext_args_errors26)" = "$$(printf '9.0\nHELLO\n6\n99\n5\ncaught: x must be non-negative')"
	...
	# from PyUnicode_*
	./$(COMPILER) -Futest/nilpy_units -Ilib/cpyext/include test/test_cpyext_containers.npy $(TESTTMP)/test_cpyext_containers26
	test "$$($(TESTTMP)/test_cpyext_containers26)" = "$$(printf '10\n2,3,1\nb:1,a:3,n:2\n5:hello')"
	...
	./$(COMPILER) -Futest/nilpy_units -Ilib/cpyext/include test/test_cpyext_markupsafe.npy $(TESTTMP)/test_cpyext_markupsafe26
	test "$$($(TESTTMP)/test_cpyext_markupsafe26)" = "$$(printf '&lt;b&gt;hi &amp; &#34;bye&#34; &#39;all&#39;&lt;/b&gt;\nplain text, no specials')"
	...
	./$(COMPILER) -Futest/nilpy_units -Ilib/cpyext/include test/test_cpyext_errformat.npy $(TESTTMP)/test_cpyext_errformat26
	...
	test "$$($(TESTTMP)/test_cpyext_cython26)" = "$$(printf '42\n0\n3000000\n1\n720\n3628800\n479001600\n22\n22\n22\n22\n42\nbadkw raised\ncython_function_or_method\ncyadd\ncysub\na,b\nn,i,r')"
	...
	./$(COMPILER) test/test_nilpy_str_method_name_collides_with_class_method.npy $(TESTTMP)/test_nilpy_strcoll26
	$(TESTTMP)/test_nilpy_strcoll26 | diff -u test/test_nilpy_str_method_name_collides_with_class_method.expected -
	...
	./$(COMPILER) test/test_nilpy_with_early_exit_runs_exit.npy $(TESTTMP)/test_nilpy_withexit26
	$(TESTTMP)/test_nilpy_withexit26 | diff -u test/test_nilpy_with_early_exit_runs_exit.expected -
...
test-asm-emit:
	@for t in x64 386 rv32 a64 arm32; do \
	  $(FPC) -FU$(TESTTMP) -FE$(TESTTMP) test/test_asm_emit_$$t.pas >$(TESTTMP)/asmemit_$$t.log 2>&1 || \
	    { echo "asm-emit $$t: BUILD FAIL"; cat $(TESTTMP)/asmemit_$$t.log; exit 1; }; \
	  $(TESTTMP)/test_asm_emit_$$t >/dev/null || \
	    { echo "asm-emit $$t: FAIL"; $(TESTTMP)/test_asm_emit_$$t; exit 1; }; \
	  echo "asm-emit $$t: OK"; \
	done
...
test-asm: $(COMPILER)
	...
	$(TESTTMP)/test_asmcore_arm32_26 | tail -1 | grep -q "all asmcore_arm32 checks passed"
	./$(COMPILER) test/test_asmcore_riscv32.pas $(TESTTMP)/test_asmcore_riscv32_26
	$(TESTTMP)/test_asmcore_riscv32_26 | tail -1 | grep -q "all asmcore_riscv32 checks passed"
	...
	readelf -s $(TESTTMP)/test_asm_obj26.o | grep -q 'GLOBAL DEFAULT    1 asm_obj_add'
	readelf -s $(TESTTMP)/test_asm_obj26.o | grep -q 'GLOBAL DEFAULT    1 asm_obj_start'
	readelf -s $(TESTTMP)/test_asm_obj26.o | grep -q 'UND puts'
	readelf -r $(TESTTMP)/test_asm_obj26.o | grep -q 'R_X86_64_PLT32'
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/test_asm_obj26_caller_exe && echo "test-asm: .o exported symbol callable from C ok"; \
	else echo "test-asm: gcc not installed; .o link check skipped"; fi
	./$(COMPILER) test/test_asm_so.asm $(TESTTMP)/test_asm_so26.so
	readelf -h $(TESTTMP)/test_asm_so26.so | grep -q 'DYN (Shared object file)'
	readelf -h $(TESTTMP)/test_asm_so26.so | grep -q 'X86-64'
	readelf -d $(TESTTMP)/test_asm_so26.so | grep -q 'NEEDED.*libc.so.6'
	@if command -v gcc >/dev/null 2>&1; then \
...
test-core: $(COMPILER)
	...
	grep -q "string parameter's default must be a string literal" $(TESTTMP)/test_odsp.log
	! ./$(COMPILER) test/test_string_default_on_ordinal_param_fail.pas $(TESTTMP)/test_sdop26 > $(TESTTMP)/test_sdop.log 2>&1
	grep -q "string literal cannot be the default for a non-string parameter" $(TESTTMP)/test_sdop.log
	! ./$(COMPILER) test/test_forin_string_char_fail.pas $(TESTTMP)/test_fsc26 > $(TESTTMP)/test_fsc.log 2>&1
	grep -q "loop variable must be of type Char" $(TESTTMP)/test_fsc.log
	...
	! ./$(COMPILER) --strict-fpc test/strict_fpc_case_fail.pas $(TESTTMP)/strict_fpc_case26 > $(TESTTMP)/strict_fpc_case.log 2>&1
	...
	grep -q "cannot have protected members" $(TESTTMP)/test_recprot.log
	! ./$(COMPILER) test/test_record_ctor_noparam_fail.pas $(TESTTMP)/test_recctor26 > $(TESTTMP)/test_recctor.log 2>&1
	grep -q "at least one parameter without a default" $(TESTTMP)/test_recctor.log
	! ./$(COMPILER) test/test_record_local_advanced_fail.pas $(TESTTMP)/test_recloc26 > $(TESTTMP)/test_recloc.log 2>&1
	grep -q "can only have fields" $(TESTTMP)/test_recloc.log
	...
	grep -q "routine used before its declaration" $(TESTTMP)/test_reqfwd.log
	...
	! ./$(COMPILER) test/test_sealed_class_fail.pas $(TESTTMP)/test_sealed26 > $(TESTTMP)/test_sealed.log 2>&1
	grep -q "cannot derive from the sealed class" $(TESTTMP)/test_sealed.log
	! ./$(COMPILER) test/test_sealed_abstract_method_fail.pas $(TESTTMP)/test_sealedam26 > $(TESTTMP)/test_sealedam.log 2>&1
	grep -q "sealed class cannot have an abstract method" $(TESTTMP)/test_sealedam.log
	...
	grep -q "stray token at top level" $(TESTTMP)/cstray_toplevel_reject_b193.log
	...
	! ./$(COMPILER) test/cundeclared_fnptr_arg_rejected_b167.c $(TESTTMP)/cundeclared_fnptr_arg_rejected_b16726 > $(TESTTMP)/cundeclared_fnptr_arg_rejected_b167.log 2>&1
	grep -q "undeclared identifier passed as argument" $(TESTTMP)/cundeclared_fnptr_arg_rejected_b167.log
	...
	./$(COMPILER) --system-libs=c test/csystem_libs_granular_libc_b113.c $(TESTTMP)/csystem_libs_granular_libc_b11326
	@if command -v readelf >/dev/null 2>&1; then \
	  readelf -d $(TESTTMP)/csystem_libs_granular_libc_b11326 | grep -q "Shared library: \\[libc.so.6\\]"; \
	...
	! ./$(COMPILER) --strict-case test/test_case_range_inverted_error.pas $(TESTTMP)/test_case_range_inv26 > $(TESTTMP)/test_case_range_inv.log 2>&1
	...
	@if [ -x /usr/bin/time ]; then \
	  /usr/bin/time -v $(TESTTMP)/test_big_static_array_open_param26 2>$(TESTTMP)/bsoa.time >/dev/null; \
	  rss=$$(grep -oE 'Maximum resident set size .kbytes.: [0-9]+' $(TESTTMP)/bsoa.time | grep -oE '[0-9]+$$'); \
	...
	grep -q "jump_if_false" $(TESTTMP)/test_ir_for26.log
	grep -q "binop" $(TESTTMP)/test_ir_for26.log
	...
	! ./$(COMPILER) test/test_decl_order_global_error.pas $(TESTTMP)/test_decl_order_global_error26 > $(TESTTMP)/test_decl_order_global_error.log 2>&1
	grep -q "declared later" $(TESTTMP)/test_decl_order_global_error.log
	...
	! ./$(COMPILER) -Werror test/test_warn_stack_frame.pas $(TESTTMP)/test_warn_stack_frame_werr26 > $(TESTTMP)/test_warn_stack_frame_werr.log 2>&1
	...
	! $(TESTTMP)/test_exception_unit_unhandled26 > $(TESTTMP)/test_exception_unit_unhandled.out 2> $(TESTTMP)/test_exception_unit_unhandled.log
	grep -q "Unhandled exception" $(TESTTMP)/test_exception_unit_unhandled.log
	...
	test ! -s $(TESTTMP)/test_exception_silent.log
	./$(COMPILER) -fno-unhandled-handler test/test_exception_unhandled.pas $(TESTTMP)/test_exception_silent_alias26
	! $(TESTTMP)/test_exception_silent_alias26 > $(TESTTMP)/test_exception_silent_alias.out 2> $(TESTTMP)/test_exception_silent_alias.log
	test ! -s $(TESTTMP)/test_exception_silent_alias.log
...
test-riscv32: $(COMPILER)
	...
	./$(COMPILER) -Fulib/rtl test/lib_bignum_ops.pas $(TESTTMP)/test_riscv32_bignum_x64
	$(TESTTMP)/test_riscv32_bignum_x64 > $(TESTTMP)/test_riscv32_bignum_x64.out
	diff $(TESTTMP)/test_riscv32_bignum_x64.out $(TESTTMP)/test_riscv32_bignum.out
...
cross-bootstrap-aarch64: $(COMPILER)
	./$(COMPILER) $(CROSS_BOOTSTRAP_FLAGS) --target=aarch64 compiler/compiler.pas $(TESTTMP)/pc_aarch64
	tools/run_target.sh aarch64 $(TESTTMP)/pc_aarch64 $(CROSS_BOOTSTRAP_FLAGS) --target=aarch64 compiler/compiler.pas $(TESTTMP)/pc_aarch64_2
	cmp $(TESTTMP)/pc_aarch64 $(TESTTMP)/pc_aarch64_2
	@echo "aarch64 cross self-host: byte-identical self-fixedpoint OK"

cross-bootstrap-arm32: $(COMPILER)
	./$(COMPILER) $(CROSS_BOOTSTRAP_FLAGS) --target=arm32 compiler/compiler.pas $(TESTTMP)/pc_arm32
	tools/run_target.sh arm32 $(TESTTMP)/pc_arm32 $(CROSS_BOOTSTRAP_FLAGS) --target=arm32 compiler/compiler.pas $(TESTTMP)/pc_arm32_2
	cmp $(TESTTMP)/pc_arm32 $(TESTTMP)/pc_arm32_2
	@echo "arm32 cross self-host: byte-identical self-fixedpoint OK"

cross-bootstrap-i386: $(COMPILER)
	./$(COMPILER) $(CROSS_BOOTSTRAP_FLAGS) --target=i386 compiler/compiler.pas $(TESTTMP)/pc_i386
	tools/run_target.sh i386 $(TESTTMP)/pc_i386 $(CROSS_BOOTSTRAP_FLAGS) --target=i386 compiler/compiler.pas $(TESTTMP)/pc_i386_2
	cmp $(TESTTMP)/pc_i386 $(TESTTMP)/pc_i386_2
...
test-lua-cross: $(COMPILER)
	...
	for T in $(LUA_CROSS_TARGETS); do \
	  ...
	  if ! ./$(COMPILER) --target=$$T -g -Ilib/crtl/include -Ilib/crtl/src -I$(LUA_SRC) \
	       test/lua/runner.c $(TESTTMP)/pxx_lua_$$T 2>$(TESTTMP)/pxx_lua_$$T.err; then \
	    echo "test-lua-cross: FAIL $$T (build error)"; head -3 $(TESTTMP)/pxx_lua_$$T.err; overall=1; continue; \
	  fi; \
	  fail=0; \
...
test-zlib: $(COMPILER)
	...
	gcc -w -DHAVE_UNISTD_H -I$(ZLIB_SRC) -o $(TESTTMP)/pxx_zlib_oracle \
...
test-chess-perft: $(COMPILER)
	...
	./$(COMPILER) $$deep -Ilib/crtl/include -Ilib/crtl/src -I$(CHESS_SRC) \
	  test/chess/perft_runner.c $(TESTTMP)/pxx_chess_perft || exit 1; \
	$(TESTTMP)/pxx_chess_perft > $(TESTTMP)/pxx_chess_perft.txt 2>&1; rc=$$?; \
	cat $(TESTTMP)/pxx_chess_perft.txt; \
	if [ "$$rc" = "42" ]; then \
...
test-emit-obj: $(COMPILER)
	...
	readelf -h $(TESTTMP)/test_emit_obj_xt.o | grep -q 'REL (Relocatable file)'
	...
	./$(COMPILER) --target=xtensa test/cxtensa_obj.c $(TESTTMP)/cxtensa_obj_xt.o
	readelf -h $(TESTTMP)/cxtensa_obj_xt.o | grep -q 'REL (Relocatable file)'
	readelf -h $(TESTTMP)/cxtensa_obj_xt.o | grep -q 'Xtensa'
	readelf -s $(TESTTMP)/cxtensa_obj_xt.o | grep -q 'FUNC    GLOBAL DEFAULT    1 app_main'
	readelf -s $(TESTTMP)/cxtensa_obj_xt.o | grep -q 'UND ext_notify'
	readelf -r $(TESTTMP)/cxtensa_obj_xt.o | grep -q 'R_XTENSA_32'
	./$(COMPILER) --target=riscv32 test/cxtensa_obj.c $(TESTTMP)/cxtensa_obj_rv.o
	readelf -h $(TESTTMP)/cxtensa_obj_rv.o | grep -q 'REL (Relocatable file)'
	readelf -s $(TESTTMP)/cxtensa_obj_rv.o | grep -q 'FUNC    GLOBAL DEFAULT    1 app_main'
	./$(COMPILER) --target=xtensa --xtensa-abi=windowed test/test_emit_obj.pas $(TESTTMP)/test_emit_obj_xt_windowed.o
	readelf -h $(TESTTMP)/test_emit_obj_xt_windowed.o | grep -q 'REL (Relocatable file)'
...
test-esp-bare: $(COMPILER)
	...
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 bare-boot run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_bare.pas > $(TESTTMP)/test_esp_bare.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_bare.oracle $(TESTTMP)/test_esp_bare.c3; then echo "esp32c3 bare-boot ok (UART output == x86-64 oracle)"; \
	...
	@./$(COMPILER) test/test_esp_bare_arg64.pas $(TESTTMP)/test_esp_arg64_oracle >/dev/null && $(TESTTMP)/test_esp_arg64_oracle > $(TESTTMP)/test_esp_arg64.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 arg64 run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_bare_arg64.pas > $(TESTTMP)/test_esp_arg64.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_arg64.oracle $(TESTTMP)/test_esp_arg64.c3; then echo "esp32c3 odd-index 64-bit args ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 arg64 run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_bare_arg64.pas > $(TESTTMP)/test_esp_arg64.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_arg64.oracle $(TESTTMP)/test_esp_arg64.s3; then echo "esp32s3 odd-index 64-bit args ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 odd-index 64-bit args MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_frozen_string.pas $(TESTTMP)/test_esp_frz_oracle >/dev/null && $(TESTTMP)/test_esp_frz_oracle > $(TESTTMP)/test_esp_frz.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 frozen-string run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_frozen_string.pas > $(TESTTMP)/test_esp_frz.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_frz.oracle $(TESTTMP)/test_esp_frz.c3; then echo "esp32c3 frozen string[N] ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 frozen-string run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_frozen_string.pas > $(TESTTMP)/test_esp_frz.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_frz.oracle $(TESTTMP)/test_esp_frz.s3; then echo "esp32s3 frozen string[N] ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 frozen string MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_varparam.pas $(TESTTMP)/test_esp_varparam_oracle >/dev/null && $(TESTTMP)/test_esp_varparam_oracle > $(TESTTMP)/test_esp_varparam.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 var-param run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_varparam.pas > $(TESTTMP)/test_esp_varparam.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_varparam.oracle $(TESTTMP)/test_esp_varparam.c3; then echo "esp32c3 var->var forwarding ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 var-param run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_varparam.pas > $(TESTTMP)/test_esp_varparam.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_varparam.oracle $(TESTTMP)/test_esp_varparam.s3; then echo "esp32s3 var->var forwarding ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 var->var forwarding MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_record_result.pas $(TESTTMP)/test_esp_record_result_oracle >/dev/null && $(TESTTMP)/test_esp_record_result_oracle > $(TESTTMP)/test_esp_record_result.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 record-result run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_record_result.pas > $(TESTTMP)/test_esp_record_result.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_record_result.oracle $(TESTTMP)/test_esp_record_result.c3; then echo "esp32c3 record copy + by-value results ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 record-result run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_record_result.pas > $(TESTTMP)/test_esp_record_result.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_record_result.oracle $(TESTTMP)/test_esp_record_result.s3; then echo "esp32s3 (Call0) record copy + by-value results ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 record result MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_exception.pas $(TESTTMP)/test_esp_exception_oracle >/dev/null && $(TESTTMP)/test_esp_exception_oracle > $(TESTTMP)/test_esp_exception.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 exception run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_exception.pas > $(TESTTMP)/test_esp_exception.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_exception.oracle $(TESTTMP)/test_esp_exception.c3; then echo "esp32c3 try/except/finally ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 exception run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_exception.pas > $(TESTTMP)/test_esp_exception.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_exception.oracle $(TESTTMP)/test_esp_exception.s3; then echo "esp32s3 (Call0) try/except/finally ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 exception MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_class.pas $(TESTTMP)/test_esp_class_oracle >/dev/null && $(TESTTMP)/test_esp_class_oracle > $(TESTTMP)/test_esp_class.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 class run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_class.pas > $(TESTTMP)/test_esp_class.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_class.oracle $(TESTTMP)/test_esp_class.c3; then echo "esp32c3 class + virtual dispatch ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 class run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_class.pas > $(TESTTMP)/test_esp_class.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_class.oracle $(TESTTMP)/test_esp_class.s3; then echo "esp32s3 class + virtual dispatch ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 class MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_procvar.pas $(TESTTMP)/test_esp_procvar_oracle >/dev/null && $(TESTTMP)/test_esp_procvar_oracle > $(TESTTMP)/test_esp_procvar.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 procvar run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_procvar.pas > $(TESTTMP)/test_esp_procvar.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_procvar.oracle $(TESTTMP)/test_esp_procvar.c3; then echo "esp32c3 proc-var indirect call ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 procvar run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_procvar.pas > $(TESTTMP)/test_esp_procvar.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_procvar.oracle $(TESTTMP)/test_esp_procvar.s3; then echo "esp32s3 (Call0) proc-var indirect call ok (UART output == x86-64 oracle)"; \
	  else echo "esp32s3 procvar MISMATCH"; exit 1; fi; fi
	@./$(COMPILER) test/test_esp_stack_args.pas $(TESTTMP)/test_esp_stack_args_oracle >/dev/null && $(TESTTMP)/test_esp_stack_args_oracle > $(TESTTMP)/test_esp_stack_args.oracle
	@RV=$$(ls $$HOME/.espressif/tools/qemu-riscv32/*/qemu/bin/qemu-system-riscv32 2>/dev/null | head -1); \
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 stack-args run skipped"; else \
	  ESP_RUN_TIMEOUT=8 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_stack_args.pas > $(TESTTMP)/test_esp_stack_args.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_stack_args.oracle $(TESTTMP)/test_esp_stack_args.c3; then echo "esp32c3 >6-word args ok (UART output == x86-64 oracle)"; \
...
test-esp-idf: $(COMPILER)
	...
	@for chip in esp32c3 esp32s3; do \
	  ...
	  ESP_RUN_TIMEOUT=25 ESP_PXXFLAGS="--no-signals -Fu$(CURDIR)/lib/rtl -Fu$(CURDIR)/lib/rtl/platform/esp" \
	    ...
	    | grep "PXX timer" > $(TESTTMP)/test_esp_idf_timer.$$chip || true; \
	  printf 'PXX timer: started\nPXX timer: tick=1\nPXX timer: tick=2\nPXX timer: tick=3\nPXX timer: tick=4\nPXX timer: tick=5\nPXX timer: done ticks=5 status=0\n' > $(TESTTMP)/test_esp_idf_timer.expected; \
	  if diff -u $(TESTTMP)/test_esp_idf_timer.expected $(TESTTMP)/test_esp_idf_timer.$$chip; then \
...
test-esp-softfloat: $(COMPILER)
	...
	if [ -z "$$RV" ]; then echo "Espressif qemu-system-riscv32 not installed; esp32c3 softfloat run skipped"; else \
	  ESP_RUN_TIMEOUT=12 tools/esp_run_bare.sh --chip esp32c3 test/test_esp_softfloat_probe.pas > $(TESTTMP)/test_esp_softfloat.c3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_softfloat.oracle $(TESTTMP)/test_esp_softfloat.c3; then echo "esp32c3 softfloat/int64 ok (UART output == x86-64 oracle)"; \
	...
	if [ -z "$$XT" ]; then echo "Espressif qemu-system-xtensa not installed; esp32s3 softfloat run skipped"; else \
	  ESP_RUN_TIMEOUT=12 tools/esp_run_bare.sh --chip esp32s3 test/test_esp_softfloat_probe.pas > $(TESTTMP)/test_esp_softfloat.s3 2>/dev/null; \
	  if diff -u $(TESTTMP)/test_esp_softfloat.oracle $(TESTTMP)/test_esp_softfloat.s3; then echo "esp32s3 softfloat/int64 ok (UART output == x86-64 oracle)"; \
...
qemu-env-check: $(COMPILER)
	...
	@fail=0; for a in i386 aarch64 arm32; do \
	  ...
	  chmod +x $(TESTTMP)/qemu_probe_$$a; \
	  if tools/run_target.sh $$a $(TESTTMP)/qemu_probe_$$a; then rc=0; else rc=$$?; fi; \
	  if [ "$$rc" = 42 ]; then \
...
test-opt: $(COMPILER)
	for t in test_dynarray_torture test_dynarray_insert_delete \
	         ...
	         test_exc_resident_param test_opt_store_reload; do \
	  ./$(COMPILER) test/$$t.pas $(TESTTMP)/opt0_$$t >/dev/null && \
	  ./$(COMPILER) -O1 test/$$t.pas $(TESTTMP)/opt1_$$t >/dev/null && \
	  ./$(COMPILER) -O2 test/$$t.pas $(TESTTMP)/opt2_$$t >/dev/null && \
	  ./$(COMPILER) -O3 test/$$t.pas $(TESTTMP)/opt3_$$t >/dev/null && \
	  $(TESTTMP)/opt0_$$t > $(TESTTMP)/opt0_$$t.out && $(TESTTMP)/opt1_$$t > $(TESTTMP)/opt1_$$t.out && \
	  $(TESTTMP)/opt2_$$t > $(TESTTMP)/opt2_$$t.out && $(TESTTMP)/opt3_$$t > $(TESTTMP)/opt3_$$t.out && \
	  cmp -s $(TESTTMP)/opt0_$$t.out $(TESTTMP)/opt1_$$t.out || { echo "OPT DIFF O1: $$t"; exit 1; }; \
	  cmp -s $(TESTTMP)/opt0_$$t.out $(TESTTMP)/opt2_$$t.out || { echo "OPT DIFF O2: $$t"; exit 1; }; \
	  cmp -s $(TESTTMP)/opt0_$$t.out $(TESTTMP)/opt3_$$t.out || { echo "OPT DIFF O3: $$t"; exit 1; }; \
	done
	...
	@for o in -O0 -O2 -O3; do \
	  ./$(COMPILER) $$o -Ilib/crtl/include -Ilib/crtl/src test/c_inline_strlit_arg.c $(TESTTMP)/c_inl_strlit >/dev/null && \
	  out=$$($(TESTTMP)/c_inl_strlit); \
	  [ "$$out" = "literal_ok=1 variable_ok=1" ] || \
	    { echo "FAIL: c_inline_strlit_arg at $$o -> $$out"; exit 1; }; \
	done; echo 'c_inline_strlit_arg: -O0/-O2/-O3 agree'
	./$(COMPILER) --threadsafe test/test_atomic64.pas $(TESTTMP)/opt0_atomic64 >/dev/null
	./$(COMPILER) -O1 --threadsafe test/test_atomic64.pas $(TESTTMP)/opt1_atomic64 >/dev/null
	$(TESTTMP)/opt0_atomic64 > $(TESTTMP)/opt0_a64.out; $(TESTTMP)/opt1_atomic64 > $(TESTTMP)/opt1_a64.out
	cmp $(TESTTMP)/opt0_a64.out $(TESTTMP)/opt1_a64.out
	# -O1 self-compile fixedpoint: an -O1-built compiler rebuilding itself at
	# -O1 must reach byte-identity too
	./$(COMPILER) -O1 $(COMPILER_SRC) $(TESTTMP)/pascal26-o1a.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o1a.$$$$.tmp $(TESTTMP)/pascal26-o1a
	$(TESTTMP)/pascal26-o1a -O1 $(COMPILER_SRC) $(TESTTMP)/pascal26-o1b.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o1b.$$$$.tmp $(TESTTMP)/pascal26-o1b
	$(TESTTMP)/pascal26-o1b -O1 $(COMPILER_SRC) $(TESTTMP)/pascal26-o1c.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o1c.$$$$.tmp $(TESTTMP)/pascal26-o1c
	cmp $(TESTTMP)/pascal26-o1b $(TESTTMP)/pascal26-o1c
	...
	./$(COMPILER) -O2 $(COMPILER_SRC) $(TESTTMP)/pascal26-o2a.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o2a.$$$$.tmp $(TESTTMP)/pascal26-o2a
	$(TESTTMP)/pascal26-o2a -O2 $(COMPILER_SRC) $(TESTTMP)/pascal26-o2b.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o2b.$$$$.tmp $(TESTTMP)/pascal26-o2b
	$(TESTTMP)/pascal26-o2b -O2 $(COMPILER_SRC) $(TESTTMP)/pascal26-o2c.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o2c.$$$$.tmp $(TESTTMP)/pascal26-o2c
	cmp $(TESTTMP)/pascal26-o2b $(TESTTMP)/pascal26-o2c
	...
	./$(COMPILER) -O3 $(COMPILER_SRC) $(TESTTMP)/pascal26-o3a.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o3a.$$$$.tmp $(TESTTMP)/pascal26-o3a
	$(TESTTMP)/pascal26-o3a -O3 $(COMPILER_SRC) $(TESTTMP)/pascal26-o3b.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o3b.$$$$.tmp $(TESTTMP)/pascal26-o3b
	$(TESTTMP)/pascal26-o3b -O3 $(COMPILER_SRC) $(TESTTMP)/pascal26-o3c.$$$$.tmp && mv -f $(TESTTMP)/pascal26-o3c.$$$$.tmp $(TESTTMP)/pascal26-o3c
	cmp $(TESTTMP)/pascal26-o3b $(TESTTMP)/pascal26-o3c
...
stabilize: test
	...
	$(TESTTMP)/pascal26-fixedpoint $(PXXFLAGS) $(COMPILER_SRC) $(TESTTMP)/pascal26-s4.$$$$.tmp && mv -f $(TESTTMP)/pascal26-s4.$$$$.tmp $(TESTTMP)/pascal26-s4
	cmp $(TESTTMP)/pascal26-next $(TESTTMP)/pascal26-s4
	$(TESTTMP)/pascal26-s4 $(PXXFLAGS) $(COMPILER_SRC) $(TESTTMP)/pascal26-s5.$$$$.tmp && mv -f $(TESTTMP)/pascal26-s5.$$$$.tmp $(TESTTMP)/pascal26-s5
	cmp $(TESTTMP)/pascal26-next $(TESTTMP)/pascal26-s5
	$(MAKE) stabilize-record
...
stabilize-record:
	...
	@NV=$$(( $$(cat $(STABLE_DEFAULT_DIR)/VERSION 2>/dev/null || echo 0) + 1 )); \
	 ...
	 cp $(TESTTMP)/pascal26-s5 $(STABLE_DEFAULT_DIR)/stable_latest; \
...
stabilize-managed: test-managed
	...
	@NV=$$(( $$(cat $(STABLE_MANAGED_DIR)/VERSION 2>/dev/null || echo 0) + 1 )); \
	 ...
	 cp $(TESTTMP)/pascal26-s5 $(STABLE_MANAGED_DIR)/v$$NV; \
...
selfcheck: check-stable
	...
	$(PXX_STABLE) $(COMPILER_SRC) $(TESTTMP)/pxx-sc-g1
	$(TESTTMP)/pxx-sc-g1 $(COMPILER_SRC) $(TESTTMP)/pxx-sc-g2
	$(TESTTMP)/pxx-sc-g2 $(COMPILER_SRC) $(TESTTMP)/pxx-sc-g3
...
lib-test: pxx-stable-check
	...
	$(PXX_STABLE) test/test_math.pas $(TESTTMP)/lib_math
	$(TESTTMP)/lib_math >/dev/null
	...
	@if command -v python3 >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/lib_nilsh_cpy.txt $(TESTTMP)/lib_nilsh_pxx.txt >/dev/null \
	    && echo "  lib-test: nilsh output identical to CPython" \
	    || { echo "FAIL: nilsh diverges from CPython"; diff $(TESTTMP)/lib_nilsh_cpy.txt $(TESTTMP)/lib_nilsh_pxx.txt | head -10; exit 1; }; \
...
ifeq ($(wildcard external/synapse),)
	...
	@for arch in i386 arm32 aarch64; do \
	  ...
	  got=$$(strings -a $(TESTTMP)/lib_dynlib_$$arch | grep -m1 "^/lib.*ld-"); \
	  test "$$got" = "$$want" || { echo "dynlib $$arch interpreter: got '$$got' want '$$want'"; exit 1; }; \
	  readelf -d $(TESTTMP)/lib_dynlib_$$arch 2>/dev/null | grep -q "NEEDED.*libc.so.6" || { echo "dynlib $$arch: no NEEDED libc.so.6"; exit 1; }; \
	...
	@if command -v readelf >/dev/null 2>&1; then \
	  for sym in esp_timer_create esp_timer_start_periodic esp_timer_stop esp_timer_delete; do \
	    readelf -sW $(TESTTMP)/lib_esptimer_rv.o | grep -q "UND $$sym" || { echo "esptimer object missing import: $$sym"; exit 1; }; \
	  done; \
	fi
	@if command -v readelf >/dev/null 2>&1; then \
	  echo "=== lib-test: esp32c3 (riscv32) PAL object imports lwIP socket symbols ==="; \
	  $(PXX_STABLE) --target=riscv32 -Fulib/rtl/platform/esp test/lib_platform_esp.pas $(TESTTMP)/lib_esp_rv.o >/dev/null; \
	  for sym in lwip_socket lwip_sendto lwip_recvfrom lwip_poll lwip_getsockopt lwip_getsockname; do \
	    readelf -s $(TESTTMP)/lib_esp_rv.o | grep -q "UND $$sym" || { echo "esp32c3 object missing import: $$sym"; exit 1; }; \
	  done; \
	...
	# cannot. The `warn("no category given")` line is the regression guard
	...
	$(TESTTMP)/cmath_constants
	$(PXX_STABLE) test/cstrings_bsd.c $(TESTTMP)/cstrings_bsd
	$(TESTTMP)/cstrings_bsd
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cstring_batch > $(TESTTMP)/cstring_batch_pxx.txt; \
	  diff $(TESTTMP)/cstring_batch_gcc.txt $(TESTTMP)/cstring_batch_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cerrno_strings > $(TESTTMP)/cerrno_pxx.out 2> $(TESTTMP)/cerrno_pxx.err; \
	  diff $(TESTTMP)/cerrno_gcc.out $(TESTTMP)/cerrno_pxx.out && \
	  diff $(TESTTMP)/cerrno_gcc.err $(TESTTMP)/cerrno_pxx.err || \
	...
	@if command -v readelf >/dev/null 2>&1; then \
	  n=$$(readelf -d $(TESTTMP)/cerrno_strings 2>/dev/null | grep -c NEEDED); \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/chf_gcc.out $(TESTTMP)/chf_pxx.out || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/cposix_io_gcc.out $(TESTTMP)/cposix_io_pxx.out || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/csb3_gcc.out $(TESTTMP)/csb3_pxx.out || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/cwctype_gcc.out $(TESTTMP)/cwctype_pxx.out || \
	...
	@if command -v readelf >/dev/null 2>&1; then \
	  n=$$(readelf -d $(TESTTMP)/cwctype 2>/dev/null | grep -c NEEDED); \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cstrtol_range > $(TESTTMP)/cstrtol_pxx.txt; \
	  diff $(TESTTMP)/cstrtol_gcc.txt $(TESTTMP)/cstrtol_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cscanf_math > $(TESTTMP)/csm_pxx.txt 2>&1; \
	  diff $(TESTTMP)/csm_gcc.txt $(TESTTMP)/csm_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/cdup_gcc.txt $(TESTTMP)/cdup_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  (cd $(TESTTMP) && $(TESTTMP)/cfileops) > $(TESTTMP)/cfo_pxx.txt 2>&1; \
	  diff $(TESTTMP)/cfo_gcc.txt $(TESTTMP)/cfo_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cstat_fields > $(TESTTMP)/csf_pxx.txt 2>&1; \
	  diff $(TESTTMP)/csf_gcc.txt $(TESTTMP)/csf_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/cproc_ids > $(TESTTMP)/cpi_pxx.txt 2>&1; \
	  diff $(TESTTMP)/cpi_gcc.txt $(TESTTMP)/cpi_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  diff $(TESTTMP)/cia_gcc.txt $(TESTTMP)/cia_pxx.txt || \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  if diff $(TESTTMP)/crtl_libc_gcc.txt $(TESTTMP)/crtl_libc_pxx.txt >/dev/null; then \
	...
	@if command -v gcc >/dev/null 2>&1; then \
	  ...
	  if diff $(TESTTMP)/crtl_setjmp_g.txt $(TESTTMP)/crtl_setjmp_p.txt >/dev/null; then \
	...
	@if command -v python3 >/dev/null 2>&1; then \
	  ...
	  $(TESTTMP)/lib_pyexec > $(TESTTMP)/lib_pyexec_pxx.txt; \
	  if diff $(TESTTMP)/lib_pyexec_cpython.txt $(TESTTMP)/lib_pyexec_pxx.txt >/dev/null; then \
	    echo "  pyexec: ok (byte-identical to CPython)"; \
	  else \
	    echo "  pyexec: FAIL (diverges from CPython)"; \
	    diff $(TESTTMP)/lib_pyexec_cpython.txt $(TESTTMP)/lib_pyexec_pxx.txt; exit 1; \
	  fi; \
