...
| urgent (0) | working (0) | backlog (29) | blocked (2) | done (4) | rejected (0) |
| --- | --- | --- | --- | --- | --- |
|  |  | bug-c-packed-aligned-ignored | bug-nonreproducible-miscompile-2026-06-02 | bug-operator-result-inferred-var |  |
|  |  | bug-managed-byref-string-param-store | bug-whole-record-copy-main-body-noop | bug-read-preserves-line-remainder |  |
|  |  | bug-record-byvalue-arg-truncation |  | feature-progress-check-makefile |  |
|  |  | chore-inc-to-units |  | idea-progress-board-md |  |
