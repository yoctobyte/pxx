...
| urgent (0) | working (1) | backlog (29) | blocked (2) | done (3) | rejected (0) |
| --- | --- | --- | --- | --- | --- |
|  | bug-read-preserves-line-remainder | bug-c-packed-aligned-ignored | bug-nonreproducible-miscompile-2026-06-02 | bug-operator-result-inferred-var |  |
|  |  | bug-managed-byref-string-param-store | bug-whole-record-copy-main-body-noop | feature-progress-check-makefile |  |
|  |  | bug-record-byvalue-arg-truncation |  | idea-progress-board-md |  |
|  |  | chore-inc-to-units |  |  |  |
