...
| urgent (0) | working (0) | backlog (28) | blocked (2) | done (5) | rejected (0) |
| --- | --- | --- | --- | --- | --- |
|  |  | bug-managed-byref-string-param-store | bug-nonreproducible-miscompile-2026-06-02 | bug-c-packed-aligned-ignored |  |
|  |  | bug-record-byvalue-arg-truncation | bug-whole-record-copy-main-body-noop | bug-operator-result-inferred-var |  |
|  |  | chore-inc-to-units |  | bug-read-preserves-line-remainder |  |
|  |  | chore-runtime-emission-size |  | feature-progress-check-makefile |  |
|  |  | feature-additional-cpu-targets |  | idea-progress-board-md |  |
