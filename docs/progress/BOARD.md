...
| urgent (0) | working (1) | backlog (30) | blocked (1) | done (2) | rejected (0) |
| --- | --- | --- | --- | --- | --- |
|  | bug-operator-result-inferred-var | bug-c-packed-aligned-ignored | bug-nonreproducible-miscompile-2026-06-02 | feature-progress-check-makefile |  |
|  |  | bug-managed-byref-string-param-store |  | idea-progress-board-md |  |
