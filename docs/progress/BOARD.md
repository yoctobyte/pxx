...
| urgent (0) | working (0) | backlog (31) | blocked (1) | done (2) | rejected (0) |
| --- | --- | --- | --- | --- | --- |
|  |  | bug-c-packed-aligned-ignored | bug-nonreproducible-miscompile-2026-06-02 | feature-progress-check-makefile |  |
|  |  | bug-managed-byref-string-param-store |  | idea-progress-board-md |  |
|  |  | bug-operator-result-inferred-var |  |  |  |
