...
Read `devdocs/dev/parallel-tracks.md` and `CLAUDE.md` first — they define the track
...
- When you hit a **compiler or language gap** (a missing operator, a parser
  ...
  `devdocs/progress/backlog/` (Claude A picks it up) and pick a different library
