...
| plexus **QUIET 6d21h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `47b8c3285253` | 2026-09-06T08:08:50Z | GREEN (native) | 160.6s | `0142845988d0` RED |
...
**Newest full tier in the fleet: `0142845988d0` on seven, 2026-09-06T07:52:19Z (16m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `0142845988d0` | RED | 16m | — (newest) |
| plexus | `27424c927b65` | RED | 6d21h | 6d21h |
...
- **test-emit-obj#src:test/c_obj_data_import.c** — test/c_obj_data_import.c test/c_obj_data_export.c +3 (seven): bad `0142845988d0`, last good `8a8694ba3ccf`, 10 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d21h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d21h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d21h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d21h): bad `27424c927b65`, 231 commit(s) in range
