...
|------|-------------|------|---------|------|--------------|
| borg | `cf374e381b5d` | 2026-09-14T04:40:09Z | RED (native) | 312.6s | `b44571a727b2` RED |
...
**Newest full tier in the fleet: `b44571a727b2` on borg, 2026-09-14T04:11:16Z (28m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `b44571a727b2` | RED | 28m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `b44571a727b2`, last good `8a33a920c592`, 1 commit(s) in range
