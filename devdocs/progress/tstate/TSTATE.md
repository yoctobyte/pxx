...
|------|-------------|------|---------|------|--------------|
| borg | `f37400a57126` | 2026-09-20T10:21:46Z | GREEN (slow) | 357.2s | `f37400a57126` RED |
...
**Newest full tier in the fleet: `f37400a57126` on borg, 2026-09-20T10:15:38Z (6m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `f37400a57126` | RED | 6m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `b336d1e52d27`, last good `ab5bf4228141`, 1 commit(s) in range
