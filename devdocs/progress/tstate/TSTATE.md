...
| seven | `fa5e9ef55813` | 2026-09-06T08:23:46Z | RED (native) | 160.8s | `0142845988d0` RED |
...
**Newest full tier in the fleet: `0142845988d0` on seven, 2026-09-06T07:52:19Z (31m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `0142845988d0` | RED | 31m | — (newest) |
