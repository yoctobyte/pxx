...
| seven | `4379f2b72c1e` | 2026-09-05T19:23:36Z | GREEN (native) | 154.3s | `c1fe3e414d25` RED |
...
**Newest full tier in the fleet: `c1fe3e414d25` on seven, 2026-09-05T19:14:28Z (9m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `c1fe3e414d25` | RED | 9m | — (newest) |
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d8h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d8h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d8h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d8h): bad `27424c927b65`, 231 commit(s) in range
