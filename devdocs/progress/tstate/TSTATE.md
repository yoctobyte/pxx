...
| plexus | `f4dab5ffeaab` | 2026-08-21T12:46:47Z | RED (native) | 3266.6s | `23becd24b8e5` RED |
...
- **test-core#src:test/test_c_gtk_call.pas** — test/test_c_gtk_call.pas (plexus): bad `ef7f17d45caa`, last good `0531b3b6735a`, 4 commit(s) in range
- **test-core#src:test/test_c_gtk_window.pas** — test/test_c_gtk_window.pas (plexus): bad `ef7f17d45caa`, last good `0531b3b6735a`, 4 commit(s) in range
