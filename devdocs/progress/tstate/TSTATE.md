...
|------|-------------|------|---------|------|--------------|
| borg | `925346238835` | 2026-09-14T13:01:44Z | GREEN (slow) | 100.1s | `925346238835` RED |
...
**Newest full tier in the fleet: `925346238835` on borg, 2026-09-14T12:59:50Z (1m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `925346238835` | RED | 1m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `1fa5bc5e334c`, last good `1892599756ad`, 1 commit(s) in range
