...
|------|-------------|------|---------|------|--------------|
| borg | `482858cda766` | 2026-09-20T12:03:13Z | RED (native) | 345.9s | `9f57f3c18b35` RED |
...
**Newest full tier in the fleet: `9f57f3c18b35` on borg, 2026-09-20T11:12:18Z (50m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `9f57f3c18b35` | RED | 50m | — (newest) |
...
- **size-canary#src:tools/size_canary.py** — tools/size_canary.py (borg): bad `b336d1e52d27`, last good `ab5bf4228141`, 1 commit(s) in range
- **test-core#src:test/test_set_in_64bit_element.pas** — test/test_set_in_64bit_element.pas tools/expect_same.sh +3 (borg): bad `b336d1e52d27`, last good `ab5bf4228141`, 1 commit(s) in range
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `9f57f3c18b35`, last good `f37400a57126`, 2 commit(s) in range
- **test-core#src:test/c_asm_in_inline_body.c@2** — test/c_asm_in_inline_body.c tools/expect_same.sh +2 (borg): bad `482858cda766`, last good `9f57f3c18b35`, 1 commit(s) in range
