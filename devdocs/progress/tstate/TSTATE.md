...
|------|-------------|------|---------|------|--------------|
| borg | `43467dabdb4b` | 2026-09-22T12:49:38Z | RED (native) | 311.7s | `a8b9a3a55094` RED |
...
**Newest full tier in the fleet: `a8b9a3a55094` on borg, 2026-09-22T12:37:02Z (29m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `a8b9a3a55094` | RED | 29m | — (newest) |
...
- **test-riscv32#src:test/cunsigned_semantics_sweep_b138.c@2** — test/cunsigned_semantics_sweep_b138.c tools/run_target.sh +2 (borg): bad `c194231297b1`, last good `3daf4bc16cc1`, 2 commit(s) in range
