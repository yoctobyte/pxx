...
|------|-------------|------|---------|------|--------------|
| borg | `73c733e7e7d4` | 2026-09-15T09:44:35Z | RED (opt) | 1004.3s | `73c733e7e7d4` RED |
...
**Newest full tier in the fleet: `73c733e7e7d4` on borg, 2026-09-15T09:14:21Z (42m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `73c733e7e7d4` | RED | 42m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `db1fd52c96cf`, last good `bd35a383c7c2`, 1 commit(s) in range
- **test-uforth#src:tools/compiler_srchash.sh@7** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint (borg): bad `73c733e7e7d4`, last good `e20e84544949`, 1 commit(s) in range
