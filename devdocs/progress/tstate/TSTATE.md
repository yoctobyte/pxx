...
|------|-------------|------|---------|------|--------------|
| borg | `ab5bf4228141` | 2026-09-20T08:45:15Z | RED (native) | 322.8s | `bd12bfab03e7` RED |
...
**Newest full tier in the fleet: `bd12bfab03e7` on borg, 2026-09-20T08:32:39Z (12m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `bd12bfab03e7` | RED | 12m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `ab5bf4228141`, last good `52c44f85830e`, 1 commit(s) in range
