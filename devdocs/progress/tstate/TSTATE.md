...
|------|-------------|------|---------|------|--------------|
| borg | `7f8188ce5fe5` | 2026-09-16T08:57:32Z | RED (native) | 305.5s | `16b33723f41f` RED |
...
**Newest full tier in the fleet: `16b33723f41f` on borg, 2026-09-16T08:45:42Z (11m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `16b33723f41f` | RED | 11m | — (newest) |
...
- **test-core#src:test/test_a_threadvar_is_a_variable.pas** — test/test_a_threadvar_is_a_variable.pas tools/expect_same.sh +4 (borg): bad `59afeadbceaa`, last good `16b33723f41f`, 2 commit(s) in range
