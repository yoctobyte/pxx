...
|------|-------------|------|---------|------|--------------|
| borg | `32a0a421a292` | 2026-09-15T01:41:18Z | RED (opt) | 1025.0s | `32a0a421a292` RED |
...
**Newest full tier in the fleet: `32a0a421a292` on borg, 2026-09-15T01:22:00Z (19m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `32a0a421a292` | RED | 19m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `32a0a421a292`, last good `e977f78c3199`, 1 commit(s) in range
