...
|------|-------------|------|---------|------|--------------|
| borg | `df19c8d95807` | 2026-09-20T13:21:45Z | RED (full) | 1034.0s | `df19c8d95807` RED |
...
**Newest full tier in the fleet: `df19c8d95807` on borg, 2026-09-20T13:21:45Z (0m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `df19c8d95807` | RED | 0m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `df19c8d95807`, last good `751ab922ebf8`, 3 commit(s) in range
