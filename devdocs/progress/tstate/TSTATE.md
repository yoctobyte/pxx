...
|------|-------------|------|---------|------|--------------|
| borg | `f40ffd630c3d` | 2026-09-15T13:35:08Z | RED (native) | 294.6s | `1416e94114df` RED |
...
**Newest full tier in the fleet: `1416e94114df` on borg, 2026-09-15T13:09:58Z (25m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `1416e94114df` | RED | 25m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `f40ffd630c3d`, last good `1416e94114df`, 1 commit(s) in range
