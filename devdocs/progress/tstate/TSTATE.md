...
| plexus **QUIET 6d10h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `bdc52828a93b` | 2026-09-05T21:09:14Z | GREEN (native) | 156.5s | `1b75dc88dbc7` RED |
...
**Newest full tier in the fleet: `1b75dc88dbc7` on seven, 2026-09-05T20:49:32Z (19m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `1b75dc88dbc7` | RED | 19m | — (newest) |
| plexus | `27424c927b65` | RED | 6d10h | 6d10h |
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d10h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d10h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d10h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d10h): bad `27424c927b65`, 231 commit(s) in range
