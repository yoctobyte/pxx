...
|------|-------------|------|---------|------|--------------|
| borg | `54c8d8285938` | 2026-09-13T03:54:08Z | RED (native) | 291.9s | `a56bd7985f8c` RED |
...
**Newest full tier in the fleet: `a56bd7985f8c` on borg, 2026-09-13T03:31:29Z (22m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `a56bd7985f8c` | RED | 22m | — (newest) |
...
- **test-threads#src:test/test_a_threadvar_is_per_thread.pas** — test/test_a_threadvar_is_per_thread.pas tools/expect_same.sh (borg): bad `54c8d8285938`, last good `647c3cbdbfb0`, 1 commit(s) in range
