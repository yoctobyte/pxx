...
|------|-------------|------|---------|------|--------------|
| borg | `165473bf9e30` | 2026-09-19T13:07:36Z | RED (full) | 1008.6s | `165473bf9e30` RED |
...
**Newest full tier in the fleet: `165473bf9e30` on borg, 2026-09-19T13:07:36Z (0m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `165473bf9e30` | RED | 0m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `361c03dc6ded`, last good `e8a98c976991`, 4 commit(s) in range
- **test-threads#src:test/test_tls_base.pas** — test/test_tls_base.pas tools/expect_same.sh (borg): bad `165473bf9e30`, last good `f648c28e35e2`, 5 commit(s) in range
