...
| seven | `0dd59f05cc3a` | 2026-09-06T15:04:20Z | RED (native) | 175.3s | `851f170cb454` RED |
...
**Newest full tier in the fleet: `851f170cb454` on seven, 2026-09-06T14:46:29Z (17m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `851f170cb454` | RED | 17m | — (newest) |
...
- **test-threads#src:test/test_critsec_once.pas** — test/test_critsec_once.pas tools/expect_same.sh (seven): bad `0dd59f05cc3a`, last good `5a08811f33bc`, 1 commit(s) in range
- **test-threads#src:test/test_parallel_for_private.pas** — test/test_parallel_for_private.pas tools/expect_same.sh +1 (seven): bad `0dd59f05cc3a`, last good `5a08811f33bc`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 7d4h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 7d4h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 7d4h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 7d4h): bad `27424c927b65`, 231 commit(s) in range
