...
|------|-------------|------|---------|------|--------------|
| borg | `ac21aca7700c` | 2026-09-14T01:50:01Z | RED (native) | 288.2s | `369f962af9e5` RED |
...
**Newest full tier in the fleet: `369f962af9e5` on borg, 2026-09-14T01:42:14Z (7m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `369f962af9e5` | RED | 7m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `ac21aca7700c`, last good `369f962af9e5`, 1 commit(s) in range
