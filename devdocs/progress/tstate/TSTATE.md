...
| seven | `8b51c42331fd` | 2026-09-06T18:23:22Z | GREEN (native) | 170.8s | `c69b52b6ea35` RED |
...
**Newest full tier in the fleet: `c69b52b6ea35` on seven, 2026-09-06T18:02:17Z (21m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `c69b52b6ea35` | RED | 21m | — (newest) |
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 7d7h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 7d7h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 7d7h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 7d7h): bad `27424c927b65`, 231 commit(s) in range
