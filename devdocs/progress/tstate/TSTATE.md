...
| plexus **QUIET 3d2h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `5be4c0665c1e` | 2026-09-02T12:32:08Z | RED (full) | 658.1s | `5be4c0665c1e` RED |
...
**Newest full tier in the fleet: `5be4c0665c1e` on seven, 2026-09-02T12:32:08Z (0m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `5be4c0665c1e` | RED | 0m | — (newest) |
| plexus | `27424c927b65` | RED | 3d2h | 3d2h |
...
- **test-core#src:test/test_anonymous_enum_and_subrange_types.pas** — test/test_anonymous_enum_and_subrange_types.pas tools/expect_same.sh (seven): bad `5be4c0665c1e`, last good `adb676557642`, 1 commit(s) in range
- **test-core#src:test/test_typeinfo_typedata.pas** — test/test_typeinfo_typedata.pas tools/expect_same.sh (seven): bad `5be4c0665c1e`, last good `adb676557642`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 3d2h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 3d2h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 3d2h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 3d2h): bad `27424c927b65`, 231 commit(s) in range
