...
| plexus **QUIET 2d23h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `bb524e1abd1f` | 2026-09-02T10:22:28Z | GREEN (native) | 187.0s | `cb6ea0dc9d9e` RED |
...
**Newest full tier in the fleet: `cb6ea0dc9d9e` on seven, 2026-09-02T09:37:21Z (45m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `cb6ea0dc9d9e` | RED | 45m | — (newest) |
| plexus | `27424c927b65` | RED | 2d23h | 2d23h |
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 2d23h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 2d23h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 2d23h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 2d23h): bad `27424c927b65`, 231 commit(s) in range
