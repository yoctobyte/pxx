...
|------|-------------|------|---------|------|--------------|
| borg | `aed71652fcd5` | 2026-09-20T17:13:57Z | RED (native) | 331.2s | `606d79c053ff` RED |
...
**Newest full tier in the fleet: `606d79c053ff` on borg, 2026-09-20T16:16:02Z (57m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `606d79c053ff` | RED | 57m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `aed71652fcd5`, last good `606d79c053ff`, 1 commit(s) in range
