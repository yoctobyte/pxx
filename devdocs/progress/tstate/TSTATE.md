...
| plexus **QUIET 3d3h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `dc018685fd56` | 2026-09-02T14:12:44Z | GREEN (opt) | 336.7s | `dc018685fd56` RED |
...
**Newest full tier in the fleet: `dc018685fd56` on seven, 2026-09-02T14:02:40Z (10m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `dc018685fd56` | RED | 10m | — (newest) |
| plexus | `27424c927b65` | RED | 3d3h | 3d3h |
...
- **test-threads#src:test/test_nilpy_thread_clone.npy** — test/test_nilpy_thread_clone.npy tools/expect_same.sh +2 (seven): bad `dc018685fd56`, last good `6f6ec7b36e0f`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 3d3h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 3d3h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 3d3h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 3d3h): bad `27424c927b65`, 231 commit(s) in range
