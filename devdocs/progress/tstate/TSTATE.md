...
| seven | `a24a521145b0` | 2026-09-03T09:00:48Z | RED (native) | 186.4s | `cd694bdc4de9` RED |
...
**Newest full tier in the fleet: `cd694bdc4de9` on seven, 2026-09-03T08:56:37Z (4m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `cd694bdc4de9` | RED | 4m | — (newest) |
...
- **test-threads#src:test/test_nilpy_thread_clone.npy** — test/test_nilpy_thread_clone.npy tools/expect_same.sh +2 (seven): bad `a24a521145b0`, last good `cd694bdc4de9`, 2 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 3d22h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 3d22h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 3d22h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 3d22h): bad `27424c927b65`, 231 commit(s) in range
