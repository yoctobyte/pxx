...
|------|-------------|------|---------|------|--------------|
| borg | `accb99f3c59b` | 2026-09-14T07:48:38Z | RED (native) | 298.1s | `ee441baba852` RED |
...
**Newest full tier in the fleet: `ee441baba852` on borg, 2026-09-14T06:31:32Z (1h ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `ee441baba852` | RED | 1h | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `ee441baba852`, last good `cf374e381b5d`, 1 commit(s) in range
- **test-uforth#src:tools/compiler_srchash.sh@3** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint (borg): bad `ee441baba852`, last good `cf374e381b5d`, 1 commit(s) in range
- **test-uforth#src:tools/compiler_srchash.sh@7** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint (borg): bad `ee441baba852`, last good `cf374e381b5d`, 1 commit(s) in range
- **test-core#src:test/c_asm_in_inline_body.c@2** — test/c_asm_in_inline_body.c tools/expect_same.sh +2 (borg): bad `accb99f3c59b`, last good `ee441baba852`, 1 commit(s) in range
