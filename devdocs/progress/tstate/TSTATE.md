...
|------|-------------|------|---------|------|--------------|
| borg | `f2bcb5ecb43b` | 2026-09-20T13:45:34Z | RED (full) | 1036.3s | `f2bcb5ecb43b` RED |
...
**Newest full tier in the fleet: `f2bcb5ecb43b` on borg, 2026-09-20T13:45:34Z (0m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `f2bcb5ecb43b` | RED | 0m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `f2bcb5ecb43b`, last good `df19c8d95807`, 1 commit(s) in range
