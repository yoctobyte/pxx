...
| plexus **QUIET 6d18h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `7e5a0470a6b2` | 2026-09-06T04:48:54Z | RED (full) | 559.7s | `7e5a0470a6b2` RED |
...
**Newest full tier in the fleet: `7e5a0470a6b2` on seven, 2026-09-06T04:48:54Z (0m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `7e5a0470a6b2` | RED | 0m | — (newest) |
| plexus | `27424c927b65` | RED | 6d18h | 6d18h |
...
- **test-debug-g#src:tools/compiler_srchash.sh** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint +1 (seven): bad `7e5a0470a6b2`, last good `147b8a2ac642`, 2 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d18h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d18h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d18h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d18h): bad `27424c927b65`, 231 commit(s) in range
