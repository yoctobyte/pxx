...
| plexus **QUIET 3d20h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `c23dcf1cfd42` | 2026-09-03T07:03:14Z | RED (native) | 186.0s | `7979c98bc7f3` RED |
...
**Newest full tier in the fleet: `7979c98bc7f3` on seven, 2026-09-03T06:59:06Z (4m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `7979c98bc7f3` | RED | 4m | — (newest) |
| plexus | `27424c927b65` | RED | 3d20h | 3d20h |
...
- **test-threads#src:test/test_nilpy_thread_clone.npy** — test/test_nilpy_thread_clone.npy tools/expect_same.sh +2 (seven): bad `c23dcf1cfd42`, last good `7979c98bc7f3`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 3d20h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 3d20h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 3d20h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 3d20h): bad `27424c927b65`, 231 commit(s) in range
