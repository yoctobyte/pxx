...
|------|-------------|------|---------|------|--------------|
| borg | `bd12bfab03e7` | 2026-09-20T08:15:10Z | RED (native) | 333.8s | `2723029f4125` RED |
...
**Newest full tier in the fleet: `2723029f4125` on borg, 2026-09-20T08:08:43Z (6m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `2723029f4125` | RED | 6m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `bd12bfab03e7`, last good `2723029f4125`, 2 commit(s) in range
