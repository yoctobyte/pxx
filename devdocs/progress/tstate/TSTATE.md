...
|------|-------------|------|---------|------|--------------|
| borg | `7fb6a46c346f` | 2026-09-20T13:58:13Z | RED (native) | 326.5s | `f2bcb5ecb43b` RED |
...
**Newest full tier in the fleet: `f2bcb5ecb43b` on borg, 2026-09-20T13:45:34Z (12m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `f2bcb5ecb43b` | RED | 12m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `7fb6a46c346f`, last good `fae99f4a70b1`, 1 commit(s) in range
