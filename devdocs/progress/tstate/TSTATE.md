...
|------|-------------|------|---------|------|--------------|
| borg | `2846fcdd3e2c` | 2026-09-25T15:58:32Z | RED (native) | 381.4s | `5580f0d587d6` RED |
...
**Newest full tier in the fleet: `5580f0d587d6` on borg, 2026-09-25T14:57:38Z (1h ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `5580f0d587d6` | RED | 1h | — (newest) |
