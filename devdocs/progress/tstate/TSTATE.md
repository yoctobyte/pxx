...
| seven | `adb676557642` | 2026-09-02T12:05:19Z | RED (native) | 187.8s | `a0f86c00485b` RED |
...
**Newest full tier in the fleet: `a0f86c00485b` on seven, 2026-09-02T11:57:19Z (8m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `a0f86c00485b` | RED | 8m | — (newest) |
