...
|------|-------------|------|---------|------|--------------|
| borg | `bd35a383c7c2` | 2026-09-15T07:35:33Z | RED (native) | 306.9s | `03975f44d5d4` RED |
...
**Newest full tier in the fleet: `03975f44d5d4` on borg, 2026-09-15T06:55:08Z (40m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `03975f44d5d4` | RED | 40m | — (newest) |
...
- **CASCADE 14 jobs** (borg): bad `827fabcc7d6d`, last good `f7a745e876ef`, 1 commit(s) in range
...
- **test-threads#src:test/test_tls_base.pas** — test/test_tls_base.pas tools/expect_same.sh (borg): bad `bd35a383c7c2`, last good `03975f44d5d4`, 1 commit(s) in range
