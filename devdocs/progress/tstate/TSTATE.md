...
| seven | `918842a5fd43` | 2026-09-06T12:52:23Z | RED (native) | 170.9s | `12af8ef60bfd` RED |
...
**Newest full tier in the fleet: `12af8ef60bfd` on seven, 2026-09-06T12:48:13Z (4m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `12af8ef60bfd` | RED | 4m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_class_finalize_race.pas** — test/test_threadsafe_class_finalize_race.pas tools/expect_same.sh (seven): bad `918842a5fd43`, last good `12af8ef60bfd`, 3 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 7d2h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 7d2h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 7d2h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 7d2h): bad `27424c927b65`, 231 commit(s) in range
