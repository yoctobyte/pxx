...
| plexus **QUIET 2d22h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `fcc167699a7c` | 2026-09-02T08:52:04Z | GREEN (native) | 184.5s | `14c46b53c617` RED |
...
**Newest full tier in the fleet: `14c46b53c617` on seven, 2026-09-02T08:47:58Z (4m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `14c46b53c617` | RED | 4m | — (newest) |
| plexus | `27424c927b65` | RED | 2d22h | 2d22h |
...
- **test-sqlite-threads-aarch64#src:tools/compiler_srchash.sh** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint +1 (seven): bad `14c46b53c617`, last good `d3fac441ff4d`, 3 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 2d22h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 2d22h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 2d22h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 2d22h): bad `27424c927b65`, 231 commit(s) in range
