...
|------|-------------|------|---------|------|--------------|
| borg | `2ee0eae8e102` | 2026-09-13T04:30:26Z | RED (native) | 299.8s | `54c8d8285938` RED |
...
**Newest full tier in the fleet: `54c8d8285938` on borg, 2026-09-13T04:09:06Z (21m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `54c8d8285938` | RED | 21m | — (newest) |
...
- **test-threads#src:test/test_a_threadvar_is_per_thread.pas** — test/test_a_threadvar_is_per_thread.pas tools/expect_same.sh (borg): bad `2ee0eae8e102`, last good `54c8d8285938`, 1 commit(s) in range
