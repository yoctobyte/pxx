...
| plexus **QUIET 6d12h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `6102e6d61cbf` | 2026-09-05T22:46:28Z | RED (native) | 155.2s | `b30c373b6cfb` RED |
...
**Newest full tier in the fleet: `b30c373b6cfb` on seven, 2026-09-05T22:34:42Z (11m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `b30c373b6cfb` | RED | 11m | — (newest) |
| plexus | `27424c927b65` | RED | 6d12h | 6d12h |
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d12h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d12h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d12h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d12h): bad `27424c927b65`, 231 commit(s) in range
