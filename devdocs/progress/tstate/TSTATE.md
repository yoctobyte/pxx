...
| plexus **QUIET 7d3h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `d68ed2fe803c` | 2026-09-06T13:44:28Z | RED (native) | 165.1s | `bb18f83c859e` RED |
...
**Newest full tier in the fleet: `bb18f83c859e` on seven, 2026-09-06T13:32:07Z (12m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `bb18f83c859e` | RED | 12m | — (newest) |
| plexus | `27424c927b65` | RED | 7d3h | 7d3h |
...
- **test-pascal-conformance#shard4/6** — tools/run_pascal_conformance.sh (seven): bad `e678b743d3bb`, last good `918842a5fd43`, 2 commit(s) in range
- **test-core#src:test/test_nd_subarray_as_param.pas** — test/test_nd_subarray_as_param.pas tools/expect_same.sh +2 (seven): bad `0aff068c6d08`, last good `bb18f83c859e`, 2 commit(s) in range
...
- **fpc-bootstrap#src:compiler/compiler.pas** — compiler/compiler.pas (seven): bad `d68ed2fe803c`, last good `b3f70093e7d8`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 7d3h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 7d3h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 7d3h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 7d3h): bad `27424c927b65`, 231 commit(s) in range
