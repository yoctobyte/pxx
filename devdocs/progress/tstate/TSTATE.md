...
| plexus **QUIET 2d7h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `d44435dec2ca` | 2026-09-01T18:13:59Z | RED (native) | 106.7s | `d17c4c4a3676` RED |
...
**Newest full tier in the fleet: `d17c4c4a3676` on seven, 2026-09-01T18:08:50Z (5m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `d17c4c4a3676` | RED | 5m | — (newest) |
| plexus | `27424c927b65` | RED | 2d7h | 2d7h |
...
- **test-core#src:test/test_exception_unhandled.pas@3** — test/test_exception_unhandled.pas compiler/compiler.pas +11 (seven): bad `d44435dec2ca`, last good `02de90b979c3`, 1 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 2d7h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 2d7h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 2d7h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 2d7h): bad `27424c927b65`, 231 commit(s) in range
