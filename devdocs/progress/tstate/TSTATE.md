...
|------|-------------|------|---------|------|--------------|
| borg | `8a33a920c592` | 2026-09-14T03:34:26Z | RED (native) | 309.6s | `8eec0021138c` RED |
...
**Newest full tier in the fleet: `8eec0021138c` on borg, 2026-09-14T03:07:26Z (27m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| borg | `8eec0021138c` | RED | 27m | — (newest) |
...
- **test-threads#src:test/test_threadsafe_heap_lock_deadlock_diag.pas** — test/test_threadsafe_heap_lock_deadlock_diag.pas tools/expect_same.sh (borg): bad `8a33a920c592`, last good `8eec0021138c`, 1 commit(s) in range
