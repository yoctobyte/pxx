...
| plexus **QUIET 2d21h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `8dcf6ae133af` | 2026-09-02T07:31:27Z | GREEN (native) | 183.6s | `ba2a1871de4c` RED |
...
**Newest full tier in the fleet: `ba2a1871de4c` on seven, 2026-09-02T07:25:01Z (6m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `ba2a1871de4c` | RED | 6m | — (newest) |
| plexus | `27424c927b65` | RED | 2d21h | 2d21h |
...
- **test-sqlite-threads-aarch64#src:tools/compiler_srchash.sh** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint +1 (seven): bad `ba2a1871de4c`, last good `9037ea5d8471`, 2 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 2d21h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 2d21h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 2d21h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 2d21h): bad `27424c927b65`, 231 commit(s) in range
