...
- **fpc-bootstrap#src:compiler/compiler.pas** — compiler/compiler.pas (seven): bad `c40dcc092493`, last good `4be27a5c7d0d`, 6 commit(s) in range
- **test-core#src:test/test_object_reference.pas** — test/test_object_reference.pas tools/expect_same.sh +1 (seven): bad `f9bfcca97409`, last good `8fbee6e13141`, 6 commit(s) in range
