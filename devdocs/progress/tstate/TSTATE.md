...
| seven | `ef03a6282980` | 2026-09-06T00:42:45Z | GREEN (native) | 156.0s | `3b13f585f5f4` RED |
...
**Newest full tier in the fleet: `3b13f585f5f4` on seven, 2026-09-06T00:21:24Z (21m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `3b13f585f5f4` | RED | 21m | — (newest) |
| plexus | `27424c927b65` | RED | 6d14h | 6d13h |
...
- **test-fgl#src:tools/compiler_srchash.sh** — tools/compiler_srchash.sh compiler/.pascal26.fixedpoint +1 (seven): bad `3b13f585f5f4`, last good `5daad03f50d7`, 5 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 6d14h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 6d14h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 6d14h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 6d14h): bad `27424c927b65`, 231 commit(s) in range
