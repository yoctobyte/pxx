...
| plexus **QUIET 7d1h** | `27424c927b65` | 2026-08-30T10:24:09Z | RED (full) | 1370.0s | `27424c927b65` RED |
| seven | `886bfe597d69` | 2026-09-06T11:24:33Z | RED (native) | 166.1s | `847091ba8c13` RED |
...
**Newest full tier in the fleet: `847091ba8c13` on seven, 2026-09-06T11:15:38Z (8m ago).**

| host | full through | verdict | age | behind the newest by |
|------|--------------|---------|-----|----------------------|
| seven | `847091ba8c13` | RED | 8m | — (newest) |
| plexus | `27424c927b65` | RED | 7d1h | 7d0h |
...
- **test-core#src:test/test_a_named_dynamic_array_parameter_still_takes_nil_as_a_default.pas** — test/test_a_named_dynamic_array_parameter_still_takes_nil_as_a_default.pas tools/expect_same.sh (seven): bad `fc43936b00d9`, last good `847091ba8c13`, 4 commit(s) in range
...
- **test-pascal-conformance#shard0/6** (plexus, quiet 7d1h): bad `e46dbffaa80d`, 217 commit(s) in range
- **test-asm#src:test/test_asm_emit_rv32.pas** (plexus, quiet 7d1h): bad `27424c927b65`, 88 commit(s) in range
- **test-core#src:test/test_opt_store_reload.pas** (plexus, quiet 7d1h): bad `27424c927b65`, 88 commit(s) in range
- **test-pascal-conformance#shard1/6** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard2/6** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard3/6** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard4/6** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
- **test-pascal-conformance#shard5/6** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
- **tools-devtest#00** (plexus, quiet 7d1h): bad `27424c927b65`, 231 commit(s) in range
