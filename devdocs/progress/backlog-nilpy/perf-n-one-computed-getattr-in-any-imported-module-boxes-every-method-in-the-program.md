...
Either a measured run-time cost small enough to close it as chosen — in which
case say so and record the number — or a narrowing that keeps both fixtures
passing. **Both fixtures must pass: they are the only thing standing between
