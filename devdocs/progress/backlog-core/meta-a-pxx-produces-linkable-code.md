...
owner: ""
blocked-by: [bug-a-a-pascal-global-cannot-import-a-c-global, feature-a-every-emit-obj-object-links-its-own-full-copy-of-crtl-so-n-objects-cost-n-runtimes, bug-a-the-esp-object-writer-exports-only-app-main-so-no-cdecl-routine-or-global-is-linkable]
