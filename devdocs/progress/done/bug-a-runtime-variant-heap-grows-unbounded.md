...
- 2026-08-03 — stray duplicate of this ticket removed from `backlog/`: it held
  only the verification section above and was re-surfacing an already-resolved
  ticket at the top of Track A's ready queue.
