...
## Log
- 2026-08-15 — auto-closed by the plexus watcher: `test-asm#src:test/hello.pas` passes at d61380078f35 (tier native); it was red at d2172550a236. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
