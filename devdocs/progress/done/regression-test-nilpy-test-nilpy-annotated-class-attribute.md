...
> **Track guessed as N from the FAILING STEP** — line 2 of 2, `/tmp/test_nilpy_annotated_class_attribute26 | diff -u test/test_nilpy_annotated_class_attribute.expected -`, which names `test/test_nilpy_annotated_class_attribute.expected`. Not from the job's name or its `src`: those describe what the job is ABOUT, and this job's recipe spans 2 source file(s). The ranker reads frontmatter, so this line — not the body — decides who works it; correct it if the guess is wrong.

> **origin/master has advanced 4 commit(s) since this sha.** Re-verify at current HEAD before acting — the callback is tagged to the sha that was tested, which may no longer be the state of the tree.

# regression: test-nilpy#src:test/test_nilpy_annotated_class_attribute.npy at 67f0878f2e59 in step 2/2, `/tmp/test_nilpy_annotated_class_attribute26 | diff -u test/test_nilpy_annotated_class_attribute.expected -` (auto-filed by twatch)

- **Type:** regression (auto-filed by Track T watcher, host borg, twatch `1d5c476a6328`).
  Untriaged.
- **Found:** 2026-09-16T02:10:51Z
- **Test source:** test/test_nilpy_annotated_class_attribute.npy test/test_nilpy_annotated_class_attribute.expected
- **Failing step:** line 2 of 2 of the job's recipe; it names `test/test_nilpy_annotated_class_attribute.expected`.
  ```
  /tmp/test_nilpy_annotated_class_attribute26 | diff -u test/test_nilpy_annotated_class_attribute.expected -
  ```

## Repro
`tools/testmgr.py --tier full --job 'test-nilpy#src:test/test_nilpy_annotated_class_attribute.npy'` at 67f0878f2e594f042e00005391b213922d8f1047
...
(tail)
ok: /tmp/testmgr-scratch-4094684/test_nilpy_annotated_class_attribute26  [code=1355544B  data=90120B  bss=55284B  procs=2196]
Segmentation fault (core dumped)
--- test/test_nilpy_annotated_class_attribute.expected	2026-09-11 21:30:21.991071347 +0200
+++ -	2026-09-16 04:05:11.266345300 +0200
@@ -2,6 +2,3 @@
 5
 []
 {}
...
## Log
- 2026-09-16 — auto-closed by the borg watcher: `test-nilpy#src:test/test_nilpy_annotated_class_attribute.npy` passes at 881fdee59b6f (tier full); it was red at 67f0878f2e59. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
