...
# regression: lib-test#src:test/lib_synapse_ssl.pas at 889bfcf73256 in step 1/3, `stable_linux_amd64/default/pinned --mimic-fpc -dPXX_DYNLIB_LIBC -Fuexternal/synapse -Fulib/rtl -Fulib/rtl/platform/posi…` (auto-filed by twatch)
...
- **Failing step:** line 1 of 3 of the job's recipe; it names `test/lib_synapse_ssl.pas`.
  ```
...
## Repro
`tools/testmgr.py --tier full --job 'lib-test#src:test/lib_synapse_ssl.pas'` at 889bfcf7325633e2c400c82877a9ceef69a48800
