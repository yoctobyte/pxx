...
# regression: test-core#src:test/test_nilpy_c_pointer.npy red at 67015a8cf7d8 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier native --job 'test-core#src:test/test_nilpy_c_pointer.npy'` at 67015a8cf7d83b33d76eb9867abe59d78f27f6a9
...
## Log tail
```
pascal26:7: error: import: no unit named stdlib and no shim mimic_stdlib
(tail)
pascal26:7: error: import: no unit named stdlib and no shim mimic_stdlib
  near:  stdlib >>>  p  
