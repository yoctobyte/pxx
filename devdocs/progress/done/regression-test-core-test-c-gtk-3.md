...
# regression: test-core#src:test/test_c_gtk.pas at 7867c5481c01 in step 1/2, `./compiler/pascal26 test/test_c_gtk.pas /tmp/test_c_gtk26` (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier native --job 'test-core#src:test/test_c_gtk.pas'` at 7867c5481c0126cd79daa92c74114b8dd3fc6ef3
