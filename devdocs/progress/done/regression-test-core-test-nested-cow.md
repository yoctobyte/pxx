...
## Log
- 2026-08-06 — auto-closed by the plexus watcher: `test-core#src:test/test_nested_cow.pas` passes at baa606d36caf (tier native); it was red at 937c51dc220a. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
