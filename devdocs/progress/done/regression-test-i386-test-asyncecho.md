...
# regression: test-i386#src:test/test_asyncecho.pas red at aaa58e72c1e8 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-i386#src:test/test_asyncecho.pas'` at aaa58e72c1e8b7c2a4af9f33d89e4e6ea524027e
...
## Log tail
```
ok: /tmp/testmgr-scratch-458448/test_i386_asyncecho  [code=88687B  data=576B  bss=38404B  procs=262]
