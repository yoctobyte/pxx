...
# regression: test-c-conformance-aarch64#shard5/6 red at b695bcb4b192 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-c-conformance-aarch64#shard5/6'` at b695bcb4b19264847cedc6c01678d4e298d14cfb
...
## Log tail
```
FAIL 00204.c — compile error:
pascal26:111: error: target aarch64: variadic external call with more than 8 arguments not supported
(tail)
self-host fixedpoint: verified — 1 round(s), 82583d52f672 --shard 5/6
FAIL 00174.c — exit code 139 (want 0)
FAIL 00204.c — compile error:
    pascal26:111: error: target aarch64: variadic external call with more than 8 arguments not supported
      near: f  d    >>>  arg  
test-c-conformance-aarch64: 34 pass, 2 fail, 0 skip (of 36)
test-c-conformance-aarch64: FAILURES: 00174.c(exit=139) 00204.c(compile)
...
## Log
- 2026-08-30 — auto-closed by the seven watcher: `test-c-conformance-aarch64#shard5/6` passes at ff0a06d75946 (tier full); it was red at b695bcb4b192. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
