...
# first-ever red: test-emit-obj#shard3/6 at 0a101662f25f in step 1/33, `./compiler/pascal26 --target=xtensa --emit-obj test/c_reaches_crtl_on_the_esp_idf_profile.c /tmp/c_crtl_xt.o --shard 3/6` (auto-filed by twatch)
...
- **Failing step:** line 1 of 33 of the job's recipe; it names `test/c_reaches_crtl_on_the_esp_idf_profile.c`.
  ```
  ./compiler/pascal26 --target=xtensa --emit-obj test/c_reaches_crtl_on_the_esp_idf_profile.c /tmp/c_crtl_xt.o --shard 3/6
  ```

## Repro
`tools/testmgr.py --tier full --job 'test-emit-obj#shard3/6'` at 0a101662f25f2db6213234e9f56b3f16095a71b5
