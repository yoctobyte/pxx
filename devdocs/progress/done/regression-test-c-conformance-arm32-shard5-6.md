...
# regression: test-c-conformance-arm32#shard5/6 red at 96b6bac331d9 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-c-conformance-arm32#shard5/6'` at 96b6bac331d9d8b9c838d0055a8e3841157314f1
...
FAIL 00204.c — output mismatch:
    ...
    +++ /tmp/pxx_c_conformance.217834/out.txt	2026-07-12 19:37:04.289377047 +0200
    @@ -102,58 +102,58 @@
     0
     abcd
     abcd0000
    -abcd00000000
    -abcd000000000000
test-c-conformance-arm32: 35 pass, 1 fail, 0 skip (of 36)
test-c-conformance-arm32: FAILURES: 00204.c(output)
