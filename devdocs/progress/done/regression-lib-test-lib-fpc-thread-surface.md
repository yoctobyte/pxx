...
## Log
- 2026-09-14 — auto-closed by the borg watcher: `lib-test#src:test/lib_fpc_thread_surface.pas` passes at 1eee9b23387b (tier full); it was red at 934ba04180e9. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
