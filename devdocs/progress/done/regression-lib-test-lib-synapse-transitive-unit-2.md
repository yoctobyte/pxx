...
# regression: lib-test#src:test/lib_synapse_transitive_unit.pas at fca28056d8ec in step 1/6, `stable_linux_amd64/default/pinned --mimic-fpc -Fuexternal/synapse -Fulib/rtl -Fulib/rtl/platform/posix test/lib_synapse…` (auto-filed by twatch)
...
- **Failing step:** line 1 of 6 of the job's recipe; it names `test/lib_synapse_transitive_unit.pas`.
  ```
...
## Repro
`tools/testmgr.py --tier full --job 'lib-test#src:test/lib_synapse_transitive_unit.pas'` at fca28056d8ec2483d3a9a1b0f064842164f92b46
