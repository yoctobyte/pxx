...
## Log
- 2026-08-19 — auto-closed by the plexus watcher: `test-core#src:test/test_nilpy_from_import_as_rename.npy` passes at 0b03169106e1 (tier native); it was red at 9bbbbef6c055. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
