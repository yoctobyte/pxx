...
# regression: test-arm32#src:test/test_timer.pas red at aaa58e72c1e8 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-arm32#src:test/test_timer.pas'` at aaa58e72c1e8b7c2a4af9f33d89e4e6ea524027e
...
## Log tail
```
ok: /tmp/testmgr-scratch-458448/test_arm32_timer  [code=173116B  data=416B  bss=38388B  procs=139]
