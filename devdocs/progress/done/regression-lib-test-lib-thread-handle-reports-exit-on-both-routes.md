...
## Log
- 2026-09-14 — auto-closed by the borg watcher: `lib-test#src:test/lib_thread_handle_reports_exit_on_both_routes.pas` passes at 1eee9b23387b (tier full); it was red at 06e40fb95b13. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
