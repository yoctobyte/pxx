...
## Log
- 2026-08-30 — auto-closed by the seven watcher: `test-core#src:test/test_nilpy_str_ascii_cache.npy` passes at e2d1d1e047df (tier native); it was red at dc798834ba33. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
