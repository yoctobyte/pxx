...
## Log
- 2026-09-16 — auto-closed by the borg watcher: `test-nilpy#src:test/test_nilpy_to_bytes.npy` passes at 881fdee59b6f (tier full); it was red at 5dbee723e228. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
