...
## Log
- 2026-09-05 — auto-closed by the seven watcher: `test-core#src:test/test_generator_instance_freed_on_escaping_raise.pas` passes at 2d6bfadd6025 (tier native); it was red at f2c6ff3288b4. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
