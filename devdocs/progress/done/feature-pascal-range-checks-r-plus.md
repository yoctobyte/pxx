...
- **Status:** done
  ...
  Slice 4: SUBRANGE dests DONE (AliasSub*/SymSub* retain lo..hi). Slices 3-6 landed (Char/field/subrange/open-array-param + the param-lo silent bug). Slice 7 (dyn fields) done. REMAINING (thin): subrange dests (needs subrange-bounds metadata — pxx maps
