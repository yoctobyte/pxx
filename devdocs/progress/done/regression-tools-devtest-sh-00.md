...
## Log
- 2026-09-11 — auto-closed by the borg watcher: `tools-devtest-sh#00` passes at 0681a288f054 (tier native); it was red at dbd40ba3c706. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
