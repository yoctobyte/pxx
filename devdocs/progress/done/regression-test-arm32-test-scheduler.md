...
# regression: test-arm32#src:test/test_scheduler.pas red at aaa58e72c1e8 (auto-filed by twatch)

- **Type:** regression (auto-filed by Track T watcher, host borg). Untriaged.
- **Found:** 2026-07-12T18:51:33Z
- **Test source:** test/test_scheduler.pas tools/run_target.sh

## Repro
`tools/testmgr.py --tier full --job 'test-arm32#src:test/test_scheduler.pas'` at aaa58e72c1e8b7c2a4af9f33d89e4e6ea524027e
...
## Log tail
```
ok: /tmp/testmgr-scratch-458448/test_arm32_sched  [code=173688B  data=424B  bss=38388B  procs=140]
ok: /tmp/testmgr-scratch-458448/test_arm32_sched_x64  [code=49751B  data=448B  bss=46708B  procs=104]
