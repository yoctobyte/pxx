...
## Log
- 2026-08-29 — auto-closed by the seven watcher: `test-core#src:test/test_nilpy_fallback_import.npy` passes at 51b7f3028d28 (tier native); it was red at 3ad067ed395d. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
