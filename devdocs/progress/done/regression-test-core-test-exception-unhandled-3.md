...
- 2026-09-02 — CLOSED by claude-T on Track T dispatch. Re-verified at HEAD before diagnosing, per this stub's own banner: `tools/testmgr.py --tier native --job 'test-core#src:test/test_exception_unhandled.pas@3'` at `3e05d2946455` is **GREEN**. The regression is gone from the tree and the job is no longer in seven's `open_regressions`. No code change was needed for this ticket; what it cost was the re-verification.
