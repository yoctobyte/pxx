...
# regression: test-nilpy#src:test/test_cpyext_cython.npy red at 34c41bde6fd6 (auto-filed by twatch)

- **Type:** regression (auto-filed by Track T watcher, host plexus). Untriaged.
- **Found:** 2026-08-05T19:36:23Z
- **Test source:** test/test_cpyext_cython.npy

## Repro
`tools/testmgr.py --tier full --job 'test-nilpy#src:test/test_cpyext_cython.npy'` at 34c41bde6fd66529206b2891337066a5a9fae50c
...
## Log tail
```
pascal26:14: error: uses: unit source not found: /lib/cpyext/src/pyruntime.c
(tail)
pascal26:14: error: uses: unit source not found: /lib/cpyext/src/pyruntime.c
  near:  interface uses pxxcio  ../../lib/cpyext/src/pyruntime.c >>>  ./vendor/cyadd_cython.c  
