...
## Log
- 2026-08-15 — auto-closed by the plexus watcher: `test-core#src:test/test_nilpy_float_pow_oracle.npy` passes at 3b66d2be1f26 (tier native); it was red at c9706630b486. Reopening is by a fresh NEW-RED stub, since a second red is a second finding with its own range.
