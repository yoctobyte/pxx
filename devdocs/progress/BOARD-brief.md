...
`working:20 unfinished:21 blocked:7 backlog:9 backlog-umbrella:7 backlog-core:135 backlog-nilpy:98 backlog-tools:40 backlog-pascal:29 backlog-decide:46 backlog-libs:19 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:146 done:3394 rejected:78`
...
- `[p 70] [P]` bug-p-a-cast-to-a-pointer-to-pointer-drops-the-implicit-second-deref
