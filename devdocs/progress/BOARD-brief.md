...
`working:6 unfinished:28 blocked:7 backlog:9 backlog-umbrella:5 backlog-core:134 backlog-nilpy:97 backlog-tools:71 backlog-pascal:54 backlog-decide:24 backlog-libs:16 backlog-cfront:11 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:2 experimental:20 rainy-day:44 float:24 done-followup:3 decided:144 done:3016 rejected:72`

## Held now (working/ — do not touch these files)

- `bug-a-a-variant-converted-to-ansistring-leaks-whenever-the-result-is-a-temporary` [A] — owner: frankA
