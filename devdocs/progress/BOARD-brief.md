...
`working:27 unfinished:22 blocked:6 backlog:17 backlog-umbrella:9 backlog-core:150 backlog-nilpy:103 backlog-tools:57 backlog-pascal:25 backlog-decide:45 backlog-libs:23 backlog-cfront:13 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:74 known-incompat:4 float:25 done-followup:3 decided:149 done:3589 rejected:79`
...
- `bug-p-a-string-literal-bound-to-a-pwidechar-is-emitted-narrow` [P] — owner: frankZ
