...
`working:4 unfinished:27 blocked:9 backlog:5 backlog-umbrella:5 backlog-core:131 backlog-nilpy:96 backlog-tools:68 backlog-pascal:52 backlog-decide:25 backlog-libs:17 backlog-cfront:9 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:1 experimental:20 rainy-day:44 float:24 done-followup:3 decided:140 done:2988 rejected:72`

## Held now (working/ — do not touch these files)

- `bug-a-c-a-shared-library-never-runs-its-initialisation` [A+C] — owner: frankA
