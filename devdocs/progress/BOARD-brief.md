...
`urgent:1 working:1 unfinished:8 blocked:3 backlog:225 experimental:20 rainy-day:40 done-followup:3 decided:56 done:1646 rejected:35`

## Held now (working/ — do not touch these files)

- `bug-nilpy-a-bare-attribute-on-a-call-result-is-refused` [N] — owner: claude-A
