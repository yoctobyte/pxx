...
`working:7 unfinished:27 blocked:6 backlog:6 backlog-umbrella:6 backlog-core:136 backlog-nilpy:97 backlog-tools:6 backlog-pascal:55 backlog-decide:30 backlog-libs:16 backlog-cfront:20 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:2 experimental:20 rainy-day:44 low-prio:71 known-incompat:2 float:25 done-followup:3 decided:144 done:3132 rejected:72`
...
- `[p 70] [T]` regression-test-core-test-anonymous-enum-and-subrange-types
- `[p 70] [N]` regression-test-core-test-nilpy-c-pointer-2
- `[p 70] [T]` regression-test-core-test-typeinfo-typedata
