...
`urgent:1 working:1 unfinished:10 blocked:3 backlog:211 experimental:20 rainy-day:40 done-followup:3 decided:63 done:1654 rejected:35`

## Held now (working/ — do not touch these files)

- `bug-a-riscv32-and-xtensa-have-no-atomic-codegen` [S] — owner: claude-A
