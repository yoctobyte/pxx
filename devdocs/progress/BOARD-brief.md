...
`working:30 unfinished:21 blocked:6 backlog:26 backlog-umbrella:11 backlog-core:155 backlog-nilpy:118 backlog-tools:55 backlog-pascal:7 backlog-decide:45 backlog-libs:26 backlog-cfront:15 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:75 known-incompat:5 float:25 done-followup:3 decided:150 done:3671 rejected:81`
...
_423 more ready — `tools/progress.sh ready --track X` for a lane's full queue._
