...
`working:1 unfinished:24 blocked:7 backlog:283 backlog_new:28 experimental:20 rainy-day:44 float:21 done-followup:3 decided:115 done:2395 rejected:40`

## Held now (working/ — do not touch these files)

- `perf-a-every-npy-compile-still-rebuilds-the-whole-nilpy-runtime` [A] — owner: agent-A-npytax
