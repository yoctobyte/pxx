...
`working:2 unfinished:31 blocked:7 backlog:382 backlog_new:23 experimental:20 rainy-day:44 float:24 done-followup:3 decided:125 done:2827 rejected:58`

## Held now (working/ — do not touch these files)

- `bug-a-builtin-pas-calls-a-declaration-that-esp-compiles-out` [A+S] — owner: claude-A
