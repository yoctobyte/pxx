...
- `[p 85] [A]` bug-a-a-const-shortstring-parameter-arrives-as-nul-bytes-under-the-byte-prefix-mode
- `[p 85] [A]` bug-a-string-concat-segfaults-on-x86-64-under-the-byte-prefix-mode
- `[p 85] [A]` bug-a-string-ordering-comparison-ignores-content-on-x86-64-under-the-byte-prefix-mode
