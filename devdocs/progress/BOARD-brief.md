...
`working:21 unfinished:22 blocked:6 backlog:13 backlog-umbrella:7 backlog-core:145 backlog-nilpy:99 backlog-tools:48 backlog-pascal:36 backlog-decide:43 backlog-libs:23 backlog-cfront:12 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:149 done:3502 rejected:79`
...
- `[p 70] [N]` regression-test-nilpy-test-nilpy-dotted-package-import-2
