...
`working:22 unfinished:22 blocked:6 backlog:14 backlog-umbrella:8 backlog-core:147 backlog-nilpy:97 backlog-tools:50 backlog-pascal:39 backlog-decide:44 backlog-libs:22 backlog-cfront:11 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:74 known-incompat:4 float:25 done-followup:3 decided:149 done:3521 rejected:79`

## Held now (working/ — do not touch these files)

- `bug-a-a-float-assigned-to-an-integer-lvalue-moves-the-bits-instead-of-converting` [A] — owner: frankwasm
