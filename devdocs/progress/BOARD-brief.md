...
`working:5 unfinished:28 blocked:8 backlog:5 backlog-umbrella:5 backlog-core:133 backlog-nilpy:97 backlog-tools:71 backlog-pascal:53 backlog-decide:22 backlog-libs:17 backlog-cfront:10 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:2 experimental:20 rainy-day:44 float:24 done-followup:3 decided:144 done:3007 rejected:72`

## Held now (working/ — do not touch these files)

- `bug-a-managed-locals-leak-at-ORDINARY-scope-exit-on-wasm32-and-a-variant-local-traps` [A] — owner: frankC
