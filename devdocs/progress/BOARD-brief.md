...
`working:25 unfinished:22 blocked:6 backlog:18 backlog-umbrella:8 backlog-core:150 backlog-nilpy:97 backlog-tools:54 backlog-pascal:38 backlog-decide:44 backlog-libs:23 backlog-cfront:12 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:74 known-incompat:4 float:25 done-followup:3 decided:149 done:3562 rejected:79`
...
- `[p 70] [P]` regression-test-core-test-nested-class-type-scoping
- `[p 70] [N]` regression-test-core-test-nilpy-star-methods-and-targets-2
- `[p 70] [P]` regression-test-core-test-record-nested-type-section-2
- `[p 70] [A]` regression-test-debug-g-compiler-srchash-2
- `[p 70] [A]` regression-test-emit-obj-c-obj-data-dup-a
