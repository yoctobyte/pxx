...
`working:4 unfinished:28 blocked:8 backlog:5 backlog-umbrella:5 backlog-core:131 backlog-nilpy:97 backlog-tools:71 backlog-pascal:52 backlog-decide:22 backlog-libs:17 backlog-cfront:11 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:2 experimental:20 rainy-day:44 float:24 done-followup:3 decided:144 done:3005 rejected:72`
...
- `[p 70] [T]` regression-test-core-test-promoint-array-cleanup
