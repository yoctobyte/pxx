...
`working:33 unfinished:19 blocked:8 backlog:39 backlog-umbrella:13 backlog-core:165 backlog-nilpy:177 backlog-tools:61 backlog-pascal:11 backlog-decide:49 backlog-libs:25 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:77 known-incompat:6 float:23 done-followup:3 decided:151 done:3881 rejected:84`

## Held now (working/ — do not touch these files)

- `bug-a-dce-under-emit-obj-crashes-a-two-object-i386-link-before-main` [A] — owner: frankb-8e
