...
`working:21 unfinished:21 blocked:7 backlog:15 backlog-umbrella:7 backlog-core:137 backlog-nilpy:98 backlog-tools:42 backlog-pascal:31 backlog-decide:46 backlog-libs:21 backlog-cfront:11 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:146 done:3409 rejected:79`

## Held now (working/ — do not touch these files)

- `bug-a-pascal-nilpy-rust-and-zig-over-align-an-8-byte-member-on-i386` [A] — owner: frankA
- `bug-p-a-class-helpers-class-method-is-refused-by-the-record-metaclass-rule` [P] — owner: frankB
