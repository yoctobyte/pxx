...
`urgent:2 working:1 unfinished:23 blocked:7 backlog:284 backlog_new:19 experimental:20 rainy-day:44 float:20 done-followup:3 decided:101 done:2351 rejected:40`

## Held now (working/ — do not touch these files)

- `feature-a-error-does-not-halt-so-a-parse-can-be-speculative` [A] — owner: claude-A
