...
`working:22 unfinished:23 blocked:7 backlog:9 backlog-umbrella:7 backlog-core:137 backlog-nilpy:98 backlog-tools:41 backlog-pascal:24 backlog-decide:46 backlog-libs:21 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:146 done:3400 rejected:78`
...
- `bug-p-a-procedural-type-cannot-return-an-array-or-another-procedural-type` [P] — owner: frankB
- `bug-p-delphi-mode-binds-a-bare-routine-name-only-for-a-variable-target` [P] — owner: frankB
