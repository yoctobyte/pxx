...
`working:32 unfinished:19 blocked:9 backlog:39 backlog-umbrella:13 backlog-core:168 backlog-nilpy:174 backlog-tools:61 backlog-pascal:11 backlog-decide:50 backlog-libs:25 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:77 known-incompat:6 float:23 done-followup:3 decided:151 done:3882 rejected:84`
...
- `bug-n-a-pascal-function-handed-to-a-procedural-parameter-from-nilpy-is-not-a-code-address` [N] — owner: frankb-8e
