...
- `[p 80] [A]` bug-a-i386-copy-and-pos-segfault-under-the-byte-prefix-mode
...
- `[p 75] [A]` bug-a-i386-refuses-a-frozen-record-field-write-under-the-byte-prefix-mode
