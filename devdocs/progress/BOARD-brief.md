...
`working:32 unfinished:19 blocked:9 backlog:38 backlog-umbrella:13 backlog-core:173 backlog-nilpy:184 backlog-tools:61 backlog-pascal:11 backlog-decide:51 backlog-libs:25 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:48 low-prio:77 known-incompat:6 float:23 done-followup:3 decided:151 done:3891 rejected:84`
...
- `bug-n-a-capturing-nested-def-into-a-procedural-slot-segfaults-with-no-diagnostic` [N] — owner: frankb-8e
