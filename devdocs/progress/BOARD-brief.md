...
`working:37 unfinished:17 blocked:10 backlog:48 backlog-umbrella:14 backlog-core:170 backlog-nilpy:185 backlog-tools:72 backlog-pascal:13 backlog-decide:49 backlog-libs:28 backlog-cfront:12 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:1 experimental:20 rainy-day:49 low-prio:76 known-incompat:6 float:23 done-followup:3 decided:153 done:3950 rejected:89`
...
_548 more ready — `tools/progress.sh ready --track X` for a lane's full queue._
