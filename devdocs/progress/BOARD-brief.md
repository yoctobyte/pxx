...
`working:6 unfinished:30 blocked:9 backlog:391 backlog_new:25 experimental:20 rainy-day:44 float:23 done-followup:3 decided:128 done:2904 rejected:68`

## Held now (working/ — do not touch these files)

- `bug-a-no-cross-target-can-build-the-compiler-itself` [A] — owner: frankS
- `bug-a-threadsafe-on-x86-64-leaks-every-managed-class-field-and-it-is-not-benign` [A] — owner: frankS
- `feature-a-build-a-reduced-compiler-by-selecting-frontends-and-targets` [A] — owner: frankA
