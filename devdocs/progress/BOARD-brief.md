...
`working:31 unfinished:22 blocked:6 backlog:18 backlog-umbrella:9 backlog-core:150 backlog-nilpy:104 backlog-tools:55 backlog-pascal:5 backlog-decide:46 backlog-libs:24 backlog-cfront:13 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:75 known-incompat:4 float:25 done-followup:3 decided:149 done:3623 rejected:80`
...
- `bug-p-a-shadowed-soft-intrinsic-is-closed-without-consulting-the-arguments` [P] — owner: frankS
...
- `feature-p-threadvar-is-not-supported-at-any-scope` [P]
...
- `[p 75] [N]` bug-n-a-duck-typed-method-call-is-refused-when-no-class-in-the-unit-declares-the-name (unblocks 1)
...
- `[p 70] [T]` regression-test-core-test-generic-nested-inline-specialize
