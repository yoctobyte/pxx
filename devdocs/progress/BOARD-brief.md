...
`working:30 unfinished:21 blocked:6 backlog:28 backlog-umbrella:11 backlog-core:159 backlog-nilpy:148 backlog-tools:60 backlog-pascal:9 backlog-decide:45 backlog-libs:29 backlog-cfront:15 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:75 known-incompat:5 float:23 done-followup:3 decided:151 done:3726 rejected:81`
...
- `[p 75] [N]` bug-n-a-module-from-a-guarded-import-gives-one-attribute-int-and-another-variant
...
_470 more ready — `tools/progress.sh ready --track X` for a lane's full queue._
