...
`working:10 unfinished:26 blocked:7 backlog:11 backlog_new:2 backlog-umbrella:7 backlog-core:128 backlog-nilpy:96 backlog-tools:13 backlog-pascal:53 backlog-decide:36 backlog-libs:18 backlog-cfront:19 backlog-web:7 backlog-windows:4 backlog-docs:3 backlog-esp:2 experimental:20 rainy-day:45 low-prio:71 known-incompat:2 float:25 done-followup:3 decided:145 done:3208 rejected:74`

## Held now (working/ — do not touch these files)

- `bug-a-cross-backends-neither-retain-into-a-variant-nor-release-a-class-local-and-the-two-must-move-together` [A] — owner: frankb-78
