...
`working:31 unfinished:21 blocked:6 backlog:47 backlog-umbrella:11 backlog-core:167 backlog-nilpy:177 backlog-tools:60 backlog-pascal:9 backlog-decide:46 backlog-libs:26 backlog-cfront:13 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:75 known-incompat:5 float:23 done-followup:3 decided:151 done:3797 rejected:81`

## Held now (working/ — do not touch these files)

- `bug-a-pascal-nilpy-rust-and-zig-over-align-an-8-byte-member-on-i386` [A] — owner: frankA
- `bug-c-malloc-usable-size-is-undeclared-so-quickjs-cannot-compile` [C] — owner: frankb-56
...
_522 more ready — `tools/progress.sh ready --track X` for a lane's full queue._
