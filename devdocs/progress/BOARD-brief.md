...
`working:1 unfinished:8 blocked:3 backlog:214 experimental:20 rainy-day:40 done-followup:3 decided:66 done:1741 rejected:35`

## Held now (working/ — do not touch these files)

- `feature-nilpy-thirdparty-libraries-as-targets` [N] — owner: claude-A-N
