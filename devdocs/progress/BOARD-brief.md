...
`working:21 unfinished:22 blocked:6 backlog:17 backlog-umbrella:7 backlog-core:145 backlog-nilpy:99 backlog-tools:46 backlog-pascal:32 backlog-decide:43 backlog-libs:23 backlog-cfront:11 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:149 done:3490 rejected:79`
...
- `[p 70] [P]` regression-test-core-test-generic-func
- `[p 70] [P]` regression-test-core-test-inline-generic-specialization
