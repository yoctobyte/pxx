...
`working:23 unfinished:22 blocked:6 backlog:15 backlog-umbrella:7 backlog-core:145 backlog-nilpy:99 backlog-tools:45 backlog-pascal:26 backlog-decide:43 backlog-libs:23 backlog-cfront:11 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:46 low-prio:73 known-incompat:4 float:25 done-followup:3 decided:149 done:3464 rejected:79`
...
- `refactor-p-nodearrndinfo-answers-nothing-for-a-rank-1-array` [P] — owner: frankB
...
- `[p 70] [T]` regression-test-threads-test-threadsafe-class-finalize-race-2
