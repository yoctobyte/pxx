...
`working:28 unfinished:21 blocked:6 backlog:17 backlog-umbrella:9 backlog-core:150 backlog-nilpy:103 backlog-tools:54 backlog-pascal:23 backlog-decide:45 backlog-libs:23 backlog-cfront:13 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:74 known-incompat:4 float:25 done-followup:3 decided:149 done:3594 rejected:80`
...
- `bug-p-a-generic-template-body-is-resolved-in-the-specializers-scope-not-its-own` [P] — owner: frankH
