...
`working:30 unfinished:21 blocked:6 backlog:26 backlog-umbrella:11 backlog-core:159 backlog-nilpy:132 backlog-tools:60 backlog-pascal:9 backlog-decide:44 backlog-libs:27 backlog-cfront:15 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:3 experimental:20 rainy-day:47 low-prio:75 known-incompat:5 float:23 done-followup:3 decided:151 done:3711 rejected:81`
...
## Ready — top 30 of 479, ranked

- `[p 90] [A]` bug-a-fourteen-compiler-internal-record-names-shadow-any-user-type (unblocks 1)
- `[p 90] [N]` bug-n-a-chained-assignment-through-a-variant-typed-intermediate (unblocks 1)
