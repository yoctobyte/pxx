...
`working:6 unfinished:27 blocked:7 backlog:7 backlog-umbrella:6 backlog-core:139 backlog-nilpy:96 backlog-tools:72 backlog-pascal:60 backlog-decide:26 backlog-libs:16 backlog-cfront:16 backlog-web:7 backlog-windows:4 backlog-docs:2 backlog-esp:2 experimental:20 rainy-day:44 float:25 done-followup:3 decided:144 done:3098 rejected:72`

## Held now (working/ — do not touch these files)

- `bug-a-pascal-nilpy-rust-and-zig-over-align-an-8-byte-member-on-i386` [A] — owner: frankA
- `feature-a-i386-refuses-a-by-value-record-parameter-on-the-internal-convention-so-lib-rtl-image-does-not-build` [A] — owner: frankC
