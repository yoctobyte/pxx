...
`working:33 unfinished:18 blocked:9 backlog:37 backlog-umbrella:13 backlog-core:172 backlog-nilpy:186 backlog-tools:63 backlog-pascal:12 backlog-decide:51 backlog-libs:27 backlog-cfront:10 backlog-web:8 backlog-windows:4 backlog-docs:1 backlog-esp:5 experimental:20 rainy-day:48 low-prio:76 known-incompat:6 float:23 done-followup:3 decided:151 done:3914 rejected:86`
