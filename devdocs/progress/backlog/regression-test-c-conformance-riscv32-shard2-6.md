...
# regression: test-c-conformance-riscv32#shard2/6 red at 96b6bac331d9 (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-c-conformance-riscv32#shard2/6'` at 96b6bac331d9d8b9c838d0055a8e3841157314f1
...
FAIL 00219.c — output mismatch:
    ...
    +++ /tmp/pxx_c_conformance.217856/out.txt	2026-07-12 19:37:05.798355852 +0200
    @@ -6,7 +6,7 @@
     0
     5
     1
...
test-c-conformance-riscv32: FAILURES: 00219.c(output)
