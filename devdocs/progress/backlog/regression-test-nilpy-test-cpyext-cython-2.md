...
## Log
- 2026-09-19 — the borg watcher saw `test-nilpy#src:test/test_cpyext_cython.npy` GREEN at 361c03dc6ded (tier full) and did NOT close this: this is a repeat stub (`regression-test-nilpy-test-cpyext-cython-2`, not `regression-test-nilpy-test-cpyext-cython`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
