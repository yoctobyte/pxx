...
- 2026-09-12 — the borg watcher saw `tools-devtest#00` GREEN at 48ffab327c36 (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-20 — the borg watcher saw `tools-devtest#00` GREEN at 7fb6a46c346f (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-21 — the borg watcher saw `tools-devtest#00` GREEN at ac802a28c594 (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-24 — the borg watcher saw `tools-devtest#00` GREEN at 8e2464989f2a (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-25 — the borg watcher saw `tools-devtest#00` GREEN at fdca56b72841 (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-25 — the borg watcher saw `tools-devtest#00` GREEN at dd30aa4fb8ec (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-25 — the borg watcher saw `tools-devtest#00` GREEN at a8534f61c8f5 (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
- 2026-09-25 — the borg watcher saw `tools-devtest#00` GREEN at b53d87308781 (tier full) and did NOT close this: this is a repeat stub (`regression-tools-devtest-00-4`, not `regression-tools-devtest-00`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
