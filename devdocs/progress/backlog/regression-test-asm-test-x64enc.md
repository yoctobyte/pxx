...
# regression: test-asm#src:test/test_x64enc.pas red at 31198d3674df (auto-filed by twatch)

- **Type:** regression (auto-filed by Track T watcher, host seven). Untriaged.
- **Found:** 2026-08-30T05:08:12Z
- **Test source:** test/test_x64enc.pas tools/expect_same.sh

## Repro
`tools/testmgr.py --tier native --job 'test-asm#src:test/test_x64enc.pas'` at 31198d3674dfe530aa0699f0eb775346a705410a
