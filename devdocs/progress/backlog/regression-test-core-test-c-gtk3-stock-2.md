...
# regression: test-core#src:test/test_c_gtk3_stock.pas at 1236bf31f930 in step 1/3, `./compiler/pascal26 -Futest/gtk3stock -I/usr/include/gtk-3.0/ test/test_c_gtk3_stock.pas /tmp/test_c_gtk3_stock26` (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier native --job 'test-core#src:test/test_c_gtk3_stock.pas'` at 1236bf31f93084fe322e626880cc6132a33cf64a
