...
## Log
- 2026-09-06 — the seven watcher saw `test-pascal-conformance#shard5/6` GREEN at c1961bc63ca0 (tier full) and did NOT close this: this is a repeat stub (`regression-test-pascal-conformance-shard5-6-5`, not `regression-test-pascal-conformance-shard5-6`) — the job already went red, was closed, and came back, so one green is the outcome a live intermittent bug produces most of the time. The green is recorded because it is evidence and because a ticket that stops moving with no reason reads as forgotten; closing this one is a human's call.
