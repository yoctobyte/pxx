...
# regression: test-core#src:test/test_call_result_member.pas red at a76303231306 (auto-filed by twatch)

- **Type:** regression (auto-filed by Track T watcher, host plexus). Untriaged.
- **Found:** 2026-08-19T13:59:40Z
- **Test source:** test/test_call_result_member.pas

## Repro
`tools/testmgr.py --tier native --job 'test-core#src:test/test_call_result_member.pas'` at a763032313063caaa4da3a0039d25959752c4b58
...
## Log tail
```
pascal26:60: error: unexpected token
(tail)
Expected: ), but got:  (Kind: 81, Line: 60)
pascal26:60: error: unexpected token
  near: Writeln  MakeRec    >>>  Name  
