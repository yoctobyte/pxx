...
# regression: test-i386#src:examples/net/httpdemo.pas red at be7f80936b0c (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier full --job 'test-i386#src:examples/net/httpdemo.pas'` at be7f80936b0c0c95afadcb4d093ae8ba95ecea1c
