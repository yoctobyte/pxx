...
# regression: test-core#src:test/test_c_gtk_call.pas at 7867c5481c01 in step 1/2, `./compiler/pascal26 test/test_c_gtk_call.pas /tmp/test_c_gtk_call26` (auto-filed by twatch)
...
## Repro
`tools/testmgr.py --tier native --job 'test-core#src:test/test_c_gtk_call.pas'` at 7867c5481c0126cd79daa92c74114b8dd3fc6ef3
...
(tail)
pascal26:2: error: uses: unit source not found: gtk
  near: program test_c_gtk_call ; uses gtk >>> ; begin gtk_init 
