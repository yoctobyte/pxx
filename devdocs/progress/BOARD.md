...
| bug-nilpy-parent-method-call-breaks-if-parent-instantiated-first | N | 60 | bug | `A.call(self)` won't parse if `A` was instantiated at module level first | — |
...
| meta-t-dev-throughput-and-track-a-t-integration | T | 80 | meta | META: development is wait-limited, not token-limited. Dev tracks stop running suites; T owns breadth and its report LATENCY becomes the product. Coordinates the tooling tickets that get us there. | — |
...
- [p 55] [T] feature-t-bench-record-host-hardware-specs
...
- [p 45] [B] bug-subprocess-spawns-child-with-empty-environment
...
- [p 25] [T] bug-t-gate-sh-contention-check-double-counts-zero
- [p 25] [T] bug-t-gate-sh-pgrep-fc-double-zero-integer-error
