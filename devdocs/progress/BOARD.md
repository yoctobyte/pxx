...
1482 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 40] [N] bug-nilpy-callable-field-typed-only-by-a-ctor-parameter-has-no-signature
