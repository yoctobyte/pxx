...
| Ticket | Track | Prio | Type | Summary | Blocked-by |
| --- | --- | --- | --- | --- | --- |
| bug-a-array-of-records-with-interface-fields-leaks-the-interfaces | A | 45 | bug | An array (static or dynamic) of records holding a COM interface field leaks every interface: the element walk calls PXXRecordRelease, which owns kinds 1-3 only, and nothing runs the unlocked kind-4 pass the scalar record path now has. | — |
...
2227 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 50] [U] decide-riscv64-vs-the-bug-queue-for-autonomous-nights
...
- [p 45] [A] bug-a-array-of-records-with-interface-fields-leaks-the-interfaces
