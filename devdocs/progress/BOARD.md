...
1896 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 45] [P] bug-pascal-ord-of-a-one-char-string-const-is-its-address
...
- [p 35] [N] bug-nilpy-a-static-method-called-on-the-class-takes-no-keyword-arguments
