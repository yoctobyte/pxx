...
1689 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [urgent p 70] [T] bug-t-testmgr-pin-gates-with-the-full-tier-by-default
