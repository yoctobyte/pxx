...
2089 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [urgent p 75] [U] decide-nilpy-import-rule-vs-a-cpyext-extension-module
- [urgent p 70] [N] bug-n-a-callable-value-reaches-a-str-parameter-and-renders-as-bound-method
- [urgent p 60] [A+F] bug-a-riscv32-cross-float-output-no-longer-matches-x86-64
...
- [p 45] [T] bug-t-a-red-job-records-no-reason
