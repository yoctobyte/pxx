...
| bug-a-an-int64-assigned-to-a-variant-truncates-to-32-bits-on-i386-and-arm32 | A | 55 | bug | Found while fixing bug-a-variant-shr-is-arithmetic-where-static-shr-is-logical. Boxing a value into a Variant moves only FOUR bytes into the 8-byte payload on the two 32-bit targets, so `v := l` with l: Int64 = -12 makes a Variant holding 4294967284, and `v := 5000000000` holds 705032704. Silent wrong answer, target-dependent, on every operator downstream. | — |
...
2416 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 70] [P] regression-test-aarch64-test-parallel-for-capture-aggr
- [p 70] [P] regression-test-core-test-char-array-is-a-string
- [p 70] [P] regression-test-threads-test-parallel-for-capture-aggr-2
...
- [p 62] [P] bug-p-a-descendant-method-does-not-hide-the-inherited-one
...
- [p 55] [A] bug-a-an-int64-assigned-to-a-variant-truncates-to-32-bits-on-i386-and-arm32
