...
| regression-test-core-test-arrayofconst-to-method-b287 | P | 70 | regression | regression: test-core#src:test/test_arrayofconst_to_method_b287.pas red at a195f67d754b (auto-filed by twatch) | — |
...
2435 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 45] [A] bug-a-error-recovery-silences-every-lowering-only-diagnostic [parked — re-claim, do not duplicate]
