...
2129 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 55] [P] bug-p-a-pchar-plus-offset-loses-its-type-when-dereferenced
