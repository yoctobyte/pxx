...
2560 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 60] [P] bug-p-a-generic-prerequisite-is-emitted-before-the-referenced-template-exists [parked — re-claim, do not duplicate]
...
- [p 50] [T] bug-t-nothing-exercises-o3-so-its-clean-record-is-empty
...
- [p 45] [T] chore-t-nothing-re-checks-a-blocked-by-edge-after-its-blocker-closes
