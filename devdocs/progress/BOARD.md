...
| bug-nilpy-callable-in-local-var-call-does-nothing | N | 70 | bug | `cb = handler` then `cb(x)` compiles and does NOTHING | — |
...
- [p 70] [N] bug-nilpy-callable-in-local-var-call-does-nothing
