...
| bug-nilpy-uforth-compiles-but-segfaults-at-runtime | N | 40 | bug | uforth.py now COMPILES (both compile blockers cleared 2026-08-07) but the produced binary segfaults immediately, so `make test-uforth` is still red — now at run time instead of compile time | — |
...
1484 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 50] [N] bug-nilpy-closure-stored-in-a-callable-field-jumps-through-the-variant-tag
...
- [p 40] [U] decide-nilpy-multiple-inheritance-c3-or-delegate
...
- [p 35] [N] bug-nilpy-list-of-a-bytes-object-is-empty
