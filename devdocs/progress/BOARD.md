...
| bug-nilpy-typed-const-import-reads-zero | N | 60 | bug | Nil Python importing a Pascal *typed* constant reads zero, not the initializer | — |
...
- **1** — bug-a-overload-resolution-ignores-class-identity
