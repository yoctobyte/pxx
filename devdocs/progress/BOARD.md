...
| feature-nilpy-codecs-shim | B | 40 | feature | `import codecs` — the next wall for the compile-real-libraries campaign | decide-may-agents-fetch-thirdparty-sources-as-oracles |
...
1568 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [urgent p 75] [A] feature-a-pxx-threadsafe-conditional-define
...
- [p 45] [U] decide-threadsafe-gate-is-reach-based-not-use-based
...
- [p 25] [N] bug-nilpy-nosetitem-error-does-not-name-the-class
