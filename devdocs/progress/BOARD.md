...
| --- | --- | --- | --- | --- | --- |
| bug-n-a-module-level-rebinding-still-loses-to-a-def-of-the-same-name | A | 50→62 | bug |  | — |
...
2516 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
