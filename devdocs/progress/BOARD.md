...
| bug-esp-idf-linux-syscalls-emitted-panic-at-app-main | A | 75 | bug | Every pxx ESP-IDF app panics at `app_main`: Linux syscalls emitted into the image | — |
...
- [urgent p 75] [A] bug-esp-idf-linux-syscalls-emitted-panic-at-app-main
