...
| --- | --- | --- | --- | --- | --- |
| bug-pascal-local-var-not-registered-wrong-sym | P | 70 | bug | A method's LOCAL is not registered, and the name resolves to an unrelated symbol | — |
...
- [urgent p 70] [P] bug-pascal-local-var-not-registered-wrong-sym
