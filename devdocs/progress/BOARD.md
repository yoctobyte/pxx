...
| Ticket | Track | Prio | Type | Summary | Blocked-by |
| --- | --- | --- | --- | --- | --- |
| bug-a-riscv32-cross-float-output-no-longer-matches-x86-64 | A+F | 20 | bug | `test-riscv32#src:test/test_cross_float.pas` — the two sides print the same numbers at different widths | — |
...
2098 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
