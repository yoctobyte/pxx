...
1746 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [urgent p 80] [A] bug-pascal-uses-is-transitive
...
- [p 40] [U] decide-t-mem-floor-policy-on-a-small-box
...
- **1** — decide-pylib-exception-vs-sysutils-exception
