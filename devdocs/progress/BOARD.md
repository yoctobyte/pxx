...
2443 ticket(s) — full table in [`BOARD-done.md`](./BOARD-done.md), generated alongside this file.
...
- [p 45] [P] bug-p-an-implicit-conversion-operator-needs-an-exact-type-kind-match
