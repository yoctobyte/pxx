...
Owner decision. 73 of the 74 open Track T tickets were filed between 2026-08-31
and 2026-09-02, 58 on one day. The pile was too large to work through and
returned almost nothing, and a ticket nobody will fix does not sit neutrally — it
stays in the ranker forever at zero value.
...
**Kept, not deleted:** so the finding is not rediscovered and refiled from
scratch, and so it can be pulled back if what it touches becomes load-bearing.
