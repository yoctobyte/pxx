...
**Live case.** `feature-dynamic-compiler-tables` adjudicated this **in its own
body**, line 341, dated 2026-08-30:
...
`blocked-by: []`. It re-reported on its **second** run — frankH, working the
ticket 2026-09-06, paid the adjudication twice. **The check's own note warns that
it matches slugs and not questions; nothing lets a reader record that they did
