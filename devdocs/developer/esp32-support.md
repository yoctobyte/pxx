...
`devdocs/progress/backlog/feature-esp-isa-baseline-softfallback.md`.
...
`devdocs/progress/done/feature-esp32-managed-features.md`). Output-equality harness
